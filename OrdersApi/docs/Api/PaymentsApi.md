...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **payment_id** | [**string**](../Model/.md)| A unique identifier got in response of the create payment API. |
 ...
 **payment_id** | [**string**](../Model/.md)| Unique Payment ID set by the Prio system. This is an internal identifier. | [optional]
 ...
 **payment_id** | [**string**](../Model/.md)| [FILTER] on &#x60;payment_id&#x60;. | [optional]
