...
**product_start_date** | **\DateTime** | Starting date of product. |
**product_end_date** | **\DateTime** | End date of the product. | [optional]
**product_booking_start_date** | **\DateTime** | The earliest date on which the product is available for sale. This can be earlier than the &#x60;product_start_date&#x60;. |
**product_booking_end_date** | **\DateTime** | The date on which the product is no longer available for sale. This can be earlier than the &#x60;product_end_date&#x60;. | [optional]
