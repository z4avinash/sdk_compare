...
class ContactsApi
{
     ...
     * Contact Details
     *
     * @param  string $contact_uid Unique Contact ID. (required)
     * @param  string $include_versions [CONFIG] Include all contact revisions. (optional, default to 'false') (deprecated)
     *
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PrioTicket\DistributorAPI\Models\ContactDetailResponse|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel
     */
    public function getContact($contact_uid, $include_versions = 'false')
    {
        list($response) = $this->getContactWithHttpInfo($contact_uid, $include_versions);
        return $response;
    }
     ...
     */
    public function getContactWithHttpInfo($contact_uid, $include_versions = 'false')
    {
        $request = $this->getContactRequest($contact_uid, $include_versions);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PrioTicket\DistributorAPI\Models\ContactDetailResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PrioTicket\DistributorAPI\Models\ContactDetailResponse', []),
            ...
            $returnType = '\PrioTicket\DistributorAPI\Models\ContactDetailResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PrioTicket\DistributorAPI\Models\ContactDetailResponse',
     ...
     */
    public function getContactAsync($contact_uid, $include_versions = 'false')
    {
        return $this->getContactAsyncWithHttpInfo($contact_uid, $include_versions)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactAsyncWithHttpInfo($contact_uid, $include_versions = 'false')
    {
        $returnType = '\PrioTicket\DistributorAPI\Models\ContactDetailResponse';
        $request = $this->getContactRequest($contact_uid, $include_versions);
     ...
     */
    public function getContactRequest($contact_uid, $include_versions = 'false')
    {
        // verify the required parameter 'contact_uid' is set
        if ($contact_uid === null || (is_array($contact_uid) && count($contact_uid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contact_uid when calling getContact'
            );
        }
        if (strlen($contact_uid) < 8) {
            throw new \InvalidArgumentException('invalid length for "$contact_uid" when calling ContactsApi.getContact, must be bigger than or equal to 8.');
        }


        $resourcePath = '/contacts/{contact_uid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($include_versions !== null) {
            if('form' === 'form' && is_array($include_versions)) {
                foreach($include_versions as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['include_versions'] = $include_versions;
            }
        }
        ...
        if ($contact_uid !== null) {
            $resourcePath = str_replace(
                '{' . 'contact_uid' . '}',
                ObjectSerializer::toPathValue($contact_uid),
                $resourcePath
            );
        }
     ...
     * @param  \PrioTicket\DistributorAPI\Models\ContactType $contact_type [FILTER] on &#x60;contact_type&#x60;. (optional)
     * @param  string $contact_external_uid [FILTER] on &#x60;contact_external_uid&#x60;. (optional) (deprecated)
     ...
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PrioTicket\DistributorAPI\Models\ContactListResponse|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel
     */
    public function getContacts($reseller_id = null, $distributor_id = null, $contact_type = null, $contact_external_uid = null, $items_per_page = 10, $start_index = 1, $page = 1, $if_modified_since = null)
    {
        list($response) = $this->getContactsWithHttpInfo($reseller_id, $distributor_id, $contact_type, $contact_external_uid, $items_per_page, $start_index, $page, $if_modified_since);
        return $response;
    }
     ...
     * @return array of \PrioTicket\DistributorAPI\Models\ContactListResponse|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getContactsWithHttpInfo($reseller_id = null, $distributor_id = null, $contact_type = null, $contact_external_uid = null, $items_per_page = 10, $start_index = 1, $page = 1, $if_modified_since = null)
    {
        $request = $this->getContactsRequest($reseller_id, $distributor_id, $contact_type, $contact_external_uid, $items_per_page, $start_index, $page, $if_modified_since);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PrioTicket\DistributorAPI\Models\ContactListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PrioTicket\DistributorAPI\Models\ContactListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\PrioTicket\DistributorAPI\Models\ContactListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PrioTicket\DistributorAPI\Models\ContactListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsAsync($reseller_id = null, $distributor_id = null, $contact_type = null, $contact_external_uid = null, $items_per_page = 10, $start_index = 1, $page = 1, $if_modified_since = null)
    {
        return $this->getContactsAsyncWithHttpInfo($reseller_id, $distributor_id, $contact_type, $contact_external_uid, $items_per_page, $start_index, $page, $if_modified_since)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getContactsAsyncWithHttpInfo($reseller_id = null, $distributor_id = null, $contact_type = null, $contact_external_uid = null, $items_per_page = 10, $start_index = 1, $page = 1, $if_modified_since = null)
    {
        $returnType = '\PrioTicket\DistributorAPI\Models\ContactListResponse';
        $request = $this->getContactsRequest($reseller_id, $distributor_id, $contact_type, $contact_external_uid, $items_per_page, $start_index, $page, $if_modified_since);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactsRequest($reseller_id = null, $distributor_id = null, $contact_type = null, $contact_external_uid = null, $items_per_page = 10, $start_index = 1, $page = 1, $if_modified_since = null)
    {
        if ($items_per_page !== null && $items_per_page > 500) {
            throw new \InvalidArgumentException('invalid value for "$items_per_page" when calling ContactsApi.getContacts, must be smaller than or equal to 500.');
        }
        ...
        if ($start_index !== null && $start_index > 10000) {
            throw new \InvalidArgumentException('invalid value for "$start_index" when calling ContactsApi.getContacts, must be smaller than or equal to 10000.');
        }
        if ($start_index !== null && $start_index < 1) {
            throw new \InvalidArgumentException('invalid value for "$start_index" when calling ContactsApi.getContacts, must be bigger than or equal to 1.');
        }

        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ContactsApi.getContacts, must be bigger than or equal to 1.');
        }
        ...
        if ($contact_type !== null) {
            if('form' === 'form' && is_array($contact_type)) {
                foreach($contact_type as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['contact_type'] = $contact_type;
            }
        }
        // query params
        if ($contact_external_uid !== null) {
            if('form' === 'form' && is_array($contact_external_uid)) {
                foreach($contact_external_uid as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['contact_external_uid'] = $contact_external_uid;
            }
        }
        // query params
     ...
     *
     * @param  string $contact_uid Unique Contact ID. (required)
     * @param  \PrioTicket\DistributorAPI\Models\UpdateContactRequest $update_contact_request Update Contact Request. (required)
     * @param  string[] $order_reference By default, previous orders will not be amended. If you would like to update existing orders to the latest contact version, please include these here as well.   If the contact was not linked to the order yet, it will be added. (optional)
     *
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PrioTicket\DistributorAPI\Models\ContactDetailResponse|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel
     */
    public function updateContact($contact_uid, $update_contact_request, $order_reference = null)
    {
        list($response) = $this->updateContactWithHttpInfo($contact_uid, $update_contact_request, $order_reference);
        return $response;
    }
     ...
     * @return array of \PrioTicket\DistributorAPI\Models\ContactDetailResponse|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateContactWithHttpInfo($contact_uid, $update_contact_request, $order_reference = null)
    {
        $request = $this->updateContactRequest($contact_uid, $update_contact_request, $order_reference);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateContactAsync($contact_uid, $update_contact_request, $order_reference = null)
    {
        return $this->updateContactAsyncWithHttpInfo($contact_uid, $update_contact_request, $order_reference)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateContactAsyncWithHttpInfo($contact_uid, $update_contact_request, $order_reference = null)
    {
        $returnType = '\PrioTicket\DistributorAPI\Models\ContactDetailResponse';
        $request = $this->updateContactRequest($contact_uid, $update_contact_request, $order_reference);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateContactRequest($contact_uid, $update_contact_request, $order_reference = null)
    {
        // verify the required parameter 'contact_uid' is set
        if ($contact_uid === null || (is_array($contact_uid) && count($contact_uid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contact_uid when calling updateContact'
            );
        }
        if (strlen($contact_uid) < 8) {
            throw new \InvalidArgumentException('invalid length for "$contact_uid" when calling ContactsApi.updateContact, must be bigger than or equal to 8.');
        }
        ...
        // query params
        if (is_array($order_reference)) {
            $order_reference = ObjectSerializer::serializeCollection($order_reference, 'form', true);
        }
        ...
        if (isset($update_contact_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($update_contact_request));
            } else {
