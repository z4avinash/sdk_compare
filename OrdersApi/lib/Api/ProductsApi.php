...
class ProductsApi
{
     ...
     * @param  string $currency_type [CONFIG] show currency rates based on sales or purchase price. (optional)
     ...
     * @param  int $product_version Product Version / Revision number. By default the latest revision will be returned.  If set, the &#x60;cache&#x60; value will be ignored. (optional)
     * @param  bool $cache [CACHE] Whether the results should be loaded from the caching server. This will significantly improve performance and disabling this functionality is not recommended. (optional, default to true)
     * @param  string $if_modified_since [CACHE] The &#x60;If-Modified-Since&#x60; request HTTP header makes the request conditional: the server will send back the requested resource, with a 200 status, only if it has been modified after the given date. If the resource has not been modified since, the response will be a 304 without any body; the &#x60;Last-Modified&#x60; response header of a previous request will contain the date of last modification.  Note that if a single resource has changed, all records matching your request will be returned, not just those changed after the given date. This provides you with an efficient caching method. (optional)
     *
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  bool $include_disabled [FILTER] Include disabled / closed (&#x60;availability_active:false&#x60;) entries. (optional, default to false)
     ...
     * @param  int $party_size [FILTER] The party size that can be accommodated during this time slot. Only applicable for selected merchants. (optional)
     ...
     * @param  string $category_search_query [SEARCH] on keywords.   This API provides full-text (wildcard) search capabilities.   Only results linked to your account will be returned. (optional)
     * @param  string $if_modified_since [CACHE] The &#x60;If-Modified-Since&#x60; request HTTP header makes the request conditional: the server will send back the requested resource, with a 200 status, only if it has been modified after the given date. If the resource has not been modified since, the response will be a 304 without any body; the &#x60;Last-Modified&#x60; response header of a previous request will contain the date of last modification.  Note that if a single resource has changed, all records matching your request will be returned, not just those changed after the given date. This provides you with an efficient caching method. (optional)
     *
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  string[] $location_type [FILTER] on Location Type (&#x60;location_type&#x60;). (optional)
     * @param  int $items_per_page [PAGING] Items Per Page - Allows user&#39;s to configure the &#x60;items_per_page&#x60; value. For example, to load 100 items per page, the developer may point the user to a url with the query string ?items_per_page&#x3D;100. This parameter is mainly usefull to manage response times, higher values result in longer response times and therefore it is recommended to keep this value as low as possible. We do allow to adjust this value so it can be used to batch/cache/update inventory at once.  Clients should anticipate that the value of this parameter may not be honored by the API, and should rely exclusively on the contents of the &#x60;items_per_page&#x60; response element in calculating actual page size. (optional, default to 10)
     * @param  int $start_index [PAGING] Index-based paging - Allows user&#39;s to jump directly to a specific item position within a list of items. For example, to load 10 items starting at item 200, the developer may point the user to a url with the query string ?start_index&#x3D;200. (optional, default to 1)
     * @param  int $page [PAGING] Page-based paging - Allows user&#39;s to jump directly to a specific page within the items. This is similar to index-based paging, but saves the developer the extra step of having to calculate the item index for a new page of items. For example, rather than jump to item number 200, the developer could jump to page 20. The urls during page-based paging could use the query string ?page&#x3D;1 or ?page&#x3D;20. The &#x60;page_index&#x60; and &#x60;total_pages&#x60; properties are used for this style of paging. (optional, default to 1)
     * @param  string $if_modified_since [CACHE] The &#x60;If-Modified-Since&#x60; request HTTP header makes the request conditional: the server will send back the requested resource, with a 200 status, only if it has been modified after the given date. If the resource has not been modified since, the response will be a 304 without any body; the &#x60;Last-Modified&#x60; response header of a previous request will contain the date of last modification.  Note that if a single resource has changed, all records matching your request will be returned, not just those changed after the given date. This provides you with an efficient caching method. (optional)
     ...
     * @param  string[] $market_admin_id [FILTER] on &#x60;market_admin_id&#x60;. (optional)
     ...
     * @param  string[] $product_currency_code [FILTER] on Product Currency Code, according to [ISO-4217](https://en.wikipedia.org/wiki/ISO_4217). (optional)
     ...
     * @param  bool $product_availability [FILTER] Include products with &#x60;product_availability:true&#x60;. (optional, default to true)
     * @param  bool $product_relations [FILTER] Include product relations. (Addon, Combi, Cluster) (optional, default to true)
     * @param  string $product_planet [FILTER] on an astronomical body. *(Reserved for future use)* (optional)
     ...
     * @param  string $product_view_type [CONFIG] **(ADVANCED)** account view type.  This value defaults and is limited to the scope of your credentials. (optional)
     ...
     */
    public function getProducts($distributor_id = null, $product_content_language = null, $product_content = null, $product_start_date = null, $product_end_date = null, $product_duration = null, $product_booking_quantity_min = null, $product_booking_quantity_max = null, $product_id = null, $product_supplier = null, $market_admin_id = null, $product_category = null, $product_destination = null, $product_tag = null, $product_language = null, $product_location_id = null, $product_location_country_code = null, $product_currency_code = null, $product_custom_field = null, $product_type = null, $product_status = null, $product_catalogue_status = null, $product_availability = true, $product_relations = true, $product_planet = null, $product_modified = null, $product_search_query = null, $product_view_type = null, $product_sort_by = 'PRODUCT_MODIFIED', $product_sort_order = 'DESC', $items_per_page = 10, $start_index = 1, $page = 1, $cache = true, $if_modified_since = null)
    {
     ...
     * @return array of \PrioTicket\DistributorAPI\Models\ProductListResponse|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductsWithHttpInfo($distributor_id = null, $product_content_language = null, $product_content = null, $product_start_date = null, $product_end_date = null, $product_duration = null, $product_booking_quantity_min = null, $product_booking_quantity_max = null, $product_id = null, $product_supplier = null, $market_admin_id = null, $product_category = null, $product_destination = null, $product_tag = null, $product_language = null, $product_location_id = null, $product_location_country_code = null, $product_currency_code = null, $product_custom_field = null, $product_type = null, $product_status = null, $product_catalogue_status = null, $product_availability = true, $product_relations = true, $product_planet = null, $product_modified = null, $product_search_query = null, $product_view_type = null, $product_sort_by = 'PRODUCT_MODIFIED', $product_sort_order = 'DESC', $items_per_page = 10, $start_index = 1, $page = 1, $cache = true, $if_modified_since = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductsAsync($distributor_id = null, $product_content_language = null, $product_content = null, $product_start_date = null, $product_end_date = null, $product_duration = null, $product_booking_quantity_min = null, $product_booking_quantity_max = null, $product_id = null, $product_supplier = null, $market_admin_id = null, $product_category = null, $product_destination = null, $product_tag = null, $product_language = null, $product_location_id = null, $product_location_country_code = null, $product_currency_code = null, $product_custom_field = null, $product_type = null, $product_status = null, $product_catalogue_status = null, $product_availability = true, $product_relations = true, $product_planet = null, $product_modified = null, $product_search_query = null, $product_view_type = null, $product_sort_by = 'PRODUCT_MODIFIED', $product_sort_order = 'DESC', $items_per_page = 10, $start_index = 1, $page = 1, $cache = true, $if_modified_since = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductsAsyncWithHttpInfo($distributor_id = null, $product_content_language = null, $product_content = null, $product_start_date = null, $product_end_date = null, $product_duration = null, $product_booking_quantity_min = null, $product_booking_quantity_max = null, $product_id = null, $product_supplier = null, $market_admin_id = null, $product_category = null, $product_destination = null, $product_tag = null, $product_language = null, $product_location_id = null, $product_location_country_code = null, $product_currency_code = null, $product_custom_field = null, $product_type = null, $product_status = null, $product_catalogue_status = null, $product_availability = true, $product_relations = true, $product_planet = null, $product_modified = null, $product_search_query = null, $product_view_type = null, $product_sort_by = 'PRODUCT_MODIFIED', $product_sort_order = 'DESC', $items_per_page = 10, $start_index = 1, $page = 1, $cache = true, $if_modified_since = null)
    {
        $returnType = '\PrioTicket\DistributorAPI\Models\ProductListResponse';
        $request = $this->getProductsRequest($distributor_id, $product_content_language, $product_content, $product_start_date, $product_end_date, $product_duration, $product_booking_quantity_min, $product_booking_quantity_max, $product_id, $product_supplier, $market_admin_id, $product_category, $product_destination, $product_tag, $product_language, $product_location_id, $product_location_country_code, $product_currency_code, $product_custom_field, $product_type, $product_status, $product_catalogue_status, $product_availability, $product_relations, $product_planet, $product_modified, $product_search_query, $product_view_type, $product_sort_by, $product_sort_order, $items_per_page, $start_index, $page, $cache, $if_modified_since);
