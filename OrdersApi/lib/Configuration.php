...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://sandbox-distributor-api.prioticket.com/v3.5/distributor';
    ...
    {
        $report  = 'PHP SDK (PrioTicket\DistributorAPI) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                ...
                "variables" => [
                    "environment" => [
                        "description" => "* `distributor-api` - Production server; used for real transactions.  * `sandbox-distributor-api` - Sandbox server; used for testing, verification, demo and certification.  * `staging-distributor-api` - Pre-Production server; Internal near-production server used for deployment.  * `internal-distributor-api` - Internal server; reserved for internal use.",
                        "default_value" => "sandbox-distributor-api",
                        "enum_values" => [
                            "distributor-api",
                            "sandbox-distributor-api",
                            "staging-distributor-api",
                            "internal-distributor-api"
                        ]
                    ],
                    "version" => [
