...
class AddressModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string|null $name Name / Label of this address / addressee.
     *
     * @return self
     */
     ...
     * Sets street
     *
     * @param string|null $street Address line 1 / Street.
     *
     * @return self
     */
     ...
     * Sets addition
     *
     * @param string|null $addition Additional address line 2.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets city
     *
     * @param string|null $city Town / City / Village.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Address postal code.
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code Returns country code of the product ( [ISO-3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2))
     *
     * @return self
     */
     ...
     * Sets place_id
     *
     * @param string|null $place_id Google Place ID
     *
     * @return self
     */
     ...
     * Sets latitude
     *
     * @param string|null $latitude Address latitude.
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param string|null $longitude Address longitude.
     *
     * @return self
     */
     ...
     * Sets notes
     *
     * @param string|null $notes Address note.
     *
     * @return self
     * @deprecated
     */
