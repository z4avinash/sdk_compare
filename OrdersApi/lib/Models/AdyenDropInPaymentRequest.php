...
/**
 * AdyenDropInPaymentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class AdyenDropInPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdyenDropInPaymentRequest';
     ...
     * Sets payment_method
     *
     * @param object $payment_method The paymentComponentData.paymentMethod from Drop-in. (Adyen Specific Field)
     *
     * @return self
     */
     ...
     * Sets return_url
     *
     * @param string|null $return_url In case of a redirection, this is the URL to where your shopper should be redirected back to after they complete the payment.
     *
     * @return self
     */
