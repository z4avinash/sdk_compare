...
/**
 * AdyenDropInPaymentRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class AdyenDropInPaymentRequestAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdyenDropInPaymentRequest_allOf';
     ...
     * Sets payment_method
     *
     * @param object|null $payment_method The paymentComponentData.paymentMethod from Drop-in. (Adyen Specific Field)
     *
     * @return self
     */
