...
/**
 * AdyenSetPaymentDetailsRequest Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class AdyenSetPaymentDetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdyenSetPaymentDetailsRequest';
     ...
     * Sets data
     *
     * @param string $data Additional details returned by Adyen front-end application.
     *
     * @return self
     */
