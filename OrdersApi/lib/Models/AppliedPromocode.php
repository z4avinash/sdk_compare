...
/**
 * AppliedPromocode Class Doc Comment
 *
 * @category Class
 ...
 */
class AppliedPromocode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppliedPromocode';
    ...
    {
        $this->container['promo_title'] = $data['promo_title'] ?? null;
        $this->container['promo_description'] = $data['promo_description'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['promo_title'] === null) {
            $invalidProperties[] = "'promo_title' can't be null";
        }
    ...
    {
        return $this->container['promo_title'];
    }

    /**
     * Sets promo_title
     *
     * @param string $promo_title Title of applied promocode.
     *
     * @return self
     */
    public function setPromoTitle($promo_title)
    {
        $this->container['promo_title'] = $promo_title;
     ...
     *
     * @param string|null $promo_description Promo description.
     *
     * @return self
     */
     ...
     * Sets promo_code
     *
     * @param string $promo_code Promocode.
     *
     * @return self
     */
