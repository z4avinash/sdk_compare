...
/**
 * AvailabilitiesListResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class AvailabilitiesListResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailabilitiesListResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'total_items' => 'int',
        'items' => '\PrioTicket\DistributorAPI\Models\AvailabilityModel[]'
    ];
    ...
    public function setTotalItems($total_items)
    {
        ...
        if (($total_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling AvailabilitiesListResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \PrioTicket\DistributorAPI\Models\AvailabilityModel[]
     */
     ...
     * Sets items
     *
     * @param \PrioTicket\DistributorAPI\Models\AvailabilityModel[] $items List of all availability slots.
     *
     * @return self
     */
