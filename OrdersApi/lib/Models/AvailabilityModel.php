...
class AvailabilityModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool $availability_active Whether this availability slot is active (open) or not (closed). This availability cannot be booked if `availability_active:false`.
     *
     * @return self
     */
