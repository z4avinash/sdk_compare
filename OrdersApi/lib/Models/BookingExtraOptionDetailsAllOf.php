<?php
/**
 * BookingExtraOptionDetailsAllOf
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * BookingExtraOptionDetailsAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class BookingExtraOptionDetailsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BookingExtraOptionDetails_allOf';
    ...
    public function setValueCount($value_count)
    {
        ...
        if (($value_count > 100)) {
            throw new \InvalidArgumentException('invalid value for $value_count when calling BookingExtraOptionDetailsAllOf., must be smaller than or equal to 100.');
        }
        if (($value_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $value_count when calling BookingExtraOptionDetailsAllOf., must be bigger than or equal to 0.');
        }
