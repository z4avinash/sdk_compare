...
/**
 * BookingItemConfirmed Class Doc Comment
 *
 * @category Class
 ...
 */
class BookingItemConfirmed implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BookingItemConfirmed';
    ...
    public function setProductTypeCount($product_type_count)
    {
        ...
        if (($product_type_count > 100)) {
            throw new \InvalidArgumentException('invalid value for $product_type_count when calling BookingItemConfirmed., must be smaller than or equal to 100.');
        }
        if (($product_type_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $product_type_count when calling BookingItemConfirmed., must be bigger than or equal to 1.');
        }
    ...
    public function setProductTypePax($product_type_pax)
    {
        ...
        if (($product_type_pax < 0)) {
            throw new \InvalidArgumentException('invalid value for $product_type_pax when calling BookingItemConfirmed., must be bigger than or equal to 0.');
        }
    ...
    public function setProductTypeCapacity($product_type_capacity)
    {
        ...
        if (!is_null($product_type_capacity) && ($product_type_capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $product_type_capacity when calling BookingItemConfirmed., must be bigger than or equal to 0.');
        }
    ...
    public function setProductTypeSpots($product_type_spots)
    {
        ...
        if (!is_null($product_type_spots) && (count($product_type_spots) < 1)) {
            throw new \InvalidArgumentException('invalid length for $product_type_spots when calling BookingItemConfirmed., number of items must be greater than or equal to 1.');
        }
