 ...
 */
class BookingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'booking_option_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BookingOption';
    ...
    protected static $attributeMap = [
        'booking_option_type' => 'booking_option_type',
    ...
    protected static $setters = [
        'booking_option_type' => 'setBookingOptionType',
    ...
    protected static $getters = [
        'booking_option_type' => 'getBookingOptionType',
    ...
    {
        $this->container['booking_option_type'] = $data['booking_option_type'] ?? 'DIRECT_BOOKING';
        ...
        $this->container['booking_option_type'] = static::$openAPIModelName;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['booking_option_type'] === null) {
            $invalidProperties[] = "'booking_option_type' can't be null";
        }
    ...
    /**
     * Gets booking_option_type
     *
     * @return string
     */
    public function getBookingOptionType()
    {
        return $this->container['booking_option_type'];
    }

    /**
     * Sets booking_option_type
     *
     * @param string $booking_option_type Used to aid in serialization, deserialization, and validation. Must be one of the following values:   * `CONFIRM_RESERVATION`   * `DIRECT_BOOKING`   * `UPDATE_BOOKING`   * `UPDATE_BOOKING_NOTES`
     *
     * @return self
     */
    public function setBookingOptionType($booking_option_type)
    {
        $this->container['booking_option_type'] = $booking_option_type;
     ...
     *
     * @param string $reservation_reference A unique identifier created by the reservation API of Prio.
     *
     * @return self
     */
    ...
    public function setBookingVersion($booking_version)
    {
        ...
        if (!is_null($booking_version) && ($booking_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $booking_version when calling BookingOption., must be bigger than or equal to 1.');
        }
