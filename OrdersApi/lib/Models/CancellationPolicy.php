...
class CancellationPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'cancellation_type' => '\PrioTicket\DistributorAPI\Models\CancellationType',
        'cancellation_fee_threshold' => 'int',
    ...
    protected static $openAPIFormats = [
        ...
        'cancellation_fee_threshold' => null,
        'cancellation_fee_percentage' => 'double',
    ...
    protected static $attributeMap = [
        ...
        'cancellation_fee_threshold' => 'cancellation_fee_threshold',
    ...
    protected static $setters = [
        'cancellation_description' => 'setCancellationDescription',
        'cancellation_type' => 'setCancellationType',
        'cancellation_fee_threshold' => 'setCancellationFeeThreshold',
        'cancellation_fee_percentage' => 'setCancellationFeePercentage',
        'cancellation_fee_amount' => 'setCancellationFeeAmount'
    ];
    ...
    protected static $getters = [
        'cancellation_description' => 'getCancellationDescription',
        'cancellation_type' => 'getCancellationType',
        'cancellation_fee_threshold' => 'getCancellationFeeThreshold',
        'cancellation_fee_percentage' => 'getCancellationFeePercentage',
        'cancellation_fee_amount' => 'getCancellationFeeAmount'
    ];
    ...
    {
        $this->container['cancellation_description'] = $data['cancellation_description'] ?? null;
        $this->container['cancellation_type'] = $data['cancellation_type'] ?? null;
        $this->container['cancellation_fee_threshold'] = $data['cancellation_fee_threshold'] ?? null;
        $this->container['cancellation_fee_percentage'] = $data['cancellation_fee_percentage'] ?? null;
        $this->container['cancellation_fee_amount'] = $data['cancellation_fee_amount'] ?? null;
    }
    ...
    /**
     * Gets cancellation_description
     *
     * @return string|null
     */
    public function getCancellationDescription()
    {
        return $this->container['cancellation_description'];
    }

    /**
     * Sets cancellation_description
     *
     * @param string|null $cancellation_description Description of this cancellation policy.
     *
     * @return self
     */
    public function setCancellationDescription($cancellation_description)
    {
        $this->container['cancellation_description'] = $cancellation_description;
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\CancellationType
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\CancellationType $cancellation_type cancellation_type
     *
     * @return self
     */
    ...
    /**
     * Gets cancellation_fee_threshold
     *
     * @return int|null
     */
    public function getCancellationFeeThreshold()
    {
        return $this->container['cancellation_fee_threshold'];
    }

    /**
     * Sets cancellation_fee_threshold
     *
     * @param int|null $cancellation_fee_threshold The amount of minutes before / after the traveldate / booking date for which this policy is applicable.
     *
     * @return self
     */
    public function setCancellationFeeThreshold($cancellation_fee_threshold)
    {
        $this->container['cancellation_fee_threshold'] = $cancellation_fee_threshold;

        return $this;
    }

    /**
     * Gets cancellation_fee_percentage
     *
     * @return double|null
     */
    public function getCancellationFeePercentage()
    {
        return $this->container['cancellation_fee_percentage'];
    }

    /**
     * Sets cancellation_fee_percentage
     *
     * @param double|null $cancellation_fee_percentage Percentage of the total booking value that should be charged.
     *
     * @return self
     */
    public function setCancellationFeePercentage($cancellation_fee_percentage)
    {
        $this->container['cancellation_fee_percentage'] = $cancellation_fee_percentage;

        return $this;
    }

    /**
     * Gets cancellation_fee_amount
     *
     * @return string|null
     */
    public function getCancellationFeeAmount()
    {
        return $this->container['cancellation_fee_amount'];
    }

    /**
     * Sets cancellation_fee_amount
     *
     * @param string|null $cancellation_fee_amount Fixed amount that should be charged.
     *
     * @return self
     */
    public function setCancellationFeeAmount($cancellation_fee_amount)
    {
        $this->container['cancellation_fee_amount'] = $cancellation_fee_amount;
