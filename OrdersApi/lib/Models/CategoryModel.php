...
class CategoryModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category_images' => '\PrioTicket\DistributorAPI\Models\Image[]',
    ...
    protected static $setters = [
        ...
        'category_parent_id' => 'setCategoryParentId',
        'category_type' => 'setCategoryType',
        'category_slug' => 'setCategorySlug',
        'category_icon' => 'setCategoryIcon',
        'category_images' => 'setCategoryImages',
        'category_products' => 'setCategoryProducts'
    ];
    ...
    protected static $getters = [
        ...
        'category_parent_id' => 'getCategoryParentId',
        'category_type' => 'getCategoryType',
        'category_slug' => 'getCategorySlug',
        'category_icon' => 'getCategoryIcon',
        'category_images' => 'getCategoryImages',
        'category_products' => 'getCategoryProducts'
    ];
    ...
    const CATEGORY_TYPE_RESELLER = 'RESELLER';
    ...
    {
        return [
            self::CATEGORY_TYPE_SYSTEM,
            self::CATEGORY_TYPE_RESELLER,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['category_parent_id'] = $data['category_parent_id'] ?? null;
        ...
        $this->container['category_images'] = $data['category_images'] ?? null;
        $this->container['category_products'] = $data['category_products'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['category_products'] === null) {
            $invalidProperties[] = "'category_products' can't be null";
        }
     ...
     * Sets category_id
     *
     * @param string $category_id Unique category identifier.
     *
     * @return self
     */
    ...
    /**
     * Gets category_parent_id
     *
     * @return string|null
     */
    public function getCategoryParentId()
    {
        return $this->container['category_parent_id'];
    }

    /**
     * Sets category_parent_id
     *
     * @param string|null $category_parent_id Optional parent category.
     *
     * @return self
     */
    public function setCategoryParentId($category_parent_id)
    {
        $this->container['category_parent_id'] = $category_parent_id;
     ...
     * Sets category_slug
     *
     * @param string|null $category_slug SEO friendly slug which can be used during URL building.
     *
     * @return self
     */
     ...
     * Sets category_icon
     *
     * @param string|null $category_icon URL which points to category icon.
     *
     * @return self
     */
    ...
    /**
     * Gets category_images
     *
     * @return \PrioTicket\DistributorAPI\Models\Image[]|null
     */
    public function getCategoryImages()
    {
        return $this->container['category_images'];
    }

    /**
     * Sets category_images
     *
     * @param \PrioTicket\DistributorAPI\Models\Image[]|null $category_images It contains images related to the category.
     *
     * @return self
     */
    public function setCategoryImages($category_images)
    {
        $this->container['category_images'] = $category_images;

        return $this;
    }

    /**
     * Gets category_products
     *
     * @return string[]
     */
    public function getCategoryProducts()
    {
        return $this->container['category_products'];
    }

    /**
     * Sets category_products
     *
     * @param string[] $category_products The products available in this category.
     *
     * @return self
     */
    public function setCategoryProducts($category_products)
    {
        $this->container['category_products'] = $category_products;
