...
/**
 * ClientCredentialsGrantResponse Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ClientCredentialsGrantResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientCredentialsGrantResponse';
     ...
     * Sets scope
     *
     * @param string|null $scope OPTIONAL, if identical to the scope requested by the client; otherwise, REQUIRED.
     *
     * @return self
     */
