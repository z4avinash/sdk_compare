...
/**
 * ConfirmedBooking Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfirmedBooking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfirmedBooking';
    ...
    protected static $openAPITypes = [
        ...
        'product_combi_details' => '\PrioTicket\DistributorAPI\Models\ConfirmedCombiBooking[]',
        'product_code' => 'string',
        'product_code_settings' => '\PrioTicket\DistributorAPI\Models\ProductCodeSettings',
        'product_type_details' => '\PrioTicket\DistributorAPI\Models\ConfirmedBookingDetail[]',
        'product_cancellation_policies' => '\PrioTicket\DistributorAPI\Models\CancellationPolicy[]',
        'booking_reference' => 'string',
        'booking_supplier_reference' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'booking_supplier_reference' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'booking_supplier_reference' => 'booking_supplier_reference'
    ];
    ...
    protected static $setters = [
        ...
        'booking_supplier_reference' => 'setBookingSupplierReference'
    ];
    ...
    protected static $getters = [
        ...
        'booking_supplier_reference' => 'getBookingSupplierReference'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['booking_reference'] = $data['booking_reference'] ?? null;
        $this->container['booking_supplier_reference'] = $data['booking_supplier_reference'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['booking_pricing'] === null) {
            $invalidProperties[] = "'booking_pricing' can't be null";
        }
        ...
        if ($this->container['booking_reference'] === null) {
            $invalidProperties[] = "'booking_reference' can't be null";
        }
        if ((mb_strlen($this->container['booking_reference']) < 8)) {
            $invalidProperties[] = "invalid value for 'booking_reference', the character length must be bigger than or equal to 8.";
        }
    ...
    public function setBookingVersion($booking_version)
    {
        ...
        if (!is_null($booking_version) && ($booking_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $booking_version when calling ConfirmedBooking., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\Pricing $booking_pricing booking_pricing
     *
     * @return self
     */
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\ConfirmedCombiBooking[]|null
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\ConfirmedCombiBooking[]|null $product_combi_details A list of the confirmed combi-products.
     *
     * @return self
     */
     ...
     * Sets product_code
     *
     * @param string|null $product_code The product code. More details can be found on `product_code_settings`
     *
     * @return self
     */
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\ConfirmedBookingDetail[]
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\ConfirmedBookingDetail[] $product_type_details A list of details on the confirmed booked product types.
     *
     * @return self
     */
     ...
     *
     * @param string $booking_reference Unique identifier for booking assigned by Prio.
     *
     * @return self
     */
    public function setBookingReference($booking_reference)
    {
        ...
        if ((mb_strlen($booking_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $booking_reference when calling ConfirmedBooking., must be bigger than or equal to 8.');
        }
    ...
    /**
     * Gets booking_supplier_reference
     *
     * @return string|null
     */
    public function getBookingSupplierReference()
    {
        return $this->container['booking_supplier_reference'];
    }

    /**
     * Sets booking_supplier_reference
     *
     * @param string|null $booking_supplier_reference Unique identifier for booking assigned by supplier system. Only applicable if `product_third_party:true`.
     *
     * @return self
     */
    public function setBookingSupplierReference($booking_supplier_reference)
    {
        $this->container['booking_supplier_reference'] = $booking_supplier_reference;
