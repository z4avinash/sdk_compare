...
/**
 * ContactDetailResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactDetailResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\ContactDetailResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\ContactDetailResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\ContactDetailResponseData $data data
     *
     * @return self
     */
