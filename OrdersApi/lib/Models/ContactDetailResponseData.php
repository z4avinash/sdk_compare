...
/**
 * ContactDetailResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactDetailResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactDetailResponseData';
     ...
     * Sets items
     *
     * @param \PrioTicket\DistributorAPI\Models\ContactDetails[] $items A list of all contact revisions.   If `include_versions:false`, only a single record will be returned.
     *
     * @return self
     */
