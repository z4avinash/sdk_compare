...
/**
 * CreateNotificationRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateNotificationRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateNotificationRequestData';
    ...
    protected static $openAPITypes = [
        ...
        'notification' => '\PrioTicket\DistributorAPI\Models\WebhookNotification'
    ];
     ...
     * Sets notification
     *
     * @param \PrioTicket\DistributorAPI\Models\WebhookNotification $notification notification
     *
     * @return self
     */
