...
class CreatePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\CreatePaymentRequestData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\CreatePaymentRequestData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\CreatePaymentRequestData $data data
     *
     * @return self
     */
