...
class Currency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'currency_language_code' => 'string',
        'currency_region_code' => 'string',
        'currency_symbol' => 'string',
        'currency_symbol_position' => '\PrioTicket\DistributorAPI\Models\CurrencySymbolPosition',
        'currency_decimal_digits' => 'int',
        'currency_decimal_delimiter' => 'string',
        'currency_thousand_delimiter' => 'string',
        'currency_space_between_amount_and_symbol' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'currency_code' => null,
        'currency_language_code' => null,
        'currency_region_code' => null,
        'currency_symbol' => null,
        'currency_symbol_position' => null,
        'currency_decimal_digits' => null,
        'currency_decimal_delimiter' => null,
        'currency_thousand_delimiter' => null,
        'currency_space_between_amount_and_symbol' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'currency_language_code' => 'currency_language_code',
        'currency_region_code' => 'currency_region_code',
        'currency_symbol' => 'currency_symbol',
        'currency_symbol_position' => 'currency_symbol_position',
        'currency_decimal_digits' => 'currency_decimal_digits',
        'currency_decimal_delimiter' => 'currency_decimal_delimiter',
        'currency_thousand_delimiter' => 'currency_thousand_delimiter',
        'currency_space_between_amount_and_symbol' => 'currency_space_between_amount_and_symbol'
    ];
    ...
    protected static $setters = [
        ...
        'currency_language_code' => 'setCurrencyLanguageCode',
        'currency_region_code' => 'setCurrencyRegionCode',
        'currency_symbol' => 'setCurrencySymbol',
        'currency_symbol_position' => 'setCurrencySymbolPosition',
        'currency_decimal_digits' => 'setCurrencyDecimalDigits',
        'currency_decimal_delimiter' => 'setCurrencyDecimalDelimiter',
        'currency_thousand_delimiter' => 'setCurrencyThousandDelimiter',
        'currency_space_between_amount_and_symbol' => 'setCurrencySpaceBetweenAmountAndSymbol'
    ];
    ...
    protected static $getters = [
        ...
        'currency_language_code' => 'getCurrencyLanguageCode',
        'currency_region_code' => 'getCurrencyRegionCode',
        'currency_symbol' => 'getCurrencySymbol',
        'currency_symbol_position' => 'getCurrencySymbolPosition',
        'currency_decimal_digits' => 'getCurrencyDecimalDigits',
        'currency_decimal_delimiter' => 'getCurrencyDecimalDelimiter',
        'currency_thousand_delimiter' => 'getCurrencyThousandDelimiter',
        'currency_space_between_amount_and_symbol' => 'getCurrencySpaceBetweenAmountAndSymbol'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['currency_language_code'] = $data['currency_language_code'] ?? null;
        $this->container['currency_region_code'] = $data['currency_region_code'] ?? null;
        $this->container['currency_symbol'] = $data['currency_symbol'] ?? null;
        $this->container['currency_symbol_position'] = $data['currency_symbol_position'] ?? null;
        $this->container['currency_decimal_digits'] = $data['currency_decimal_digits'] ?? null;
        $this->container['currency_decimal_delimiter'] = $data['currency_decimal_delimiter'] ?? null;
        $this->container['currency_thousand_delimiter'] = $data['currency_thousand_delimiter'] ?? null;
        $this->container['currency_space_between_amount_and_symbol'] = $data['currency_space_between_amount_and_symbol'] ?? 'true';
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['currency_language_code'] === null) {
            $invalidProperties[] = "'currency_language_code' can't be null";
        }
        if ($this->container['currency_region_code'] === null) {
            $invalidProperties[] = "'currency_region_code' can't be null";
        }
        if ($this->container['currency_symbol'] === null) {
            $invalidProperties[] = "'currency_symbol' can't be null";
        }
        if ($this->container['currency_symbol_position'] === null) {
            $invalidProperties[] = "'currency_symbol_position' can't be null";
        }
     ...
     * Sets currency_code
     *
     * @param string $currency_code Currency Code, according to [ISO-4217](https://en.wikipedia.org/wiki/ISO_4217).
     *
     * @return self
     */
    ...
    /**
     * Gets currency_language_code
     *
     * @return string
     * @deprecated
     */
    public function getCurrencyLanguageCode()
    {
        return $this->container['currency_language_code'];
    }

    /**
     * Sets currency_language_code
     *
     * @param string $currency_language_code Currency language code.
     *
     * @return self
     * @deprecated
     */
    public function setCurrencyLanguageCode($currency_language_code)
    {
        $this->container['currency_language_code'] = $currency_language_code;

        return $this;
    }

    /**
     * Gets currency_region_code
     *
     * @return string
     * @deprecated
     */
    public function getCurrencyRegionCode()
    {
        return $this->container['currency_region_code'];
    }

    /**
     * Sets currency_region_code
     *
     * @param string $currency_region_code Currency region code.
     *
     * @return self
     * @deprecated
     */
    public function setCurrencyRegionCode($currency_region_code)
    {
        $this->container['currency_region_code'] = $currency_region_code;
    ...
    /**
     * Gets currency_symbol_position
     *
     * @return \PrioTicket\DistributorAPI\Models\CurrencySymbolPosition
     * @deprecated
     */
    public function getCurrencySymbolPosition()
    {
        return $this->container['currency_symbol_position'];
    }

    /**
     * Sets currency_symbol_position
     *
     * @param \PrioTicket\DistributorAPI\Models\CurrencySymbolPosition $currency_symbol_position currency_symbol_position
     *
     * @return self
     * @deprecated
     */
    ...
    {
        $this->container['currency_symbol_position'] = $currency_symbol_position;

        return $this;
    }

    /**
     * Gets currency_decimal_digits
     *
     * @return int|null
     * @deprecated
     */
    ...
    {
        return $this->container['currency_decimal_digits'];
    }

    /**
     * Sets currency_decimal_digits
     *
     * @param int|null $currency_decimal_digits Currency decimal digits.
     *
     * @return self
     * @deprecated
     */
    public function setCurrencyDecimalDigits($currency_decimal_digits)
    {
        $this->container['currency_decimal_digits'] = $currency_decimal_digits;

        return $this;
    }

    /**
     * Gets currency_decimal_delimiter
     *
     * @return string|null
     * @deprecated
     */
    public function getCurrencyDecimalDelimiter()
    {
        return $this->container['currency_decimal_delimiter'];
    }

    /**
     * Sets currency_decimal_delimiter
     *
     * @param string|null $currency_decimal_delimiter Currency decimal delimiter.
     *
     * @return self
     * @deprecated
     */
    public function setCurrencyDecimalDelimiter($currency_decimal_delimiter)
    {
        $this->container['currency_decimal_delimiter'] = $currency_decimal_delimiter;

        return $this;
    }

    /**
     * Gets currency_thousand_delimiter
     *
     * @return string|null
     * @deprecated
     */
    public function getCurrencyThousandDelimiter()
    {
        return $this->container['currency_thousand_delimiter'];
    }

    /**
     * Sets currency_thousand_delimiter
     *
     * @param string|null $currency_thousand_delimiter Currency thousand delimiter.
     *
     * @return self
     * @deprecated
     */
    public function setCurrencyThousandDelimiter($currency_thousand_delimiter)
    {
        $this->container['currency_thousand_delimiter'] = $currency_thousand_delimiter;

        return $this;
    }

    /**
     * Gets currency_space_between_amount_and_symbol
     *
     * @return string|null
     * @deprecated
     */
    public function getCurrencySpaceBetweenAmountAndSymbol()
    {
        return $this->container['currency_space_between_amount_and_symbol'];
    }

    /**
     * Sets currency_space_between_amount_and_symbol
     *
     * @param string|null $currency_space_between_amount_and_symbol Currency space between amount and symbol.
     *
     * @return self
     * @deprecated
     */
    public function setCurrencySpaceBetweenAmountAndSymbol($currency_space_between_amount_and_symbol)
    {
        $this->container['currency_space_between_amount_and_symbol'] = $currency_space_between_amount_and_symbol;
