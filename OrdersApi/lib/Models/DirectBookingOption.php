...
/**
 * DirectBookingOption Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectBookingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectBookingOption';
    ...
    public function setBookingVersion($booking_version)
    {
        ...
        if (!is_null($booking_version) && ($booking_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $booking_version when calling DirectBookingOption., must be bigger than or equal to 1.');
        }
