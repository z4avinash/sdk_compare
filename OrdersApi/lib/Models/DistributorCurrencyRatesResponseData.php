...
/**
 * DistributorCurrencyRatesResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributorCurrencyRatesResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorCurrencyRatesResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'total_items' => 'int',
        'items' => '\PrioTicket\DistributorAPI\Models\CurrencyConversion[]'
    ];
    ...
    public function setTotalItems($total_items)
    {
        ...
        if (($total_items > 500)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling DistributorCurrencyRatesResponseData., must be smaller than or equal to 500.');
        }
        if (($total_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling DistributorCurrencyRatesResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \PrioTicket\DistributorAPI\Models\CurrencyConversion[]
     */
     ...
     * Sets items
     *
     * @param \PrioTicket\DistributorAPI\Models\CurrencyConversion[] $items items
     *
     * @return self
     */
