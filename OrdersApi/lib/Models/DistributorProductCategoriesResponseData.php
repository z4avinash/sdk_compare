...
/**
 * DistributorProductCategoriesResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributorProductCategoriesResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorProductCategoriesResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'total_items' => 'int',
        'items' => '\PrioTicket\DistributorAPI\Models\CategoryModel[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['total_items'] > 500)) {
            $invalidProperties[] = "invalid value for 'total_items', must be smaller than or equal to 500.";
        }
    ...
    public function setTotalItems($total_items)
    {
        ...
        if (($total_items > 500)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling DistributorProductCategoriesResponseData., must be smaller than or equal to 500.');
        }
        if (($total_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling DistributorProductCategoriesResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \PrioTicket\DistributorAPI\Models\CategoryModel[]
     */
     ...
     * Sets items
     *
     * @param \PrioTicket\DistributorAPI\Models\CategoryModel[] $items items
     *
     * @return self
     */
