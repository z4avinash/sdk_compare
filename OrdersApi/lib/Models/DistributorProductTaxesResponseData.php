...
/**
 * DistributorProductTaxesResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributorProductTaxesResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorProductTaxesResponseData';
    ...
    protected static $openAPITypes = [
        'kind' => '\PrioTicket\DistributorAPI\Models\Kind',
        ...
        'page_index' => 'int',
        'total_pages' => 'int',
        'items' => '\PrioTicket\DistributorAPI\Models\ProductTaxDetail[]'
    ];
    ...
    protected static $setters = [
        'kind' => 'setKind',
        'current_item_count' => 'setCurrentItemCount',
    ...
    protected static $getters = [
        'kind' => 'getKind',
        'current_item_count' => 'getCurrentItemCount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['current_item_count'] = $data['current_item_count'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['current_item_count'] === null) {
            $invalidProperties[] = "'current_item_count' can't be null";
        }
        if (($this->container['current_item_count'] > 500)) {
            $invalidProperties[] = "invalid value for 'current_item_count', must be smaller than or equal to 500.";
        }

        if (($this->container['current_item_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'current_item_count', must be bigger than or equal to 0.";
        }

        if ($this->container['items_per_page'] === null) {
            $invalidProperties[] = "'items_per_page' can't be null";
        }
        if (($this->container['items_per_page'] > 500)) {
            $invalidProperties[] = "invalid value for 'items_per_page', must be smaller than or equal to 500.";
        }
        ...
        if (($this->container['start_index'] < 1)) {
        ...
        if (($this->container['page_index'] < 1)) {
     ...
     * Gets kind
     *
     * @return \PrioTicket\DistributorAPI\Models\Kind
     */
     ...
     * Sets kind
     *
     * @param \PrioTicket\DistributorAPI\Models\Kind $kind kind
     *
     * @return self
     */
    ...
    /**
     * Gets current_item_count
     *
     * @return int
     */
    public function getCurrentItemCount()
    {
        return $this->container['current_item_count'];
    }

    /**
     * Sets current_item_count
     *
     * @param int $current_item_count The number of items in this result set. Should be equivalent to items.length, and is provided as a convenience property. For example, suppose a developer requests a set of search items, and asks for 10 items per page. The total set of that search has 14 total items. The first page of items will have 10 items in it, so both `items_per_page` and `current_item_count` will equal \"10\". The next page of items will have the remaining 4 items; `items_per_page` will still be \"10\", but `current_item_count` will be \"4\".
     *
     * @return self
     */
    public function setCurrentItemCount($current_item_count)
    {

        if (($current_item_count > 500)) {
            throw new \InvalidArgumentException('invalid value for $current_item_count when calling DistributorProductTaxesResponseData., must be smaller than or equal to 500.');
        }
        if (($current_item_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_item_count when calling DistributorProductTaxesResponseData., must be bigger than or equal to 0.');
        }

        $this->container['current_item_count'] = $current_item_count;
     ...
     * Sets items_per_page
     *
     * @param int $items_per_page The number of items in the result. This is not necessarily the size of the data.items array; if we are viewing the last page of items, the size of data.items may be less than `items_per_page`. However the size of data.items should not exceed `items_per_page`.
     *
     * @return self
     */
    public function setItemsPerPage($items_per_page)
    {
        ...
        if (($items_per_page > 500)) {
            throw new \InvalidArgumentException('invalid value for $items_per_page when calling DistributorProductTaxesResponseData., must be smaller than or equal to 500.');
        }
        if (($items_per_page < 0)) {
            throw new \InvalidArgumentException('invalid value for $items_per_page when calling DistributorProductTaxesResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Sets start_index
     *
     * @param int $start_index The index of the first item in data.items. For consistency, `start_index` should be 1-based. For example, the first item in the first set of items should have a `start_index` of 1. If the user requests the next set of data, the `start_index` may be 10.
     *
     * @return self
     */
    public function setStartIndex($start_index)
    {
        ...
        if (($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling DistributorProductTaxesResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets total_items
     *
     * @param int $total_items The total number of items available in this set. For example, if a user has 100 blog posts, the response may only contain 10 items, but the `total_items` would be 100.
     *
     * @return self
     */
    public function setTotalItems($total_items)
    {
        ...
        if (($total_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling DistributorProductTaxesResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Sets page_index
     *
     * @param int $page_index The index of the current page of items. For consistency, `page_index` should be 1-based. For example, the first page of items has a `page_index` of 1. `page_index` can also be calculated from the item-based paging properties: `page_index` = floor(`start_index` / `items_per_page`) + 1.
     *
     * @return self
     */
    public function setPageIndex($page_index)
    {
        ...
        if (($page_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_index when calling DistributorProductTaxesResponseData., must be bigger than or equal to 1.');
        }
     ...
     * Sets total_pages
     *
     * @param int $total_pages The total number of pages in the result set. `total_pages` can also be calculated from the item-based paging properties above: `total_pages` = ceiling(`total_items` / `items_per_page`)
     *
     * @return self
     */
    public function setTotalPages($total_pages)
    {
        ...
        if (($total_pages < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_pages when calling DistributorProductTaxesResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductTaxDetail[]|null
     */
     ...
     * Sets items
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductTaxDetail[]|null $items items
     *
     * @return self
     */
