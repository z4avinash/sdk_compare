...
/**
 * EmailOptionsModel Class Doc Comment
 *
 * @category Class
 ...
 */
class EmailOptionsModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailOptionsModel';
    ...
    protected static $openAPITypes = [
        'email_types' => '\PrioTicket\DistributorAPI\Models\EmailTypes'
    ];
    ...
    {
        $this->container['email_types'] = $data['email_types'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_types'] === null) {
            $invalidProperties[] = "'email_types' can't be null";
        }
     ...
     * Gets email_types
     *
     * @return \PrioTicket\DistributorAPI\Models\EmailTypes
     */
    public function getEmailTypes()
    {
        return $this->container['email_types'];
    }

    /**
     * Sets email_types
     *
     * @param \PrioTicket\DistributorAPI\Models\EmailTypes $email_types email_types
     *
     * @return self
     */
    public function setEmailTypes($email_types)
    {
        $this->container['email_types'] = $email_types;
