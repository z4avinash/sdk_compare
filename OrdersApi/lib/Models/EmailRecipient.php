...
class EmailRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'recipients_name' => 'setRecipientsName',
        'recipients_address' => 'setRecipientsAddress'
    ];
    ...
    protected static $getters = [
        'recipients_name' => 'getRecipientsName',
        'recipients_address' => 'getRecipientsAddress'
    ];
    ...
    {
        $this->container['recipients_name'] = $data['recipients_name'] ?? null;
        $this->container['recipients_address'] = $data['recipients_address'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recipients_address'] === null) {
            $invalidProperties[] = "'recipients_address' can't be null";
        }
    ...
    /**
     * Gets recipients_name
     *
     * @return string|null
     */
    public function getRecipientsName()
    {
        return $this->container['recipients_name'];
    }

    /**
     * Sets recipients_name
     *
     * @param string|null $recipients_name Recipient name.
     *
     * @return self
     */
    public function setRecipientsName($recipients_name)
    {
        $this->container['recipients_name'] = $recipients_name;

        return $this;
    }

    /**
     * Gets recipients_address
     *
     * @return string
     */
    public function getRecipientsAddress()
    {
        return $this->container['recipients_address'];
    }

    /**
     * Sets recipients_address
     *
     * @param string $recipients_address Recipient address.
     *
     * @return self
     */
    public function setRecipientsAddress($recipients_address)
    {
        $this->container['recipients_address'] = $recipients_address;
