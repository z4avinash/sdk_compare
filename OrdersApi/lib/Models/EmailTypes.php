...
class EmailTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets send_tickets
     *
     * @param bool|null $send_tickets Send all vouchers to the specified email recipients.
     *
     * @return self
     */
     ...
     * Sets send_receipt
     *
     * @param bool|null $send_receipt Send the receipt to the specified email recipients.
     *
     * @return self
     */
     ...
     * Sets send_marketing
     *
     * @param bool|null $send_marketing Send marketing to the specified email recipients.
     *
     * @return self
     */
     ...
     * Sets send_offers
     *
     * @param bool|null $send_offers Send offers to the specified email recipients.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $send_notification Send notifications to the specified email recipients.
     *
     * @return self
     */
