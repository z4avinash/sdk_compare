...
class ErrorModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['error_reference'] === null) {
            $invalidProperties[] = "'error_reference' can't be null";
        }
     ...
     * Sets error
     *
     * @param string $error The error code which occured.  As our API has over 1000+ unique error codes (grouped by HTTP status). We discourage implementing individual errors on your customer front-end interface and suggest a catch-all clause for each HTTP status code instead.
     *
     * @return self
     */
     ...
     *
     * @param string $error_reference Unique reference linked to this error.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message Customer friendly error message which can be shown on your front-end.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string|null $error_description Human-readable ASCII [[USASCII]](https://tools.ietf.org/html/rfc6749#ref-USASCII) text providing additional information, used to assist the client developer in understanding the error that occurred.
     *
     * @return self
     */
     ...
     * Sets error_uri
     *
     * @param string|null $error_uri A URI identifying a human-readable web page with information about the error, used to provide the client  developer with additional information about the error.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param string[]|null $errors Specific messages indicating one or more problems.
     *
     * @return self
     */
