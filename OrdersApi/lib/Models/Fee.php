...
class Fee implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets fee_included
     *
     * @param bool $fee_included Whether this is an additional fee that should be listed separately and included in the `price_total` or is part of a calculation, e.g. margin breakdown (informational only).
     *
     * @return self
     */
     ...
     * Sets fee_refundable
     *
     * @param bool $fee_refundable Whether this fee is refundable.
     *
     * @return self
     */
