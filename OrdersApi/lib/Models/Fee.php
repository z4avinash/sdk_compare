...
class Fee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'fee_label' => 'string',
        'fee_type' => '\PrioTicket\DistributorAPI\Models\FeeType',
        'fee_amount' => 'string',
        'fee_percentage' => 'string',
        'fee_tax_id' => 'string',
        'fee_tax_amount' => 'string',
        'fee_included' => 'string',
        'fee_refundable' => 'string'
    ];
    ...
    protected static $setters = [
        'fee_label' => 'setFeeLabel',
        'fee_type' => 'setFeeType',
        'fee_amount' => 'setFeeAmount',
        'fee_percentage' => 'setFeePercentage',
        'fee_tax_id' => 'setFeeTaxId',
        'fee_tax_amount' => 'setFeeTaxAmount',
        'fee_included' => 'setFeeIncluded',
        'fee_refundable' => 'setFeeRefundable'
    ];
    ...
    protected static $getters = [
        'fee_label' => 'getFeeLabel',
        'fee_type' => 'getFeeType',
        'fee_amount' => 'getFeeAmount',
        'fee_percentage' => 'getFeePercentage',
        'fee_tax_id' => 'getFeeTaxId',
        'fee_tax_amount' => 'getFeeTaxAmount',
        'fee_included' => 'getFeeIncluded',
        'fee_refundable' => 'getFeeRefundable'
    ];
    ...
    {
        $this->container['fee_label'] = $data['fee_label'] ?? null;
        $this->container['fee_type'] = $data['fee_type'] ?? null;
        $this->container['fee_amount'] = $data['fee_amount'] ?? null;
        $this->container['fee_percentage'] = $data['fee_percentage'] ?? null;
        $this->container['fee_tax_id'] = $data['fee_tax_id'] ?? null;
        $this->container['fee_tax_amount'] = $data['fee_tax_amount'] ?? null;
        $this->container['fee_included'] = $data['fee_included'] ?? null;
        $this->container['fee_refundable'] = $data['fee_refundable'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fee_tax_id'] === null) {
            $invalidProperties[] = "'fee_tax_id' can't be null";
        }
        if ($this->container['fee_tax_amount'] === null) {
            $invalidProperties[] = "'fee_tax_amount' can't be null";
        }
        if ($this->container['fee_included'] === null) {
            $invalidProperties[] = "'fee_included' can't be null";
        }
        if ($this->container['fee_refundable'] === null) {
            $invalidProperties[] = "'fee_refundable' can't be null";
        }
    ...
    {
        return $this->container['fee_label'];
    }

    /**
     * Sets fee_label
     *
     * @param string|null $fee_label Fee label.
     *
     * @return self
     * @deprecated
     */
    public function setFeeLabel($fee_label)
    {
        $this->container['fee_label'] = $fee_label;
     ...
     * Gets fee_type
     *
     * @return \PrioTicket\DistributorAPI\Models\FeeType
     */
     ...
     * Sets fee_type
     *
     * @param \PrioTicket\DistributorAPI\Models\FeeType $fee_type fee_type
     *
     * @return self
     */
     ...
     * Sets fee_amount
     *
     * @param string $fee_amount The applicable fee amount, can either be a surcharge or discount.
     *
     * @return self
     */
     ...
     * Sets fee_percentage
     *
     * @param string|null $fee_percentage Fee percentage.
     *
     * @return self
     */
     ...
     * @deprecated
     */
    public function getFeeTaxId()
    {
        return $this->container['fee_tax_id'];
    }

    /**
     * Sets fee_tax_id
     *
     * @param string $fee_tax_id Tax ID for this fee. Tax information can be retrieved from the Tax API.
     *
     * @return self
     * @deprecated
     */
    public function setFeeTaxId($fee_tax_id)
    {
        $this->container['fee_tax_id'] = $fee_tax_id;
    ...
    {
        return $this->container['fee_tax_amount'];
    }

    /**
     * Sets fee_tax_amount
     *
     * @param string $fee_tax_amount Amount of tax.
     *
     * @return self
     * @deprecated
     */
    public function setFeeTaxAmount($fee_tax_amount)
    {
        $this->container['fee_tax_amount'] = $fee_tax_amount;
    ...
    {
        return $this->container['fee_included'];
    }

    /**
     * Sets fee_included
     *
     * @param string $fee_included Whether this is an additional fee that should be listed separately and included in the `price_total` or is part of a calculation, e.g. margin breakdown (informational only).
     *
     * @return self
     * @deprecated
     */
    public function setFeeIncluded($fee_included)
    {
        $this->container['fee_included'] = $fee_included;
     ...
     * @deprecated
     */
    public function getFeeRefundable()
    {
        return $this->container['fee_refundable'];
    }

    /**
     * Sets fee_refundable
     *
     * @param string $fee_refundable Whether this fee is refundable.
     *
     * @return self
     * @deprecated
     */
    public function setFeeRefundable($fee_refundable)
    {
        $this->container['fee_refundable'] = $fee_refundable;
