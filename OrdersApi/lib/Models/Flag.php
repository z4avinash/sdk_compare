...
class Flag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'flag_value_id' => 'setFlagValueId',
        'flag_value' => 'setFlagValue',
        'flag_visible' => 'setFlagVisible'
    ];
    ...
    protected static $getters = [
        ...
        'flag_value_id' => 'getFlagValueId',
        'flag_value' => 'getFlagValue',
        'flag_visible' => 'getFlagVisible'
    ];
    ...
    const FLAG_TYPE_FLAG = 'FLAG';
    const FLAG_TYPE_CONTENT_LABEL = 'CONTENT_LABEL';
    const FLAG_TYPE_PARTNER_LABEL = 'PARTNER_LABEL';
    const FLAG_TYPE_MARKETING_LABEL = 'MARKETING_LABEL';
    const FLAG_TYPE_FINANCIAL_LABEL = 'FINANCIAL_LABEL';
    const FLAG_TYPE_PROMOTION_LABEL = 'PROMOTION_LABEL';
     ...
     * @return string[]
     */
    public function getFlagTypeAllowableValues()
    {
        return [
            self::FLAG_TYPE_FLAG,
            self::FLAG_TYPE_CONTENT_LABEL,
            self::FLAG_TYPE_PARTNER_LABEL,
            self::FLAG_TYPE_MARKETING_LABEL,
            self::FLAG_TYPE_FINANCIAL_LABEL,
            self::FLAG_TYPE_PROMOTION_LABEL,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['flag_name'] = $data['flag_name'] ?? null;
        $this->container['flag_type'] = $data['flag_type'] ?? null;
        $this->container['flag_value_id'] = $data['flag_value_id'] ?? null;
        $this->container['flag_value'] = $data['flag_value'] ?? null;
        $this->container['flag_visible'] = $data['flag_visible'] ?? 'true';
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getFlagTypeAllowableValues();
        if (!is_null($this->container['flag_type']) && !in_array($this->container['flag_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'flag_type', must be one of '%s'",
                $this->container['flag_type'],
     ...
     * Sets flag_id
     *
     * @param string $flag_id Flag identifier.
     *
     * @return self
     */
     ...
     * Sets flag_type
     *
     * @param string|null $flag_type Type of flag.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getFlagTypeAllowableValues();
        if (!is_null($flag_type) && !in_array($flag_type, $allowedValues, true)) {
     ...
     * @return string|null
     */
    public function getFlagValueId()
    {
        return $this->container['flag_value_id'];
    }

    /**
     * Sets flag_value_id
     *
     * @param string|null $flag_value_id Flag value identifier.
     *
     * @return self
     */
    public function setFlagValueId($flag_value_id)
    {
        $this->container['flag_value_id'] = $flag_value_id;
     ...
     * Sets flag_value
     *
     * @param string $flag_value Flag value.
     *
     * @return self
     */
     ...
     * @deprecated
     */
    public function getFlagVisible()
    {
        return $this->container['flag_visible'];
    }

    /**
     * Sets flag_visible
     *
     * @param string|null $flag_visible Whether this flag should be shown to the customer.
     *
     * @return self
     * @deprecated
     */
    public function setFlagVisible($flag_visible)
    {
        $this->container['flag_visible'] = $flag_visible;
