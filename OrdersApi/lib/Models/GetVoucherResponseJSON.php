...
/**
 * GetVoucherResponseJSON Class Doc Comment
 *
 * @category Class
 ...
 */
class GetVoucherResponseJSON implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetVoucherResponseJSON';
    ...
    protected static $openAPITypes = [
        'data' => '\PrioTicket\DistributorAPI\Models\GetVoucherResponseJSONData',
        'url' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\GetVoucherResponseJSONData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\GetVoucherResponseJSONData $data data
     *
     * @return self
     */
