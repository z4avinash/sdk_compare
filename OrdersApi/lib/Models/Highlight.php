...
class Highlight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'highlight_description' => 'setHighlightDescription',
        'highlight_type' => 'setHighlightType',
        'highlight_icon' => 'setHighlightIcon'
    ];
    ...
    protected static $getters = [
        ...
        'highlight_description' => 'getHighlightDescription',
        'highlight_type' => 'getHighlightType',
        'highlight_icon' => 'getHighlightIcon'
    ];
    ...
    const HIGHLIGHT_TYPE_SLOGAN = 'SLOGAN';
    const HIGHLIGHT_TYPE_ADDON = 'ADDON';
    const HIGHLIGHT_TYPE_INCLUDES = 'INCLUDES';
    const HIGHLIGHT_TYPE_ABOUT = 'ABOUT';
     ...
     * @return string[]
     */
    public function getHighlightTypeAllowableValues()
    {
        return [
            self::HIGHLIGHT_TYPE_SLOGAN,
            self::HIGHLIGHT_TYPE_ADDON,
            self::HIGHLIGHT_TYPE_INCLUDES,
            self::HIGHLIGHT_TYPE_ABOUT,
        ];
    }
    ...
    {
        $this->container['highlight_id'] = $data['highlight_id'] ?? null;
        $this->container['highlight_description'] = $data['highlight_description'] ?? null;
        $this->container['highlight_type'] = $data['highlight_type'] ?? null;
        $this->container['highlight_icon'] = $data['highlight_icon'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['highlight_id'] === null) {
            $invalidProperties[] = "'highlight_id' can't be null";
        }
        if ($this->container['highlight_description'] === null) {
            $invalidProperties[] = "'highlight_description' can't be null";
        }
        $allowedValues = $this->getHighlightTypeAllowableValues();
        if (!is_null($this->container['highlight_type']) && !in_array($this->container['highlight_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'highlight_type', must be one of '%s'",
                $this->container['highlight_type'],
    ...
    /**
     * Gets highlight_description
     *
     * @return string
     */
    public function getHighlightDescription()
    {
        return $this->container['highlight_description'];
    }

    /**
     * Sets highlight_description
     *
     * @param string $highlight_description Description of the highlight.
     *
     * @return self
     */
    public function setHighlightDescription($highlight_description)
    {
        $this->container['highlight_description'] = $highlight_description;
     ...
     * Sets highlight_type
     *
     * @param string|null $highlight_type Highlight type.
     *
     * @return self
     * @deprecated
     */
    ...
    {
        $allowedValues = $this->getHighlightTypeAllowableValues();
        if (!is_null($highlight_type) && !in_array($highlight_type, $allowedValues, true)) {
     ...
     * @deprecated
     */
    public function getHighlightIcon()
    {
        return $this->container['highlight_icon'];
    }

    /**
     * Sets highlight_icon
     *
     * @param string|null $highlight_icon Highlight icon.
     *
     * @return self
     * @deprecated
     */
    public function setHighlightIcon($highlight_icon)
    {
        $this->container['highlight_icon'] = $highlight_icon;
