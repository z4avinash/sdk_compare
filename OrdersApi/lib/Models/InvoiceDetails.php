...
class InvoiceDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'invoice_status' => '\PrioTicket\DistributorAPI\Models\InvoiceStatus',
        'invoice_type' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'invoice_product_quantity' => 'invoice_product_quantity',
    ...
    protected static $setters = [
        ...
        'invoice_product_quantity' => 'setInvoiceProductQuantity',
    ...
    protected static $getters = [
        ...
        'invoice_product_quantity' => 'getInvoiceProductQuantity',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invoice_product_id'] = $data['invoice_product_id'] ?? null;
        $this->container['invoice_product_quantity'] = $data['invoice_product_quantity'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['invoice_product_id'] === null) {
            $invalidProperties[] = "'invoice_product_id' can't be null";
        }
        if ($this->container['invoice_product_quantity'] === null) {
            $invalidProperties[] = "'invoice_product_quantity' can't be null";
        }
     ...
     *
     * @param string $invoice_product_id The product ID of this invoice.
     *
     * @return self
     */
    ...
    /**
     * Gets invoice_product_quantity
     *
     * @return int
     */
    public function getInvoiceProductQuantity()
    {
        return $this->container['invoice_product_quantity'];
    }

    /**
     * Sets invoice_product_quantity
     *
     * @param int $invoice_product_quantity The quantity of products invoiced.
     *
     * @return self
     */
    public function setInvoiceProductQuantity($invoice_product_quantity)
    {
        $this->container['invoice_product_quantity'] = $invoice_product_quantity;
     ...
     * Sets invoice_date
     *
     * @param \DateTime $invoice_date Date of invoice.
     *
     * @return self
     */
     ...
     * Gets invoice_status
     *
     * @return \PrioTicket\DistributorAPI\Models\InvoiceStatus
     */
     ...
     * Sets invoice_status
     *
     * @param \PrioTicket\DistributorAPI\Models\InvoiceStatus $invoice_status invoice_status
     *
     * @return self
     */
     ...
     * Sets invoice_type
     *
     * @param string $invoice_type Type of invoice.
     *
     * @return self
     */
