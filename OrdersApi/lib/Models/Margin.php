...
class Margin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'margin_type' => '\PrioTicket\DistributorAPI\Models\FeeType',
        'margin_amount' => 'string',
        'margin_tax_id' => 'string',
        'margin_tax_amount' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'margin_tax_id' => 'margin_tax_id',
        'margin_tax_amount' => 'margin_tax_amount'
    ];
    ...
    protected static $setters = [
        ...
        'margin_amount' => 'setMarginAmount',
        'margin_tax_id' => 'setMarginTaxId',
        'margin_tax_amount' => 'setMarginTaxAmount'
    ];
    ...
    protected static $getters = [
        ...
        'margin_tax_id' => 'getMarginTaxId',
        'margin_tax_amount' => 'getMarginTaxAmount'
    ];
    ...
    {
        $this->container['margin_type'] = $data['margin_type'] ?? null;
        $this->container['margin_amount'] = $data['margin_amount'] ?? null;
        $this->container['margin_tax_id'] = $data['margin_tax_id'] ?? null;
        $this->container['margin_tax_amount'] = $data['margin_tax_amount'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['margin_amount'] === null) {
            $invalidProperties[] = "'margin_amount' can't be null";
        }
        if ($this->container['margin_tax_id'] === null) {
            $invalidProperties[] = "'margin_tax_id' can't be null";
        }
        if ($this->container['margin_tax_amount'] === null) {
            $invalidProperties[] = "'margin_tax_amount' can't be null";
        }
     ...
     * Sets margin_type
     *
     * @param \PrioTicket\DistributorAPI\Models\FeeType $margin_type margin_type
     *
     * @return self
     */
    ...
    {
        return $this->container['margin_amount'];
    }

    /**
     * Sets margin_amount
     *
     * @param string $margin_amount The calculated margin.
     *
     * @return self
     */
    public function setMarginAmount($margin_amount)
    {
        $this->container['margin_amount'] = $margin_amount;
     ...
     * @deprecated
     */
    public function getMarginTaxId()
    {
        return $this->container['margin_tax_id'];
    }

    /**
     * Sets margin_tax_id
     *
     * @param string $margin_tax_id Tax ID for this margin. Tax information can be retrieved from the Tax API.
     *
     * @return self
     * @deprecated
     */
    public function setMarginTaxId($margin_tax_id)
    {
        $this->container['margin_tax_id'] = $margin_tax_id;

        return $this;
    }

    /**
     * Gets margin_tax_amount
     *
     * @return string
     * @deprecated
     */
    public function getMarginTaxAmount()
    {
        return $this->container['margin_tax_amount'];
    }

    /**
     * Sets margin_tax_amount
     *
     * @param string $margin_tax_amount Amount of tax on the margin.
     *
     * @return self
     * @deprecated
     */
    public function setMarginTaxAmount($margin_tax_amount)
    {
        $this->container['margin_tax_amount'] = $margin_tax_amount;
