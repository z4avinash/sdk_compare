...
class Note implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'note_value' => 'setNoteValue',
        'note_type' => 'setNoteType',
        'note_date' => 'setNoteDate',
        'note_creator' => 'setNoteCreator'
    ];
    ...
    protected static $getters = [
        'note_value' => 'getNoteValue',
        'note_type' => 'getNoteType',
        'note_date' => 'getNoteDate',
        'note_creator' => 'getNoteCreator'
    ];
    ...
    const NOTE_TYPE_GUEST = 'GUEST';
    const NOTE_TYPE_PARTNER = 'PARTNER';
    const NOTE_TYPE_SUPPLIER = 'SUPPLIER';
    const NOTE_TYPE_RESELLER = 'RESELLER';
    const NOTE_TYPE_DISTRIBUTOR = 'DISTRIBUTOR';
    const NOTE_TYPE_INTERNAL = 'INTERNAL';
    ...
    {
        return [
            self::NOTE_TYPE_GUEST,
            self::NOTE_TYPE_PARTNER,
            self::NOTE_TYPE_SUPPLIER,
            self::NOTE_TYPE_RESELLER,
            self::NOTE_TYPE_DISTRIBUTOR,
    ...
    {
        $this->container['note_value'] = $data['note_value'] ?? null;
        $this->container['note_type'] = $data['note_type'] ?? null;
        $this->container['note_date'] = $data['note_date'] ?? null;
        $this->container['note_creator'] = $data['note_creator'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['note_value'] === null) {
            $invalidProperties[] = "'note_value' can't be null";
        }
        ...
        if ($this->container['note_date'] === null) {
            $invalidProperties[] = "'note_date' can't be null";
        }
        if ($this->container['note_creator'] === null) {
            $invalidProperties[] = "'note_creator' can't be null";
        }
    ...
    {
        return $this->container['note_value'];
    }
    ...
    {
        $this->container['note_value'] = $note_value;
     ...
     * Sets note_type
     *
     * @param string $note_type * `GUEST` - Note visible to the guest. * `PARTNER` - Note visible to the partner. * `SUPPLIER` - Note visible to the supplier. * `RESELLER` - Note visible to the reseller / supplier admin. * `DISTRIBUTOR` - Note visible to the distributor. * `INTERNAL` - Note visible to the account of the user.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getNoteTypeAllowableValues();
        if (!in_array($note_type, $allowedValues, true)) {
    ...
    {
        return $this->container['note_date'];
    }

    /**
     * Sets note_date
     *
     * @param \DateTime $note_date Creation / Modification date of the note.
     *
     * @return self
     */
    public function setNoteDate($note_date)
    {
        $this->container['note_date'] = $note_date;
    ...
    {
        return $this->container['note_creator'];
    }

    /**
     * Sets note_creator
     *
     * @param string $note_creator User who created the note.
     *
     * @return self
     */
    public function setNoteCreator($note_creator)
    {
        $this->container['note_creator'] = $note_creator;
