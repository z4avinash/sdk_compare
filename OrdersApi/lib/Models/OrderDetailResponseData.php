...
/**
 * OrderDetailResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderDetailResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderDetailResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'order' => '\PrioTicket\DistributorAPI\Models\ConfirmedOrderModel'
    ];
     ...
     * Sets order
     *
     * @param \PrioTicket\DistributorAPI\Models\ConfirmedOrderModel $order order
     *
     * @return self
     */
