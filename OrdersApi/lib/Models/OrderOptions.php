...
class OrderOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'email_options' => '\PrioTicket\DistributorAPI\Models\EmailOptionsModel',
        'price_on_voucher' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'price_on_voucher' => 'price_on_voucher'
    ];
    ...
    protected static $setters = [
        ...
        'price_on_voucher' => 'setPriceOnVoucher'
    ];
    ...
    protected static $getters = [
        ...
        'price_on_voucher' => 'getPriceOnVoucher'
    ];
    ...
    {
        $this->container['email_options'] = $data['email_options'] ?? null;
        $this->container['price_on_voucher'] = $data['price_on_voucher'] ?? 'true';
    }
     ...
     * Gets email_options
     *
     * @return \PrioTicket\DistributorAPI\Models\EmailOptionsModel|null
     */
     ...
     * Sets email_options
     *
     * @param \PrioTicket\DistributorAPI\Models\EmailOptionsModel|null $email_options email_options
     *
     * @return self
     */
    ...
    /**
     * Gets price_on_voucher
     *
     * @return string|null
     * @deprecated
     */
    public function getPriceOnVoucher()
    {
        return $this->container['price_on_voucher'];
    }

    /**
     * Sets price_on_voucher
     *
     * @param string|null $price_on_voucher Show price on voucher.
     *
     * @return self
     * @deprecated
     */
    public function setPriceOnVoucher($price_on_voucher)
    {
        $this->container['price_on_voucher'] = $price_on_voucher;
