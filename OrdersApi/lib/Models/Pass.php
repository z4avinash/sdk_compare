...
class Pass implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'pass_duration' => '\PrioTicket\DistributorAPI\Models\PassDurationDetails'
    ];
    ...
    {
        $this->container['pass_duration'] = $data['pass_duration'] ?? null;
    }
     ...
     * Gets pass_duration
     *
     * @return \PrioTicket\DistributorAPI\Models\PassDurationDetails|null
     */
    public function getPassDuration()
    {
        return $this->container['pass_duration'];
    }

    /**
     * Sets pass_duration
     *
     * @param \PrioTicket\DistributorAPI\Models\PassDurationDetails|null $pass_duration pass_duration
     *
     * @return self
     */
    public function setPassDuration($pass_duration)
    {
        $this->container['pass_duration'] = $pass_duration;
