...
/**
 * PassDurationDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PassDurationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PassDurationDetails';
    ...
    protected static $openAPITypes = [
        'pass_duration_start' => '\DateTime',
        'pass_duration_end' => '\DateTime',
        'pass_duration_total' => 'int',
        'pass_duration_remaining' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'pass_duration_start' => 'date-time',
        'pass_duration_end' => 'date-time',
        'pass_duration_total' => null,
        'pass_duration_remaining' => null
    ];
    ...
    protected static $attributeMap = [
        'pass_duration_start' => 'pass_duration_start',
        'pass_duration_end' => 'pass_duration_end',
        'pass_duration_total' => 'pass_duration_total',
        'pass_duration_remaining' => 'pass_duration_remaining'
    ];
    ...
    protected static $setters = [
        'pass_duration_start' => 'setPassDurationStart',
        'pass_duration_end' => 'setPassDurationEnd',
        'pass_duration_total' => 'setPassDurationTotal',
        'pass_duration_remaining' => 'setPassDurationRemaining'
    ];
    ...
    protected static $getters = [
        'pass_duration_start' => 'getPassDurationStart',
        'pass_duration_end' => 'getPassDurationEnd',
        'pass_duration_total' => 'getPassDurationTotal',
        'pass_duration_remaining' => 'getPassDurationRemaining'
    ];
    ...
    {
        $this->container['pass_duration_start'] = $data['pass_duration_start'] ?? null;
        $this->container['pass_duration_end'] = $data['pass_duration_end'] ?? null;
        $this->container['pass_duration_total'] = $data['pass_duration_total'] ?? null;
        $this->container['pass_duration_remaining'] = $data['pass_duration_remaining'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pass_duration_start'] === null) {
            $invalidProperties[] = "'pass_duration_start' can't be null";
        }
        if ($this->container['pass_duration_end'] === null) {
            $invalidProperties[] = "'pass_duration_end' can't be null";
        }
        if ($this->container['pass_duration_total'] === null) {
            $invalidProperties[] = "'pass_duration_total' can't be null";
        }
        if ($this->container['pass_duration_remaining'] === null) {
            $invalidProperties[] = "'pass_duration_remaining' can't be null";
        }
    ...
    /**
     * Gets pass_duration_start
     *
     * @return \DateTime
     */
    public function getPassDurationStart()
    {
        return $this->container['pass_duration_start'];
    }

    /**
     * Sets pass_duration_start
     *
     * @param \DateTime $pass_duration_start In case of a redeemed pass, the start time of the countdown. Will be equal to `redeem_date_time_first`.
     *
     * @return self
     */
    public function setPassDurationStart($pass_duration_start)
    {
        $this->container['pass_duration_start'] = $pass_duration_start;

        return $this;
    }

    /**
     * Gets pass_duration_end
     *
     * @return \DateTime
     */
    public function getPassDurationEnd()
    {
        return $this->container['pass_duration_end'];
    }

    /**
     * Sets pass_duration_end
     *
     * @param \DateTime $pass_duration_end In case of a redeemed pass, the end time of the countdown. (`duration_start` + `duration_total`)
     *
     * @return self
     */
    public function setPassDurationEnd($pass_duration_end)
    {
        $this->container['pass_duration_end'] = $pass_duration_end;

        return $this;
    }

    /**
     * Gets pass_duration_total
     *
     * @return int
     */
    public function getPassDurationTotal()
    {
        return $this->container['pass_duration_total'];
    }

    /**
     * Sets pass_duration_total
     *
     * @param int $pass_duration_total The total amount of time in seconds that the pass is supposed to be valid.
     *
     * @return self
     */
    public function setPassDurationTotal($pass_duration_total)
    {
        $this->container['pass_duration_total'] = $pass_duration_total;

        return $this;
    }

    /**
     * Gets pass_duration_remaining
     *
     * @return int
     */
    public function getPassDurationRemaining()
    {
        return $this->container['pass_duration_remaining'];
    }

    /**
     * Sets pass_duration_remaining
     *
     * @param int $pass_duration_remaining The remaining time for the pass to be valid in seconds. Can be a negative value in case of an expired passcode. (`duration_end` - current time)
     *
     * @return self
     */
    public function setPassDurationRemaining($pass_duration_remaining)
    {
        $this->container['pass_duration_remaining'] = $pass_duration_remaining;
