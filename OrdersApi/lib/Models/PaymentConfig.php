...
class PaymentConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'payment_origin_key' => 'string',
        'payment_origin_domain' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'payment_origin_key' => null,
        'payment_origin_domain' => 'URI'
    ];
    ...
    protected static $attributeMap = [
        ...
        'payment_origin_key' => 'payment_origin_key',
        'payment_origin_domain' => 'payment_origin_domain'
    ];
    ...
    protected static $setters = [
        ...
        'payment_origin_key' => 'setPaymentOriginKey',
        'payment_origin_domain' => 'setPaymentOriginDomain'
    ];
    ...
    protected static $getters = [
        ...
        'payment_origin_key' => 'getPaymentOriginKey',
        'payment_origin_domain' => 'getPaymentOriginDomain'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_origin_key'] = $data['payment_origin_key'] ?? null;
        $this->container['payment_origin_domain'] = $data['payment_origin_domain'] ?? null;
    }
     ...
     *
     * @param string|null $payment_methods In case of `payment_service_provider:ADYEN` a list of available payment methods is returned in the response, including any required fields. If you want to know more about the properties returned in the response, see the [response parameters](https://docs.adyen.com/api-explorer/#/PaymentSetupAndVerificationService/paymentMethods__resParam_groups) in the Adyen API Explorer.
     *
     * @return self
     */
    ...
    /**
     * Gets payment_origin_key
     *
     * @return string|null
     */
    public function getPaymentOriginKey()
    {
        return $this->container['payment_origin_key'];
    }

    /**
     * Sets payment_origin_key
     *
     * @param string|null $payment_origin_key In case of `payment_service_provider:ADYEN`, the required Origin-Key for Web Drop-In will be returned. More information can be found [here](https://docs.adyen.com/user-management/how-to-get-an-origin-key).
     *
     * @return self
     */
    public function setPaymentOriginKey($payment_origin_key)
    {
        $this->container['payment_origin_key'] = $payment_origin_key;

        return $this;
    }

    /**
     * Gets payment_origin_domain
     *
     * @return string|null
     */
    public function getPaymentOriginDomain()
    {
        return $this->container['payment_origin_domain'];
    }

    /**
     * Sets payment_origin_domain
     *
     * @param string|null $payment_origin_domain In case of `payment_service_provider:ADYEN`, the configured origin domain authorized for web payments.
     *
     * @return self
     */
    public function setPaymentOriginDomain($payment_origin_domain)
    {
        $this->container['payment_origin_domain'] = $payment_origin_domain;
