...
/**
 * PaymentConfigResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentConfigResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentConfigResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'payment_config' => '\PrioTicket\DistributorAPI\Models\PaymentConfig'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_config'] = $data['payment_config'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_config'] === null) {
            $invalidProperties[] = "'payment_config' can't be null";
        }
     ...
     * Gets payment_config
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentConfig
     */
     ...
     * Sets payment_config
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentConfig $payment_config payment_config
     *
     * @return self
     */
