...
/**
 * PaymentDetailsResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentDetailsResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDetailsResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'payment' => '\PrioTicket\DistributorAPI\Models\PaymentDetails'
    ];
     ...
     * Sets payment
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentDetails $payment payment
     *
     * @return self
     */
