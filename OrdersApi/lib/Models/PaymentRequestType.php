...
/**
 * PaymentRequestType Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentRequestType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'payment_object_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRequestType';
    ...
    protected static $openAPITypes = [
        ...
        'payment_merchant_account_name' => 'string',
        'payment_gateway_type' => '\PrioTicket\DistributorAPI\Models\PaymentGatewayType',
        'payment_service_provider_reference' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'payment_merchant_account_name' => null,
        'payment_gateway_type' => null,
        'payment_service_provider_reference' => null,
        'payment_type' => null,
        'payment_scheme' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'payment_service_provider_reference' => 'payment_service_provider_reference',
    ...
    protected static $setters = [
        'payment_object_type' => 'setPaymentObjectType',
        ...
        'payment_terminal_id' => 'setPaymentTerminalId',
        'payment_customer_id' => 'setPaymentCustomerId',
        'payment_merchant_account_name' => 'setPaymentMerchantAccountName',
        'payment_gateway_type' => 'setPaymentGatewayType',
        'payment_service_provider_reference' => 'setPaymentServiceProviderReference',
    ...
    protected static $getters = [
        'payment_object_type' => 'getPaymentObjectType',
        ...
        'payment_terminal_id' => 'getPaymentTerminalId',
        'payment_customer_id' => 'getPaymentCustomerId',
        'payment_merchant_account_name' => 'getPaymentMerchantAccountName',
        'payment_gateway_type' => 'getPaymentGatewayType',
        'payment_service_provider_reference' => 'getPaymentServiceProviderReference',
    ...
    {
        $this->container['payment_object_type'] = $data['payment_object_type'] ?? null;
        ...
        $this->container['payment_terminal_id'] = $data['payment_terminal_id'] ?? null;
        $this->container['payment_customer_id'] = $data['payment_customer_id'] ?? null;
        $this->container['payment_merchant_account_name'] = $data['payment_merchant_account_name'] ?? null;
        $this->container['payment_gateway_type'] = $data['payment_gateway_type'] ?? null;
        $this->container['payment_service_provider_reference'] = $data['payment_service_provider_reference'] ?? null;
        $this->container['payment_type'] = $data['payment_type'] ?? null;
        $this->container['payment_scheme'] = $data['payment_scheme'] ?? null;

        // Initialize discriminator property with the model name.
        $this->container['payment_object_type'] = static::$openAPIModelName;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_object_type'] === null) {
            $invalidProperties[] = "'payment_object_type' can't be null";
        }
        if ($this->container['payment_merchant_reference'] === null) {
            $invalidProperties[] = "'payment_merchant_reference' can't be null";
        }
        if ($this->container['payment_external_reference'] === null) {
            $invalidProperties[] = "'payment_external_reference' can't be null";
        }
        ...
        if ($this->container['payment_terminal_id'] === null) {
            $invalidProperties[] = "'payment_terminal_id' can't be null";
        }
        if ($this->container['payment_customer_id'] === null) {
            $invalidProperties[] = "'payment_customer_id' can't be null";
        }
     ...
     *
     * @param string $payment_external_reference External payment reference set to identify the shopper / entity / cardholder / guest performing the payment. This reference can also be used to identify the payment in the PSP system. > Required in case of recurring payments (`payment_recurring:true`).
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_currency_code The (guest) currency code of this payment. According to [ISO-4217](https://en.wikipedia.org/wiki/ISO_4217).  **(ADVANCED)** This value defaults to `order.order_pricing[].price_currency_code`, unless the guest uses an alternative checkout currency, in which case an additional `payment_currency_rate` and `payment_currency_amount` will be returned.  Note that the payment service provider can perform an additional conversion called dynamic currency conversion (DCC), which will be returned inside `payment_gateway_additional_values`.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string|null $payment_currency_rate Checkout / Guest currency conversion rate.   If not set and an alternative `payment_currency_code` is provided, the latest rates from the Currency API will be used as default.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets payment_amount
     *
     * @param string|null $payment_amount Optional alternative amount to be authorised / settled / refunded during this transaction.   Only set this value in case of partial payments or deposits. By default this is set to the `order_pricing.price_total`.   In case of refunds, this value will be a positive value but the payment type should be set to `payment_type:REFUND`.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string|null $payment_recurring Whether the payment details are stored for recurring payments.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets return_url
     *
     * @param string $return_url In case of a redirection, this is the URL to where your shopper should be redirected back to after they complete the payment.
     *
     * @return self
     */
    ...
    /**
     * Gets payment_terminal_id
     *
     * @return string
     * @deprecated
     */
    public function getPaymentTerminalId()
    {
        return $this->container['payment_terminal_id'];
    }

    /**
     * Sets payment_terminal_id
     *
     * @param string $payment_terminal_id Unique ID of the selected payment terminal.
     *
     * @return self
     * @deprecated
     */
    public function setPaymentTerminalId($payment_terminal_id)
    {
        $this->container['payment_terminal_id'] = $payment_terminal_id;

        return $this;
    }

    /**
     * Gets payment_customer_id
     *
     * @return string
     */
    public function getPaymentCustomerId()
    {
        return $this->container['payment_customer_id'];
    }

    /**
     * Sets payment_customer_id
     *
     * @param string $payment_customer_id Unique identifier of the MEWS customer. Retrieved via the [MEWS Customers API](https://mews-systems.gitbook.io/connector-api/operations/customers).
     *
     * @return self
     */
    public function setPaymentCustomerId($payment_customer_id)
    {
        $this->container['payment_customer_id'] = $payment_customer_id;

        return $this;
    }

    /**
     * Gets payment_merchant_account_name
     *
     * @return string|null
     */
    public function getPaymentMerchantAccountName()
    {
        return $this->container['payment_merchant_account_name'];
    }

    /**
     * Sets payment_merchant_account_name
     *
     * @param string|null $payment_merchant_account_name The name of the party selling goods or services to shoppers via an e-commerce website, a mobile app, on a point of sale, or across all three channels.
     *
     * @return self
     */
    public function setPaymentMerchantAccountName($payment_merchant_account_name)
    {
        $this->container['payment_merchant_account_name'] = $payment_merchant_account_name;
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentGatewayType|null
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentGatewayType|null $payment_gateway_type payment_gateway_type
     *
     * @return self
     */
    ...
    /**
     * Gets payment_service_provider_reference
     *
     * @return string|null
     */
    public function getPaymentServiceProviderReference()
    {
        return $this->container['payment_service_provider_reference'];
    }

    /**
     * Sets payment_service_provider_reference
     *
     * @param string|null $payment_service_provider_reference Unique payment reference set by the payment service provider.
     *
     * @return self
     */
    public function setPaymentServiceProviderReference($payment_service_provider_reference)
    {
        $this->container['payment_service_provider_reference'] = $payment_service_provider_reference;
     ...
     * Gets payment_type
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentType|null
     */
     ...
     * Sets payment_type
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentType|null $payment_type payment_type
     *
     * @return self
     */
