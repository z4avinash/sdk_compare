...
class PickupPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pickup_point_availability_dependency' => 'bool'
    ];
     ...
     *
     * @param bool|null $pickup_point_availability_dependency Dependency on the selected `availability_slot`.  The selected (`pickup_point_time` + `pickup_point_duration`) is not allowed to exceed the selected `availability_from_date_time` and therefore only a limited amount of `pickup_point_times` should be shown.
     *
     * @return self
     */
