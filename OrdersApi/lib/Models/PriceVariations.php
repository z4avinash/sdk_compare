...
/**
 * PriceVariations Class Doc Comment
 *
 * @category Class
 ...
 */
class PriceVariations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceVariations';
    ...
    protected static $setters = [
        'variation_label' => 'setVariationLabel',
        'variation_amount' => 'setVariationAmount',
    ...
    protected static $getters = [
        'variation_label' => 'getVariationLabel',
        'variation_amount' => 'getVariationAmount',
    ...
    const VARIATION_TYPE_PRODUCT_DYNAMIC = 'PRODUCT_DYNAMIC';
    const VARIATION_TYPE_PRODUCT_DAILY = 'PRODUCT_DAILY';
    const VARIATION_TYPE_PRODUCT_QUANTITY = 'PRODUCT_QUANTITY';
    const VARIATION_TYPE_PRODUCT_DISCOUNT = 'PRODUCT_DISCOUNT';
    const VARIATION_TYPE_PRODUCT_MARKUP = 'PRODUCT_MARKUP';
    const VARIATION_TYPE_PRODUCT_COMBI_DISCOUNT = 'PRODUCT_COMBI_DISCOUNT';
    const VARIATION_TYPE_PARTNER_DISCOUNT = 'PARTNER_DISCOUNT';
    const VARIATION_TYPE_CART_DISCOUNT_FIXED = 'CART_DISCOUNT_FIXED';
    const VARIATION_TYPE_CART_DISCOUNT_CUSTOM = 'CART_DISCOUNT_CUSTOM';
    const VARIATION_TYPE_OTHER = 'OTHER';
    ...
    {
        return [
            self::VARIATION_TYPE_PRODUCT_DYNAMIC,
            self::VARIATION_TYPE_PRODUCT_DAILY,
            self::VARIATION_TYPE_PRODUCT_QUANTITY,
            self::VARIATION_TYPE_PRODUCT_DISCOUNT,
            self::VARIATION_TYPE_PRODUCT_MARKUP,
            self::VARIATION_TYPE_PRODUCT_COMBI_DISCOUNT,
            self::VARIATION_TYPE_PARTNER_DISCOUNT,
            self::VARIATION_TYPE_CART_DISCOUNT_FIXED,
            self::VARIATION_TYPE_CART_DISCOUNT_CUSTOM,
            self::VARIATION_TYPE_OTHER,
        ];
    }
    ...
    {
        $this->container['variation_label'] = $data['variation_label'] ?? null;
        $this->container['variation_amount'] = $data['variation_amount'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['variation_amount'] === null) {
            $invalidProperties[] = "'variation_amount' can't be null";
        }
    ...
    /**
     * Gets variation_label
     *
     * @return string|null
     */
    public function getVariationLabel()
    {
        return $this->container['variation_label'];
    }

    /**
     * Sets variation_label
     *
     * @param string|null $variation_label Label / Explanation for this variation.
     *
     * @return self
     */
    public function setVariationLabel($variation_label)
    {
        $this->container['variation_label'] = $variation_label;

        return $this;
    }

    /**
     * Gets variation_amount
     *
     * @return string
     */
    public function getVariationAmount()
    {
        return $this->container['variation_amount'];
    }

    /**
     * Sets variation_amount
     *
     * @param string $variation_amount The amount which should be added / substracted to the `price_subtotal`. This can be a negative value (discount) or positive value (surcharge).
     *
     * @return self
     */
    public function setVariationAmount($variation_amount)
    {
        $this->container['variation_amount'] = $variation_amount;
