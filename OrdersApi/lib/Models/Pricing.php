 ...
 *
 * @category Class
 * @description The calculated price based on the selected products.   We highly recommend implementing a cross-check before confirming the order with your own calculated prices to prevent mismatches.
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Pricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'price_currency_rate' => 'string',
        'price_subtotal' => 'string',
        'price_variations' => '\PrioTicket\DistributorAPI\Models\PriceVariations[]',
        'price_promocodes' => '\PrioTicket\DistributorAPI\Models\PromoCodePricing[]',
        'price_taxes' => '\PrioTicket\DistributorAPI\Models\ProductTax[]',
        'price_fees' => '\PrioTicket\DistributorAPI\Models\Fee[]',
        'price_margins' => '\PrioTicket\DistributorAPI\Models\Margin[]',
        'price_total' => 'string'
    ];
    ...
    protected static $attributeMap = [
        ...
        'price_currency_rate' => 'price_currency_rate',
        'price_subtotal' => 'price_subtotal',
        'price_variations' => 'price_variations',
        'price_promocodes' => 'price_promocodes',
    ...
    protected static $setters = [
        ...
        'price_currency_rate' => 'setPriceCurrencyRate',
        'price_subtotal' => 'setPriceSubtotal',
        'price_variations' => 'setPriceVariations',
        'price_promocodes' => 'setPricePromocodes',
        'price_taxes' => 'setPriceTaxes',
        'price_fees' => 'setPriceFees',
        'price_margins' => 'setPriceMargins',
    ...
    protected static $getters = [
        ...
        'price_currency_rate' => 'getPriceCurrencyRate',
        'price_subtotal' => 'getPriceSubtotal',
        'price_variations' => 'getPriceVariations',
        'price_promocodes' => 'getPricePromocodes',
        'price_taxes' => 'getPriceTaxes',
        'price_fees' => 'getPriceFees',
        'price_margins' => 'getPriceMargins',
    ...
    const PRICE_TYPE_PURCHASE_GROSS = 'PURCHASE_GROSS';
    const PRICE_TYPE_PURCHASE_NET = 'PURCHASE_NET';
    const PRICE_TYPE_SALES_GROSS = 'SALES_GROSS';
    const PRICE_TYPE_SALES_NET = 'SALES_NET';
    ...
    {
        return [
            self::PRICE_TYPE_PURCHASE_GROSS,
            self::PRICE_TYPE_PURCHASE_NET,
            self::PRICE_TYPE_SALES_GROSS,
            self::PRICE_TYPE_SALES_NET,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['price_currency_code'] = $data['price_currency_code'] ?? null;
        $this->container['price_currency_rate'] = $data['price_currency_rate'] ?? null;
        $this->container['price_subtotal'] = $data['price_subtotal'] ?? null;
        $this->container['price_variations'] = $data['price_variations'] ?? null;
        $this->container['price_promocodes'] = $data['price_promocodes'] ?? null;
        $this->container['price_taxes'] = $data['price_taxes'] ?? null;
        $this->container['price_fees'] = $data['price_fees'] ?? null;
        $this->container['price_margins'] = $data['price_margins'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['price_subtotal'] === null) {
            $invalidProperties[] = "'price_subtotal' can't be null";
        }
        if ($this->container['price_total'] === null) {
            $invalidProperties[] = "'price_total' can't be null";
        }
     ...
     * Sets price_type
     *
     * @param string $price_type Price breakdown on either purchase or sales and including or excluding tax.
     *
     * @return self
     */
     ...
     *
     * @param string|null $price_currency_code Price currency code. According to [ISO-4217](https://en.wikipedia.org/wiki/ISO_4217).  Defaults to the base currency of your account.
     *
     * @return self
     */
    public function setPriceCurrencyCode($price_currency_code)
    {
    ...
    /**
     * Gets price_currency_rate
     *
     * @return string|null
     */
    public function getPriceCurrencyRate()
    {
        return $this->container['price_currency_rate'];
    }

    /**
     * Sets price_currency_rate
     *
     * @param string|null $price_currency_rate **(ADVANCED)** Optional alternative currency conversion rate.   If not set and an alternative `price_currency_code` is provided, the latest rates from the Currency API will be used. > Alternative rates can only be provided on (re)sales, purchase exchange rates are fixed.
     *
     * @return self
     */
    public function setPriceCurrencyRate($price_currency_rate)
    {
        $this->container['price_currency_rate'] = $price_currency_rate;
     ...
     * Sets price_subtotal
     *
     * @param string $price_subtotal Sum of `product_type_list_price` for all `product_types` including extra options, without promocodes, price variations and additional fees (`fee_included:true`).
     *
     * @return self
     */
    ...
    /**
     * Gets price_variations
     *
     * @return \PrioTicket\DistributorAPI\Models\PriceVariations[]|null
     */
    public function getPriceVariations()
    {
        return $this->container['price_variations'];
    }

    /**
     * Sets price_variations
     *
     * @param \PrioTicket\DistributorAPI\Models\PriceVariations[]|null $price_variations All applicable price variations (`product_quantity_pricing`, `product_daily_pricing`, `product_dynamic_pricing` and more).  Some variations are set automatically based on your request and the selected products, such as quantity and dynamic pricing, whereas other variations can be set manually (e.g cart and partner discount).
     *
     * @return self
     */
    public function setPriceVariations($price_variations)
    {
        $this->container['price_variations'] = $price_variations;

        return $this;
    }

    /**
     * Gets price_promocodes
     *
     * @return \PrioTicket\DistributorAPI\Models\PromoCodePricing[]|null
     */
    public function getPricePromocodes()
    {
        return $this->container['price_promocodes'];
    }

    /**
     * Sets price_promocodes
     *
     * @param \PrioTicket\DistributorAPI\Models\PromoCodePricing[]|null $price_promocodes Applied promocodes pricing.   Only applicable in case of `price_type:SALES_GROSS/SALES_NET`.
     *
     * @return self
     */
    public function setPricePromocodes($price_promocodes)
    {
        $this->container['price_promocodes'] = $price_promocodes;
     ...
     * Gets price_taxes
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductTax[]|null
     */
    public function getPriceTaxes()
    {
        return $this->container['price_taxes'];
    }

    /**
     * Sets price_taxes
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductTax[]|null $price_taxes Product tax breakdown.   Already included in the price breakdown in case `price_type:PURCHASE_GROSS/SALES_GROSS`, otherwise excluded. Taxes on fees are listed separately in `price_fees`.
     *
     * @return self
     */
    public function setPriceTaxes($price_taxes)
    {
        $this->container['price_taxes'] = $price_taxes;
     ...
     */
    public function getPriceFees()
    {
        return $this->container['price_fees'];
    }

    /**
     * Sets price_fees
     *
     * @param \PrioTicket\DistributorAPI\Models\Fee[]|null $price_fees List of additional fees.   Additional fees (`fee_included:true`) should be included in the `price_total`.   Note that some fees are only visible to certain users.
     *
     * @return self
     */
    public function setPriceFees($price_fees)
    {
        $this->container['price_fees'] = $price_fees;
     ...
     * Gets price_margins
     *
     * @return \PrioTicket\DistributorAPI\Models\Margin[]|null
     */
    public function getPriceMargins()
    {
        return $this->container['price_margins'];
    }

    /**
     * Sets price_margins
     *
     * @param \PrioTicket\DistributorAPI\Models\Margin[]|null $price_margins Margin breakdown (informational only). Note that some margins are only visible to certain users.
     *
     * @return self
     */
    public function setPriceMargins($price_margins)
    {
        $this->container['price_margins'] = $price_margins;
     ...
     * Sets price_total
     *
     * @param string $price_total The total sales / purchase price including all discounts, surcharges and fees above.
     *
     * @return self
     */
