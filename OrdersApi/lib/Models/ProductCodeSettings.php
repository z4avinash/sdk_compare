...
/**
 * ProductCodeSettings Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductCodeSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductCodeSettings';
    ...
    protected static $openAPITypes = [
        'product_code_format' => '\PrioTicket\DistributorAPI\Models\ProductCodeFormat',
        'product_code_source' => '\PrioTicket\DistributorAPI\Models\ProductCodeSource',
        'product_group_code' => 'bool',
        'product_combi_code' => 'bool',
        'product_voucher_settings' => '\PrioTicket\DistributorAPI\Models\ProductVoucherSettings',
        'product_code_release_date' => '\DateTime',
        'product_code_release_details' => '\PrioTicket\DistributorAPI\Models\VoucherReleaseType[]'
    ];
    ...
    protected static $openAPIFormats = [
        'product_code_format' => null,
        'product_code_source' => null,
        'product_group_code' => null,
        'product_combi_code' => null,
        'product_voucher_settings' => null,
        'product_code_release_date' => 'date-time',
        'product_code_release_details' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'product_combi_code' => 'product_combi_code',
        'product_voucher_settings' => 'product_voucher_settings',
        'product_code_release_date' => 'product_code_release_date',
        'product_code_release_details' => 'product_code_release_details'
    ];
    ...
    protected static $setters = [
        'product_code_format' => 'setProductCodeFormat',
        'product_code_source' => 'setProductCodeSource',
        'product_group_code' => 'setProductGroupCode',
        'product_combi_code' => 'setProductCombiCode',
        'product_voucher_settings' => 'setProductVoucherSettings',
        'product_code_release_date' => 'setProductCodeReleaseDate',
        'product_code_release_details' => 'setProductCodeReleaseDetails'
    ];
    ...
    protected static $getters = [
        'product_code_format' => 'getProductCodeFormat',
        'product_code_source' => 'getProductCodeSource',
        'product_group_code' => 'getProductGroupCode',
        'product_combi_code' => 'getProductCombiCode',
        'product_voucher_settings' => 'getProductVoucherSettings',
        'product_code_release_date' => 'getProductCodeReleaseDate',
        'product_code_release_details' => 'getProductCodeReleaseDetails'
    ];
    ...
    {
        $this->container['product_code_format'] = $data['product_code_format'] ?? null;
        $this->container['product_code_source'] = $data['product_code_source'] ?? null;
        $this->container['product_group_code'] = $data['product_group_code'] ?? false;
        $this->container['product_combi_code'] = $data['product_combi_code'] ?? false;
        $this->container['product_voucher_settings'] = $data['product_voucher_settings'] ?? null;
        $this->container['product_code_release_date'] = $data['product_code_release_date'] ?? null;
        $this->container['product_code_release_details'] = $data['product_code_release_details'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_code_format'] === null) {
            $invalidProperties[] = "'product_code_format' can't be null";
        }
        if ($this->container['product_code_source'] === null) {
            $invalidProperties[] = "'product_code_source' can't be null";
        }
        if ($this->container['product_group_code'] === null) {
            $invalidProperties[] = "'product_group_code' can't be null";
        }
        if ($this->container['product_combi_code'] === null) {
            $invalidProperties[] = "'product_combi_code' can't be null";
        }
        if ($this->container['product_voucher_settings'] === null) {
            $invalidProperties[] = "'product_voucher_settings' can't be null";
        }
    ...
    /**
     * Gets product_code_format
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductCodeFormat
     */
    public function getProductCodeFormat()
    {
        return $this->container['product_code_format'];
    }

    /**
     * Sets product_code_format
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductCodeFormat $product_code_format product_code_format
     *
     * @return self
     */
    public function setProductCodeFormat($product_code_format)
    {
        $this->container['product_code_format'] = $product_code_format;

        return $this;
    }

    /**
     * Gets product_code_source
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductCodeSource
     */
    public function getProductCodeSource()
    {
        return $this->container['product_code_source'];
    }

    /**
     * Sets product_code_source
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductCodeSource $product_code_source product_code_source
     *
     * @return self
     */
    public function setProductCodeSource($product_code_source)
    {
        $this->container['product_code_source'] = $product_code_source;

        return $this;
    }

    /**
     * Gets product_group_code
     *
     * @return bool
     */
    public function getProductGroupCode()
    {
        return $this->container['product_group_code'];
    }

    /**
     * Sets product_group_code
     *
     * @param bool $product_group_code Whether this product supports a group code. In this case a code (`product_code`) is returned which is valid for all `product_type`s. This code can be used to allow entry to all persons within that booking without using an individual `product_type_code`.
     *
     * @return self
     */
    public function setProductGroupCode($product_group_code)
    {
        $this->container['product_group_code'] = $product_group_code;

        return $this;
    }

    /**
     * Gets product_combi_code
     *
     * @return bool
     */
    public function getProductCombiCode()
    {
        return $this->container['product_combi_code'];
    }

    /**
     * Sets product_combi_code
     *
     * @param bool $product_combi_code Whether this product supports a combi code. In this case a code (`product_code`) is returned which is valid for all products within a package. This code allows admission to all supplier venues. This is only applicable to combi-products (`product_combi:true`).
     *
     * @return self
     */
    public function setProductCombiCode($product_combi_code)
    {
        $this->container['product_combi_code'] = $product_combi_code;

        return $this;
    }

    /**
     * Gets product_voucher_settings
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductVoucherSettings
     */
    public function getProductVoucherSettings()
    {
        return $this->container['product_voucher_settings'];
    }

    /**
     * Sets product_voucher_settings
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductVoucherSettings $product_voucher_settings product_voucher_settings
     *
     * @return self
     */
    public function setProductVoucherSettings($product_voucher_settings)
    {
        $this->container['product_voucher_settings'] = $product_voucher_settings;

        return $this;
    }

    /**
     * Gets product_code_release_date
     *
     * @return \DateTime|null
     */
    public function getProductCodeReleaseDate()
    {
        return $this->container['product_code_release_date'];
    }

    /**
     * Sets product_code_release_date
     *
     * @param \DateTime|null $product_code_release_date If `product_code_release_details:DATE_ALLOCATION`, this field will indicate the date on which the voucher codes will be available. Note that if there are multiple voucher release requirements, all must be met prior to this date, otherwise the voucher will be released as soon as the last requirement is fullfilled.  In case you are subscribed to the Order Notification Event, a webhook will be triggered on this date as well.
     *
     * @return self
     */
    public function setProductCodeReleaseDate($product_code_release_date)
    {
        $this->container['product_code_release_date'] = $product_code_release_date;

        return $this;
    }

    /**
     * Gets product_code_release_details
     *
     * @return \PrioTicket\DistributorAPI\Models\VoucherReleaseType[]|null
     */
    public function getProductCodeReleaseDetails()
    {
        return $this->container['product_code_release_details'];
    }

    /**
     * Sets product_code_release_details
     *
     * @param \PrioTicket\DistributorAPI\Models\VoucherReleaseType[]|null $product_code_release_details Requirements for the voucher codes to be released. All requirements must be met for the voucher to be released.  By default the vouchers will be released on Order Confirmation. Be aware that if additional requirements are set, the voucher codes might not immediately be released upon Create Booking.  Additional requirements are only applicable to a very small subset of products.
     *
     * @return self
     */
    public function setProductCodeReleaseDetails($product_code_release_details)
    {
        $this->container['product_code_release_details'] = $product_code_release_details;
