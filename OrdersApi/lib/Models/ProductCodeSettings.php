...
class ProductCodeSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string $product_group_code Whether this product supports a group code. In this case a code (`product_code`) is returned which is valid for all `product_type`s. This code can be used to allow entry to all persons within that booking without using an individual `product_type_code`.
     *
     * @return self
     */
     ...
     *
     * @param string $product_combi_code Whether this product supports a combi code. In this case a code (`product_code`) is returned which is valid for all products within a package. This code allows admission to all supplier venues. This is only applicable to combi-products (`product_combi:true`).
     *
     * @return self
     */
