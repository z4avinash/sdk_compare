...
/**
 * ProductDetailData Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductDetailData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductDetailData';
    ...
    protected static $openAPITypes = [
        ...
        'product' => '\PrioTicket\DistributorAPI\Models\ProductModel'
    ];
     ...
     * Sets product
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductModel $product product
     *
     * @return self
     */
