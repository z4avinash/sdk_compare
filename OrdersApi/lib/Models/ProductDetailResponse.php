...
class ProductDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\ProductDetailData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductDetailData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductDetailData $data data
     *
     * @return self
     */
