...
class ProductModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'product_third_party' => 'string',
        'product_seasonal_pricing' => 'string',
        'product_quantity_pricing' => 'string',
        'product_daily_pricing' => 'string',
        'product_dynamic_pricing' => 'string',
        'product_relation_details_visible' => 'string',
        'product_timepicker_visible' => 'string',
        'product_sub_only' => 'string',
        'product_cluster' => 'string',
        'product_combi' => 'string',
        'product_addon' => 'string',
        'product_availability' => 'string',
        'product_availability_assigned' => 'string',
        'product_capacity' => 'string',
        'product_traveldate_required' => 'string',
        'product_cancellation_allowed' => 'string',
        'product_overbooking_allowed' => 'string',
        'product_past_date_booking_allowed' => 'string',
     ...
     *
     * @param string $product_third_party Whether the product is from a third party.
     *
     * @return self
     */
     ...
     *
     * @param string $product_seasonal_pricing Whether pricing can differentiate between specific date ranges (Product types can be returned more than once with different settings).
     *
     * @return self
     */
     ...
     *
     * @param string $product_quantity_pricing Different pricing based on the booking quantity.
     *
     * @return self
     */
     ...
     *
     * @param string $product_daily_pricing Whether pricing can differentiate between specific days.
     *
     * @return self
     */
     ...
     *
     * @param string $product_dynamic_pricing Whether pricing can differentiate between specific availability slots (e.g. Peakhours).
     *
     * @return self
     */
     ...
     *
     * @param string $product_relation_details_visible Whether you should show the underlying details of the linked sub-products. Only applicable if either `product_cluster:true`, `product_combi:true` or `product_addon:true`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $product_sub_only In case `product_sub_only:true` then the product is not available for individual sales. Instead it should be listed as part of a main cluster/combi/addon product only.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param string $product_cluster Product is a cluster-product. In case this value is indicated as `true`, this product is the main cluster product and is not bookable. One of the sub-products linked to this cluster should be booked instead. These products are listed inside `product_cluster_details`.
     *
     * @return self
     */
     ...
     * Sets product_combi
     *
     * @param string $product_combi Product is a combi-product. In case this value is indicated as `true`, this product is the main combi product and is not bookable on its own. All of the sub-products linked to this combi should be booked as well. These products are listed inside `product_combi_details`.
     *
     * @return self
     */
     ...
     * Sets product_addon
     *
     * @param string $product_addon Product has one or more addon-products. In case this value is indicated as `true`, this product has one or more optional addons. All of the optional addons are listed inside `product_addon_details`.
     *
     * @return self
     */
     ...
     *
     * @param string $product_availability Whether it is required to select an availability slot to make a booking request.   In case (`product_cluster:true` or `product_combi:true`) and `product_availability:true` then the product has shared capacity (`product_capacity_type:SHARED`) across the sub-products.   If `product_availability:false` then this main cluster/combi product does not have shared capacity across the sub-products and therefore those should be checked individually.   Check `product_admission_type` for more details.
     *
     * @return self
     */
     ...
     *
     * @param string $product_capacity Whether this product has managed (limited) capacity.   Check `product_capacity_type` for more details.
     *
     * @return self
     */
     ...
     *
     * @param string $product_traveldate_required Whether a traveldate is required upon booking.  Redundant if availability is selected.
     *
     * @return self
     */
     ...
     *
     * @param string $product_cancellation_allowed Whether it is allowed to cancel this product.   Note that even if a product can be cancelled, cancellation fees might still apply. Please check `product_cancellation_policies` for more details.
     *
     * @return self
     */
     ...
     *
     * @param string $product_overbooking_allowed Whether it is allowed to overbook. Not appplicable to third party products.
     *
     * @return self
     */
     ...
     *
     * @param string $product_past_date_booking_allowed Whether it is allowed to select a date in the past.
     *
     * @return self
     */
