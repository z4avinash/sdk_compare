...
/**
 * ProductNoShowPolicy Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductNoShowPolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductNoShowPolicy';
     ...
     * Sets fee_amount
     *
     * @param string|null $fee_amount Fee amount.
     *
     * @return self
     */
