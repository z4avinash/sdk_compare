...
/**
 * ProductPaymentDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductPaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductPaymentDetails';
    ...
    protected static $openAPITypes = [
        ...
        'product_payment_term' => '\PrioTicket\DistributorAPI\Models\PaymentTermType',
        'product_payment_deposit' => 'string',
        'product_payment_require_creditcard' => 'string',
        'product_payment_currency' => '\PrioTicket\DistributorAPI\Models\Currency'
    ];
    ...
    protected static $openAPIFormats = [
        'product_payment_type' => null,
        'product_payment_term' => null,
        'product_payment_deposit' => null,
        'product_payment_require_creditcard' => null,
        'product_payment_currency' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'product_payment_term' => 'product_payment_term',
        'product_payment_deposit' => 'product_payment_deposit',
        'product_payment_require_creditcard' => 'product_payment_require_creditcard',
        'product_payment_currency' => 'product_payment_currency'
    ];
    ...
    protected static $setters = [
        'product_payment_type' => 'setProductPaymentType',
        'product_payment_term' => 'setProductPaymentTerm',
        'product_payment_deposit' => 'setProductPaymentDeposit',
        'product_payment_require_creditcard' => 'setProductPaymentRequireCreditcard',
        'product_payment_currency' => 'setProductPaymentCurrency'
    ];
    ...
    protected static $getters = [
        'product_payment_type' => 'getProductPaymentType',
        'product_payment_term' => 'getProductPaymentTerm',
        'product_payment_deposit' => 'getProductPaymentDeposit',
        'product_payment_require_creditcard' => 'getProductPaymentRequireCreditcard',
        'product_payment_currency' => 'getProductPaymentCurrency'
    ];
    ...
    const PRODUCT_PAYMENT_TYPE_REQUIRED = 'REQUIRED';
    const PRODUCT_PAYMENT_TYPE_OPTIONAL = 'OPTIONAL';
    const PRODUCT_PAYMENT_TYPE_NOT_SUPPORTED = 'NOT_SUPPORTED';
     ...
     * @return string[]
     */
    public function getProductPaymentTypeAllowableValues()
    {
        return [
            self::PRODUCT_PAYMENT_TYPE_REQUIRED,
            self::PRODUCT_PAYMENT_TYPE_OPTIONAL,
            self::PRODUCT_PAYMENT_TYPE_NOT_SUPPORTED,
        ];
    }
    ...
    {
        $this->container['product_payment_type'] = $data['product_payment_type'] ?? null;
        $this->container['product_payment_term'] = $data['product_payment_term'] ?? null;
        $this->container['product_payment_deposit'] = $data['product_payment_deposit'] ?? null;
        $this->container['product_payment_require_creditcard'] = $data['product_payment_require_creditcard'] ?? 'false';
        $this->container['product_payment_currency'] = $data['product_payment_currency'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_payment_type'] === null) {
            $invalidProperties[] = "'product_payment_type' can't be null";
        }
        $allowedValues = $this->getProductPaymentTypeAllowableValues();
        if (!is_null($this->container['product_payment_type']) && !in_array($this->container['product_payment_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'product_payment_type', must be one of '%s'",
                $this->container['product_payment_type'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['product_payment_term'] === null) {
            $invalidProperties[] = "'product_payment_term' can't be null";
        }
        if ($this->container['product_payment_currency'] === null) {
            $invalidProperties[] = "'product_payment_currency' can't be null";
        }
    ...
    /**
     * Gets product_payment_type
     *
     * @return string
     * @deprecated
     */
    public function getProductPaymentType()
    {
        return $this->container['product_payment_type'];
    }

    /**
     * Sets product_payment_type
     *
     * @param string $product_payment_type Indicates how the product will be purchased.  Payment Types:    * `REQUIRED` (string) - The user has to pay this service at the booking time.    * `OPTIONAL` (string) - The user can choose to pre-pay this service at the booking time or later, but it is not required in order to book.    * `NOT_SUPPORTED` (string) - Payment is not supported for this service.
     *
     * @return self
     * @deprecated
     */
    public function setProductPaymentType($product_payment_type)
    {
        $allowedValues = $this->getProductPaymentTypeAllowableValues();
        if (!in_array($product_payment_type, $allowedValues, true)) {
        ...
        $this->container['product_payment_type'] = $product_payment_type;

        return $this;
    }

    /**
     * Gets product_payment_term
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentTermType
     * @deprecated
     */
    public function getProductPaymentTerm()
    {
        return $this->container['product_payment_term'];
    }

    /**
     * Sets product_payment_term
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentTermType $product_payment_term product_payment_term
     *
     * @return self
     * @deprecated
     */
    public function setProductPaymentTerm($product_payment_term)
    {
        $this->container['product_payment_term'] = $product_payment_term;

        return $this;
    }

    /**
     * Gets product_payment_deposit
     *
     * @return string|null
     * @deprecated
     */
    public function getProductPaymentDeposit()
    {
        return $this->container['product_payment_deposit'];
    }

    /**
     * Sets product_payment_deposit
     *
     * @param string|null $product_payment_deposit A deposit that the user may be charged or have a hold on their credit card for.
     *
     * @return self
     * @deprecated
     */
    public function setProductPaymentDeposit($product_payment_deposit)
    {
        $this->container['product_payment_deposit'] = $product_payment_deposit;

        return $this;
    }

    /**
     * Gets product_payment_require_creditcard
     *
     * @return string|null
     * @deprecated
     */
    public function getProductPaymentRequireCreditcard()
    {
        return $this->container['product_payment_require_creditcard'];
    }

    /**
     * Sets product_payment_require_creditcard
     *
     * @param string|null $product_payment_require_creditcard This product requires a payment via creditcard.
     *
     * @return self
     * @deprecated
     */
    public function setProductPaymentRequireCreditcard($product_payment_require_creditcard)
    {
        $this->container['product_payment_require_creditcard'] = $product_payment_require_creditcard;

        return $this;
    }

    /**
     * Gets product_payment_currency
     *
     * @return \PrioTicket\DistributorAPI\Models\Currency
     */
    public function getProductPaymentCurrency()
    {
        return $this->container['product_payment_currency'];
    }

    /**
     * Sets product_payment_currency
     *
     * @param \PrioTicket\DistributorAPI\Models\Currency $product_payment_currency product_payment_currency
     *
     * @return self
     */
    public function setProductPaymentCurrency($product_payment_currency)
    {
        $this->container['product_payment_currency'] = $product_payment_currency;
