...
class ProductRedemptionRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool $redemption_has_duration In case this product has a fixed duration a countdown will be started based on the `redemption_duration_type`.
     *
     * @return self
     */
