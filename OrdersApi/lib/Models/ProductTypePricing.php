...
/**
 * ProductTypePricing Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductTypePricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductTypePricing';
    ...
    protected static $openAPITypes = [
        'product_type_list_price' => 'string',
        'product_type_discount' => 'string',
        'product_type_discount_percentage' => 'string',
        'product_type_discount_label' => 'string',
        'product_type_sales_price' => 'string',
        'product_type_resale_price' => 'string',
        'product_type_display_price' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'product_type_list_price' => null,
        'product_type_discount' => null,
        'product_type_discount_percentage' => null,
        'product_type_discount_label' => null,
        'product_type_sales_price' => null,
        'product_type_resale_price' => null,
        'product_type_display_price' => null
    ];
    ...
    protected static $attributeMap = [
        'product_type_list_price' => 'product_type_list_price',
        'product_type_discount' => 'product_type_discount',
        'product_type_discount_percentage' => 'product_type_discount_percentage',
        'product_type_discount_label' => 'product_type_discount_label',
        'product_type_sales_price' => 'product_type_sales_price',
        'product_type_resale_price' => 'product_type_resale_price',
        'product_type_display_price' => 'product_type_display_price'
    ];
    ...
    protected static $setters = [
        'product_type_list_price' => 'setProductTypeListPrice',
        'product_type_discount' => 'setProductTypeDiscount',
        'product_type_discount_percentage' => 'setProductTypeDiscountPercentage',
        'product_type_discount_label' => 'setProductTypeDiscountLabel',
        'product_type_sales_price' => 'setProductTypeSalesPrice',
        'product_type_resale_price' => 'setProductTypeResalePrice',
        'product_type_display_price' => 'setProductTypeDisplayPrice'
    ];
    ...
    protected static $getters = [
        'product_type_list_price' => 'getProductTypeListPrice',
        'product_type_discount' => 'getProductTypeDiscount',
        'product_type_discount_percentage' => 'getProductTypeDiscountPercentage',
        'product_type_discount_label' => 'getProductTypeDiscountLabel',
        'product_type_sales_price' => 'getProductTypeSalesPrice',
        'product_type_resale_price' => 'getProductTypeResalePrice',
        'product_type_display_price' => 'getProductTypeDisplayPrice'
    ];
    ...
    {
        $this->container['product_type_list_price'] = $data['product_type_list_price'] ?? null;
        $this->container['product_type_discount'] = $data['product_type_discount'] ?? null;
        $this->container['product_type_discount_percentage'] = $data['product_type_discount_percentage'] ?? null;
        $this->container['product_type_discount_label'] = $data['product_type_discount_label'] ?? null;
        $this->container['product_type_sales_price'] = $data['product_type_sales_price'] ?? null;
        $this->container['product_type_resale_price'] = $data['product_type_resale_price'] ?? null;
        $this->container['product_type_display_price'] = $data['product_type_display_price'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_type_list_price'] === null) {
            $invalidProperties[] = "'product_type_list_price' can't be null";
        }
        if ($this->container['product_type_sales_price'] === null) {
            $invalidProperties[] = "'product_type_sales_price' can't be null";
        }
        if ($this->container['product_type_display_price'] === null) {
            $invalidProperties[] = "'product_type_display_price' can't be null";
        }
    ...
    /**
     * Gets product_type_list_price
     *
     * @return string
     */
    public function getProductTypeListPrice()
    {
        return $this->container['product_type_list_price'];
    }

    /**
     * Sets product_type_list_price
     *
     * @param string $product_type_list_price Standard price before discount for the end customer of this product type set by the supplier.
     *
     * @return self
     */
    public function setProductTypeListPrice($product_type_list_price)
    {
        $this->container['product_type_list_price'] = $product_type_list_price;

        return $this;
    }

    /**
     * Gets product_type_discount
     *
     * @return string|null
     */
    public function getProductTypeDiscount()
    {
        return $this->container['product_type_discount'];
    }

    /**
     * Sets product_type_discount
     *
     * @param string|null $product_type_discount Strike-through discount applicable to `product_type_list_price`.
     *
     * @return self
     */
    public function setProductTypeDiscount($product_type_discount)
    {
        $this->container['product_type_discount'] = $product_type_discount;

        return $this;
    }

    /**
     * Gets product_type_discount_percentage
     *
     * @return string|null
     */
    public function getProductTypeDiscountPercentage()
    {
        return $this->container['product_type_discount_percentage'];
    }

    /**
     * Sets product_type_discount_percentage
     *
     * @param string|null $product_type_discount_percentage Strike-through discount percentage. If blank then the Strike-through discount is not based on percentages.
     *
     * @return self
     */
    public function setProductTypeDiscountPercentage($product_type_discount_percentage)
    {
        $this->container['product_type_discount_percentage'] = $product_type_discount_percentage;

        return $this;
    }

    /**
     * Gets product_type_discount_label
     *
     * @return string|null
     * @deprecated
     */
    public function getProductTypeDiscountLabel()
    {
        return $this->container['product_type_discount_label'];
    }

    /**
     * Sets product_type_discount_label
     *
     * @param string|null $product_type_discount_label Strike-through discount label.
     *
     * @return self
     * @deprecated
     */
    public function setProductTypeDiscountLabel($product_type_discount_label)
    {
        $this->container['product_type_discount_label'] = $product_type_discount_label;

        return $this;
    }

    /**
     * Gets product_type_sales_price
     *
     * @return string
     */
    public function getProductTypeSalesPrice()
    {
        return $this->container['product_type_sales_price'];
    }

    /**
     * Sets product_type_sales_price
     *
     * @param string $product_type_sales_price Standard price after discount for the end-customer set by the reseller. (`product_type_list_price` - `product_type_discount` == `product_type_sales_price`).
     *
     * @return self
     */
    public function setProductTypeSalesPrice($product_type_sales_price)
    {
        $this->container['product_type_sales_price'] = $product_type_sales_price;

        return $this;
    }

    /**
     * Gets product_type_resale_price
     *
     * @return string|null
     */
    public function getProductTypeResalePrice()
    {
        return $this->container['product_type_resale_price'];
    }

    /**
     * Sets product_type_resale_price
     *
     * @param string|null $product_type_resale_price Price for which a product type is sold to and purchased by indirect channels.
     *
     * @return self
     */
    public function setProductTypeResalePrice($product_type_resale_price)
    {
        $this->container['product_type_resale_price'] = $product_type_resale_price;

        return $this;
    }

    /**
     * Gets product_type_display_price
     *
     * @return string
     */
    public function getProductTypeDisplayPrice()
    {
        return $this->container['product_type_display_price'];
    }

    /**
     * Sets product_type_display_price
     *
     * @param string $product_type_display_price The display price is used to show an indicative price for this specific product configuration on your user interface. This price can be used to show the guest a common or marketing related price without requiring further details such as timeslot, pieces, age etc. which would alter the final price. Each individual season can have one or more display prices.
     *
     * @return self
     */
    public function setProductTypeDisplayPrice($product_type_display_price)
    {
        $this->container['product_type_display_price'] = $product_type_display_price;
