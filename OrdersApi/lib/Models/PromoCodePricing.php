...
/**
 * PromoCodePricing Class Doc Comment
 *
 * @category Class
 ...
 */
class PromoCodePricing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PromoCodePricing';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['promo_amount'] = $data['promo_amount'] ?? null;
    }
     ...
     * Sets promo_code
     *
     * @param string $promo_code The promocode.
     *
     * @return self
     */
     ...
     * Sets promo_amount
     *
     * @param string $promo_amount The promo amount.
     *
     * @return self
     */
