...
/**
 * ReservationDetailResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ReservationDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReservationDetailResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\ReservationDetailData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\ReservationDetailData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\ReservationDetailData $data data
     *
     * @return self
     */
