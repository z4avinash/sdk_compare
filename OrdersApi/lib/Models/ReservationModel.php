...
/**
 * ReservationModel Class Doc Comment
 *
 * @category Class
 ...
 */
class ReservationModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReservationModel';
    ...
    protected static $openAPITypes = [
        'reservation_distributor_id' => 'string',
        'reservation_distributor_name' => 'string',
        'reservation_partner_id' => 'string',
        'reservation_partner_name' => 'string',
        'reservation_reference' => 'string',
        'reservation_external_reference' => 'string',
        'reservation_hold_token' => 'string',
        'reservation_valid_until' => '\DateTime',
        'reservation_details' => '\PrioTicket\DistributorAPI\Models\ReservationDetail[]',
        'reservation_promocodes' => '\PrioTicket\DistributorAPI\Models\AppliedPromocode[]',
        'reservation_pricing' => '\PrioTicket\DistributorAPI\Models\Pricing',
        'reservation_payments' => '\PrioTicket\DistributorAPI\Models\PaymentDetails[]',
        'reservation_credit' => '\PrioTicket\DistributorAPI\Models\CreditLimit',
        'reservation_custom_fields' => '\PrioTicket\DistributorAPI\Models\CustomField[]'
    ];
    ...
    protected static $openAPIFormats = [
        'reservation_distributor_id' => null,
        'reservation_distributor_name' => null,
        'reservation_partner_id' => null,
        'reservation_partner_name' => null,
        'reservation_reference' => null,
        'reservation_external_reference' => null,
        'reservation_hold_token' => null,
        'reservation_valid_until' => 'date-time',
        'reservation_details' => null,
        'reservation_promocodes' => null,
        'reservation_pricing' => null,
        'reservation_payments' => null,
        'reservation_credit' => null,
        'reservation_custom_fields' => null
    ];
    ...
    protected static $attributeMap = [
        'reservation_distributor_id' => 'reservation_distributor_id',
        'reservation_distributor_name' => 'reservation_distributor_name',
        'reservation_partner_id' => 'reservation_partner_id',
        'reservation_partner_name' => 'reservation_partner_name',
        'reservation_reference' => 'reservation_reference',
        'reservation_external_reference' => 'reservation_external_reference',
        'reservation_hold_token' => 'reservation_hold_token',
        'reservation_valid_until' => 'reservation_valid_until',
        'reservation_details' => 'reservation_details',
        'reservation_promocodes' => 'reservation_promocodes',
    ...
    protected static $setters = [
        'reservation_distributor_id' => 'setReservationDistributorId',
        'reservation_distributor_name' => 'setReservationDistributorName',
        'reservation_partner_id' => 'setReservationPartnerId',
        'reservation_partner_name' => 'setReservationPartnerName',
        'reservation_reference' => 'setReservationReference',
        'reservation_external_reference' => 'setReservationExternalReference',
        'reservation_hold_token' => 'setReservationHoldToken',
        'reservation_valid_until' => 'setReservationValidUntil',
        'reservation_details' => 'setReservationDetails',
        'reservation_promocodes' => 'setReservationPromocodes',
        'reservation_pricing' => 'setReservationPricing',
        'reservation_payments' => 'setReservationPayments',
        'reservation_credit' => 'setReservationCredit',
        'reservation_custom_fields' => 'setReservationCustomFields'
    ];
    ...
    protected static $getters = [
        'reservation_distributor_id' => 'getReservationDistributorId',
        'reservation_distributor_name' => 'getReservationDistributorName',
        'reservation_partner_id' => 'getReservationPartnerId',
        'reservation_partner_name' => 'getReservationPartnerName',
        'reservation_reference' => 'getReservationReference',
        'reservation_external_reference' => 'getReservationExternalReference',
        'reservation_hold_token' => 'getReservationHoldToken',
        'reservation_valid_until' => 'getReservationValidUntil',
        'reservation_details' => 'getReservationDetails',
        'reservation_promocodes' => 'getReservationPromocodes',
        'reservation_pricing' => 'getReservationPricing',
        'reservation_payments' => 'getReservationPayments',
        'reservation_credit' => 'getReservationCredit',
        'reservation_custom_fields' => 'getReservationCustomFields'
    ];
    ...
    {
        $this->container['reservation_distributor_id'] = $data['reservation_distributor_id'] ?? null;
        $this->container['reservation_distributor_name'] = $data['reservation_distributor_name'] ?? null;
        $this->container['reservation_partner_id'] = $data['reservation_partner_id'] ?? null;
        $this->container['reservation_partner_name'] = $data['reservation_partner_name'] ?? null;
        $this->container['reservation_reference'] = $data['reservation_reference'] ?? null;
        $this->container['reservation_external_reference'] = $data['reservation_external_reference'] ?? null;
        $this->container['reservation_hold_token'] = $data['reservation_hold_token'] ?? null;
        $this->container['reservation_valid_until'] = $data['reservation_valid_until'] ?? null;
        $this->container['reservation_details'] = $data['reservation_details'] ?? null;
        $this->container['reservation_promocodes'] = $data['reservation_promocodes'] ?? null;
        $this->container['reservation_pricing'] = $data['reservation_pricing'] ?? null;
        $this->container['reservation_payments'] = $data['reservation_payments'] ?? null;
        $this->container['reservation_credit'] = $data['reservation_credit'] ?? null;
        $this->container['reservation_custom_fields'] = $data['reservation_custom_fields'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reservation_distributor_id'] === null) {
            $invalidProperties[] = "'reservation_distributor_id' can't be null";
        }
        if ($this->container['reservation_distributor_name'] === null) {
            $invalidProperties[] = "'reservation_distributor_name' can't be null";
        }
        if ($this->container['reservation_reference'] === null) {
            $invalidProperties[] = "'reservation_reference' can't be null";
        }
        if ((mb_strlen($this->container['reservation_reference']) < 8)) {
            $invalidProperties[] = "invalid value for 'reservation_reference', the character length must be bigger than or equal to 8.";
        }

        if ($this->container['reservation_external_reference'] === null) {
            $invalidProperties[] = "'reservation_external_reference' can't be null";
        }
        if ((mb_strlen($this->container['reservation_external_reference']) > 50)) {
            $invalidProperties[] = "invalid value for 'reservation_external_reference', the character length must be smaller than or equal to 50.";
        }

        if (!preg_match("/^[\\\\a-zA-Z-_\/\\d]+$/", $this->container['reservation_external_reference'])) {
            $invalidProperties[] = "invalid value for 'reservation_external_reference', must be conform to the pattern /^[\\\\a-zA-Z-_\/\\d]+$/.";
        }

        if ($this->container['reservation_valid_until'] === null) {
            $invalidProperties[] = "'reservation_valid_until' can't be null";
        }
        if ($this->container['reservation_details'] === null) {
            $invalidProperties[] = "'reservation_details' can't be null";
        }
        if ($this->container['reservation_pricing'] === null) {
            $invalidProperties[] = "'reservation_pricing' can't be null";
        }
    ...
    /**
     * Gets reservation_distributor_id
     *
     * @return string
     */
    public function getReservationDistributorId()
    {
        return $this->container['reservation_distributor_id'];
    }

    /**
     * Sets reservation_distributor_id
     *
     * @param string $reservation_distributor_id Unique identifier for distributor assigned by Prio.
     *
     * @return self
     */
    public function setReservationDistributorId($reservation_distributor_id)
    {
        $this->container['reservation_distributor_id'] = $reservation_distributor_id;

        return $this;
    }

    /**
     * Gets reservation_distributor_name
     *
     * @return string
     */
    public function getReservationDistributorName()
    {
        return $this->container['reservation_distributor_name'];
    }

    /**
     * Sets reservation_distributor_name
     *
     * @param string $reservation_distributor_name Name of the distributor.
     *
     * @return self
     */
    public function setReservationDistributorName($reservation_distributor_name)
    {
        $this->container['reservation_distributor_name'] = $reservation_distributor_name;

        return $this;
    }

    /**
     * Gets reservation_partner_id
     *
     * @return string|null
     */
    public function getReservationPartnerId()
    {
        return $this->container['reservation_partner_id'];
    }

    /**
     * Sets reservation_partner_id
     *
     * @param string|null $reservation_partner_id Unique identifier for partner assigned by Prio.
     *
     * @return self
     */
    public function setReservationPartnerId($reservation_partner_id)
    {
        $this->container['reservation_partner_id'] = $reservation_partner_id;

        return $this;
    }

    /**
     * Gets reservation_partner_name
     *
     * @return string|null
     */
    public function getReservationPartnerName()
    {
        return $this->container['reservation_partner_name'];
    }

    /**
     * Sets reservation_partner_name
     *
     * @param string|null $reservation_partner_name Name of the partner.
     *
     * @return self
     */
    public function setReservationPartnerName($reservation_partner_name)
    {
        $this->container['reservation_partner_name'] = $reservation_partner_name;

        return $this;
    }

    /**
     * Gets reservation_reference
     *
     * @return string
     */
    public function getReservationReference()
    {
        return $this->container['reservation_reference'];
    }

    /**
     * Sets reservation_reference
     *
     * @param string $reservation_reference A unique identifier for the created reservation in the Prio.
     *
     * @return self
     */
    public function setReservationReference($reservation_reference)
    {

        if ((mb_strlen($reservation_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $reservation_reference when calling ReservationModel., must be bigger than or equal to 8.');
        }

        $this->container['reservation_reference'] = $reservation_reference;

        return $this;
    }

    /**
     * Gets reservation_external_reference
     *
     * @return string
     */
    public function getReservationExternalReference()
    {
        return $this->container['reservation_external_reference'];
    }

    /**
     * Sets reservation_external_reference
     *
     * @param string $reservation_external_reference A unique reservation identifier within the external system.
     *
     * @return self
     */
    public function setReservationExternalReference($reservation_external_reference)
    {
        if ((mb_strlen($reservation_external_reference) > 50)) {
            throw new \InvalidArgumentException('invalid length for $reservation_external_reference when calling ReservationModel., must be smaller than or equal to 50.');
        }
        if ((!preg_match("/^[\\\\a-zA-Z-_\/\\d]+$/", $reservation_external_reference))) {
            throw new \InvalidArgumentException("invalid value for $reservation_external_reference when calling ReservationModel., must conform to the pattern /^[\\\\a-zA-Z-_\/\\d]+$/.");
        }

        $this->container['reservation_external_reference'] = $reservation_external_reference;

        return $this;
    }

    /**
     * Gets reservation_hold_token
     *
     * @return string|null
     */
    public function getReservationHoldToken()
    {
        return $this->container['reservation_hold_token'];
    }

    /**
     * Sets reservation_hold_token
     *
     * @param string|null $reservation_hold_token Unique hold token for this reservation (Internal use only). Only a single holdtoken is allowed per reservation.
     *
     * @return self
     */
    public function setReservationHoldToken($reservation_hold_token)
    {
        $this->container['reservation_hold_token'] = $reservation_hold_token;

        return $this;
    }

    /**
     * Gets reservation_valid_until
     *
     * @return \DateTime
     */
    public function getReservationValidUntil()
    {
        return $this->container['reservation_valid_until'];
    }

    /**
     * Sets reservation_valid_until
     *
     * @param \DateTime $reservation_valid_until The reserved order will stay alive until this time, after that the reservation will be auto-cancelled. > Please note that if you are having multiple products in your cart, that the value will be set according to the product with the earliest expiration time. In this case ONLY this specific product will be auto-cancelled. To view your updated reservation you could call the 'Cart Details' endpoint.  > Warning; Prio will simply confirm your pending reservation, even when products have been auto-cancelled in between. If this value is not checked by the reserving party, unexpected results could occur.
     *
     * @return self
     */
    public function setReservationValidUntil($reservation_valid_until)
    {
        $this->container['reservation_valid_until'] = $reservation_valid_until;
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\ReservationDetail[]
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\ReservationDetail[] $reservation_details Contains one or more bookings.
     *
     * @return self
     */
    ...
    /**
     * Gets reservation_promocodes
     *
     * @return \PrioTicket\DistributorAPI\Models\AppliedPromocode[]|null
     */
    public function getReservationPromocodes()
    {
        return $this->container['reservation_promocodes'];
    }

    /**
     * Sets reservation_promocodes
     *
     * @param \PrioTicket\DistributorAPI\Models\AppliedPromocode[]|null $reservation_promocodes The promocodes applied to this reservation.
     *
     * @return self
     */
    public function setReservationPromocodes($reservation_promocodes)
    {
        $this->container['reservation_promocodes'] = $reservation_promocodes;

        return $this;
    }

    /**
     * Gets reservation_pricing
     *
     * @return \PrioTicket\DistributorAPI\Models\Pricing
     */
    public function getReservationPricing()
    {
        return $this->container['reservation_pricing'];
    }

    /**
     * Sets reservation_pricing
     *
     * @param \PrioTicket\DistributorAPI\Models\Pricing $reservation_pricing reservation_pricing
     *
     * @return self
     */
    public function setReservationPricing($reservation_pricing)
    {
        $this->container['reservation_pricing'] = $reservation_pricing;

        return $this;
    }

    /**
     * Gets reservation_payments
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentDetails[]|null
     */
    public function getReservationPayments()
    {
        return $this->container['reservation_payments'];
    }

    /**
     * Sets reservation_payments
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentDetails[]|null $reservation_payments Details on the payments linked to this reservation.   A reservation can have multiple payment records in case of installments, split payments, refunds and additional charges. Every action will result in a new record so all history is kept.  Payment records are always returned in a descending order based on the payment date. Therefore the first entry in the array can be considered as the last payment and thus the `payment_total` (running sum) as the actual total amount paid and the `payment_status ` as the latest payment status for this reservation.
     *
     * @return self
     */
    public function setReservationPayments($reservation_payments)
    {
        $this->container['reservation_payments'] = $reservation_payments;

        return $this;
    }

    /**
     * Gets reservation_credit
     *
     * @return \PrioTicket\DistributorAPI\Models\CreditLimit|null
     */
    public function getReservationCredit()
    {
        return $this->container['reservation_credit'];
    }

    /**
     * Sets reservation_credit
     *
     * @param \PrioTicket\DistributorAPI\Models\CreditLimit|null $reservation_credit reservation_credit
     *
     * @return self
     */
    public function setReservationCredit($reservation_credit)
    {
        $this->container['reservation_credit'] = $reservation_credit;

        return $this;
    }

    /**
     * Gets reservation_custom_fields
     *
     * @return \PrioTicket\DistributorAPI\Models\CustomField[]|null
     */
    public function getReservationCustomFields()
    {
        return $this->container['reservation_custom_fields'];
    }

    /**
     * Sets reservation_custom_fields
     *
     * @param \PrioTicket\DistributorAPI\Models\CustomField[]|null $reservation_custom_fields Freeform entry of any key-value pair.
     *
     * @return self
     */
    public function setReservationCustomFields($reservation_custom_fields)
    {
        $this->container['reservation_custom_fields'] = $reservation_custom_fields;
