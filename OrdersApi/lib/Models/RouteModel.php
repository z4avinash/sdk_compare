 ...
 */
class RouteModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RouteModel';
    ...
    protected static $openAPITypes = [
        ...
        'route_duration' => 'int',
        'route_frequency' => 'int',
        'route_audio_languages' => 'string[]',
        'route_live_languages' => 'string[]',
        'route_products' => 'string[]',
        'route_locations' => '\PrioTicket\DistributorAPI\Models\RouteLocation[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'route_end_time' => null,
        'route_duration' => null,
        'route_frequency' => null,
        'route_audio_languages' => null,
        'route_live_languages' => null,
        'route_products' => null,
    ...
    protected static $attributeMap = [
        ...
        'route_audio_languages' => 'route_audio_languages',
        'route_live_languages' => 'route_live_languages',
    ...
    protected static $setters = [
        'route_active' => 'setRouteActive',
        'route_id' => 'setRouteId',
        'route_name' => 'setRouteName',
        'route_description' => 'setRouteDescription',
        'route_color' => 'setRouteColor',
        'route_type' => 'setRouteType',
        'route_start_time' => 'setRouteStartTime',
        'route_end_time' => 'setRouteEndTime',
        'route_duration' => 'setRouteDuration',
        'route_frequency' => 'setRouteFrequency',
        'route_audio_languages' => 'setRouteAudioLanguages',
        'route_live_languages' => 'setRouteLiveLanguages',
        'route_products' => 'setRouteProducts',
    ...
    protected static $getters = [
        'route_active' => 'getRouteActive',
        'route_id' => 'getRouteId',
        'route_name' => 'getRouteName',
        'route_description' => 'getRouteDescription',
        'route_color' => 'getRouteColor',
        'route_type' => 'getRouteType',
        'route_start_time' => 'getRouteStartTime',
        'route_end_time' => 'getRouteEndTime',
        'route_duration' => 'getRouteDuration',
        'route_frequency' => 'getRouteFrequency',
        'route_audio_languages' => 'getRouteAudioLanguages',
        'route_live_languages' => 'getRouteLiveLanguages',
        'route_products' => 'getRouteProducts',
    ...
    const ROUTE_TYPE_DRIVING = 'DRIVING';
    const ROUTE_TYPE_WALKING = 'WALKING';
    const ROUTE_TYPE_BICYCLING = 'BICYCLING';
    const ROUTE_TYPE_TRANSIT = 'TRANSIT';
    const ROUTE_TYPE_BOAT = 'BOAT';
    ...
    {
        return [
            self::ROUTE_TYPE_DRIVING,
            self::ROUTE_TYPE_WALKING,
            self::ROUTE_TYPE_BICYCLING,
            self::ROUTE_TYPE_TRANSIT,
            self::ROUTE_TYPE_BOAT,
        ];
    }
    ...
    {
        $this->container['route_active'] = $data['route_active'] ?? 'true';
        $this->container['route_id'] = $data['route_id'] ?? null;
        $this->container['route_name'] = $data['route_name'] ?? null;
        $this->container['route_description'] = $data['route_description'] ?? null;
        $this->container['route_color'] = $data['route_color'] ?? null;
        $this->container['route_type'] = $data['route_type'] ?? null;
        $this->container['route_start_time'] = $data['route_start_time'] ?? null;
        $this->container['route_end_time'] = $data['route_end_time'] ?? null;
        $this->container['route_duration'] = $data['route_duration'] ?? null;
        $this->container['route_frequency'] = $data['route_frequency'] ?? null;
        $this->container['route_audio_languages'] = $data['route_audio_languages'] ?? null;
        $this->container['route_live_languages'] = $data['route_live_languages'] ?? null;
        $this->container['route_products'] = $data['route_products'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['route_active'] === null) {
            $invalidProperties[] = "'route_active' can't be null";
        }
     ...
     * @return string
     */
    public function getRouteActive()
    {
        return $this->container['route_active'];
    }

    /**
     * Sets route_active
     *
     * @param string $route_active Whether this route should be shown.
     *
     * @return self
     */
    public function setRouteActive($route_active)
    {
        $this->container['route_active'] = $route_active;
     ...
     * Sets route_id
     *
     * @param string $route_id Unique identifier of this route.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets route_name
     *
     * @param string $route_name Returns route name.
     *
     * @return self
     */
     ...
     *
     * @param string|null $route_description Description of the route.
     *
     * @return self
     */
     ...
     * Sets route_color
     *
     * @param string|null $route_color Returns the color of this route. (HEX)
     *
     * @return self
     */
     ...
     * Sets route_type
     *
     * @param string|null $route_type The type of route.
     *
     * @return self
     */
    ...
    /**
     * Gets route_start_time
     *
     * @return string|null
     */
    public function getRouteStartTime()
    {
        return $this->container['route_start_time'];
    }

    /**
     * Sets route_start_time
     *
     * @param string|null $route_start_time The starting time of the route.
     *
     * @return self
     */
    public function setRouteStartTime($route_start_time)
    {
        $this->container['route_start_time'] = $route_start_time;
     ...
     * @return string|null
     */
    public function getRouteEndTime()
    {
        return $this->container['route_end_time'];
    }

    /**
     * Sets route_end_time
     *
     * @param string|null $route_end_time The end time of the route.
     *
     * @return self
     */
    public function setRouteEndTime($route_end_time)
    {
        $this->container['route_end_time'] = $route_end_time;
     ...
     * @return int|null
     */
    public function getRouteDuration()
    {
        return $this->container['route_duration'];
    }

    /**
     * Sets route_duration
     *
     * @param int|null $route_duration The duration of the route (in minutes).
     *
     * @return self
     */
    public function setRouteDuration($route_duration)
    {
        $this->container['route_duration'] = $route_duration;

        return $this;
    }

    /**
     * Gets route_frequency
     *
     * @return int|null
     */
    public function getRouteFrequency()
    {
        return $this->container['route_frequency'];
    }

    /**
     * Sets route_frequency
     *
     * @param int|null $route_frequency Returns the \"loop\" frequency of this route.
     *
     * @return self
     */
    public function setRouteFrequency($route_frequency)
    {
        $this->container['route_frequency'] = $route_frequency;

        return $this;
    }

    /**
     * Gets route_audio_languages
     *
     * @return string[]|null
     */
    public function getRouteAudioLanguages()
    {
        return $this->container['route_audio_languages'];
    }

    /**
     * Sets route_audio_languages
     *
     * @param string[]|null $route_audio_languages The audio languages available on this route. Language is defined in [ISO-639-1](https://en.wikipedia.org/wiki/ISO_639-1) format.
     *
     * @return self
     */
    public function setRouteAudioLanguages($route_audio_languages)
    {
        $this->container['route_audio_languages'] = $route_audio_languages;

        return $this;
    }

    /**
     * Gets route_live_languages
     *
     * @return string[]|null
     */
    public function getRouteLiveLanguages()
    {
        return $this->container['route_live_languages'];
    }

    /**
     * Sets route_live_languages
     *
     * @param string[]|null $route_live_languages The guide languages available on this route. Language is defined in [ISO-639-1](https://en.wikipedia.org/wiki/ISO_639-1) format.
     *
     * @return self
     */
    public function setRouteLiveLanguages($route_live_languages)
    {
        $this->container['route_live_languages'] = $route_live_languages;
     ...
     * @return string[]|null
     */
    public function getRouteProducts()
    {
        return $this->container['route_products'];
    }

    /**
     * Sets route_products
     *
     * @param string[]|null $route_products List of applicable products on this route.
     *
     * @return self
     */
    public function setRouteProducts($route_products)
    {
        $this->container['route_products'] = $route_products;
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\RouteLocation[]|null
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\RouteLocation[]|null $route_locations Specifies an array of directional waypoints. Waypoints alter a route by routing it through the specified location(s).
     *
     * @return self
     */
