 ...
 */
class Spot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Spot';
    ...
    protected static $setters = [
        'spot_id' => 'setSpotId',
        'spot_name' => 'setSpotName',
        'spot_section' => 'setSpotSection',
        'spot_row' => 'setSpotRow',
        'spot_number' => 'setSpotNumber',
        'spot_type' => 'setSpotType',
        'spot_state' => 'setSpotState'
    ];
    ...
    protected static $getters = [
        'spot_id' => 'getSpotId',
        'spot_name' => 'getSpotName',
        'spot_section' => 'getSpotSection',
        'spot_row' => 'getSpotRow',
        'spot_number' => 'getSpotNumber',
        'spot_type' => 'getSpotType',
        'spot_state' => 'getSpotState'
    ];
    ...
    const SPOT_TYPE_SEAT = 'SEAT';
    const SPOT_TYPE_BOOTH = 'BOOTH';
    const SPOT_TYPE_TABLE = 'TABLE';
    const SPOT_TYPE_AREA = 'AREA';
    const SPOT_STATE_AVAILABLE = 'AVAILABLE';
    const SPOT_STATE_BOOKED = 'BOOKED';
    const SPOT_STATE_RESERVED = 'RESERVED';
    const SPOT_STATE_DISABLED = 'DISABLED';
     ...
     * @return string[]
     */
    public function getSpotTypeAllowableValues()
    {
        return [
            self::SPOT_TYPE_SEAT,
            self::SPOT_TYPE_BOOTH,
            self::SPOT_TYPE_TABLE,
            self::SPOT_TYPE_AREA,
        ];
    }
     ...
     * @return string[]
     */
    public function getSpotStateAllowableValues()
    {
        return [
            self::SPOT_STATE_AVAILABLE,
            self::SPOT_STATE_BOOKED,
            self::SPOT_STATE_RESERVED,
            self::SPOT_STATE_DISABLED,
        ];
    }
    ...
    {
        $this->container['spot_id'] = $data['spot_id'] ?? null;
        $this->container['spot_name'] = $data['spot_name'] ?? null;
        $this->container['spot_section'] = $data['spot_section'] ?? null;
        $this->container['spot_row'] = $data['spot_row'] ?? null;
        $this->container['spot_number'] = $data['spot_number'] ?? null;
        $this->container['spot_type'] = $data['spot_type'] ?? null;
        $this->container['spot_state'] = $data['spot_state'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['spot_type'] === null) {
            $invalidProperties[] = "'spot_type' can't be null";
        }
        $allowedValues = $this->getSpotTypeAllowableValues();
        if (!is_null($this->container['spot_type']) && !in_array($this->container['spot_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'spot_type', must be one of '%s'",
                $this->container['spot_type'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['spot_state'] === null) {
            $invalidProperties[] = "'spot_state' can't be null";
        }
        $allowedValues = $this->getSpotStateAllowableValues();
        if (!is_null($this->container['spot_state']) && !in_array($this->container['spot_state'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'spot_state', must be one of '%s'",
                $this->container['spot_state'],
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        return $this->container['spot_id'];
    }

    /**
     * Sets spot_id
     *
     * @param string|null $spot_id Spot ID.
     *
     * @return self
     */
    public function setSpotId($spot_id)
    {
        $this->container['spot_id'] = $spot_id;
    ...
    {
        return $this->container['spot_name'];
    }

    /**
     * Sets spot_name
     *
     * @param string|null $spot_name Spot name.
     *
     * @return self
     */
    public function setSpotName($spot_name)
    {
        $this->container['spot_name'] = $spot_name;
     ...
     * @return string|null
     */
    public function getSpotSection()
    {
        return $this->container['spot_section'];
    }

    /**
     * Sets spot_section
     *
     * @param string|null $spot_section Name of the section. Only applicable if the product has sections.
     *
     * @return self
     */
    public function setSpotSection($spot_section)
    {
        $this->container['spot_section'] = $spot_section;
     ...
     * @return string|null
     */
    public function getSpotRow()
    {
        return $this->container['spot_row'];
    }

    /**
     * Sets spot_row
     *
     * @param string|null $spot_row The row the spot resides in.
     *
     * @return self
     */
    public function setSpotRow($spot_row)
    {
        $this->container['spot_row'] = $spot_row;
    ...
    {
        return $this->container['spot_number'];
    }

    /**
     * Sets spot_number
     *
     * @param string|null $spot_number The spot number.
     *
     * @return self
     */
    public function setSpotNumber($spot_number)
    {
        $this->container['spot_number'] = $spot_number;
    ...
    {
        return $this->container['spot_type'];
    }

    /**
     * Sets spot_type
     *
     * @param string $spot_type Type of spot.
     *
     * @return self
     */
    public function setSpotType($spot_type)
    {
        $allowedValues = $this->getSpotTypeAllowableValues();
        if (!in_array($spot_type, $allowedValues, true)) {
        ...
        $this->container['spot_type'] = $spot_type;
    ...
    {
        return $this->container['spot_state'];
    }

    /**
     * Sets spot_state
     *
     * @param string $spot_state The state of the spot.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getSpotStateAllowableValues();
        if (!in_array($spot_state, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'spot_state', must be one of '%s'",
                    $spot_state,
        ...
        $this->container['spot_state'] = $spot_state;
