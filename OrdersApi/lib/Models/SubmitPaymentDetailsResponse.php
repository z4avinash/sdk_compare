...
/**
 * SubmitPaymentDetailsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class SubmitPaymentDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitPaymentDetailsResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\SubmitPaymentDetailsResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\SubmitPaymentDetailsResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\SubmitPaymentDetailsResponseData $data data
     *
     * @return self
     */
