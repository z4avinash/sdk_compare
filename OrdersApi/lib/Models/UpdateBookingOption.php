...
/**
 * UpdateBookingOption Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateBookingOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateBookingOption';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['booking_reference']) && (mb_strlen($this->container['booking_reference']) < 8)) {
    ...
    public function setBookingVersion($booking_version)
    {
        ...
        if (!is_null($booking_version) && ($booking_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $booking_version when calling UpdateBookingOption., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $booking_reference Unique identifier for the booking that you would like to amend. If you leave this value empty, a new booking will be added to the existing order.
     *
     * @return self
     */
    public function setBookingReference($booking_reference)
    {
        ...
        if (!is_null($booking_reference) && (mb_strlen($booking_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $booking_reference when calling UpdateBookingOption., must be bigger than or equal to 8.');
        }
