...
class UpdateContactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\UpdateContactRequestData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\UpdateContactRequestData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\UpdateContactRequestData $data data
     *
     * @return self
     */
