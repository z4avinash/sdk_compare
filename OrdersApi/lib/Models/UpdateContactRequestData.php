...
/**
 * UpdateContactRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateContactRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateContactRequestData';
    ...
    protected static $openAPITypes = [
        ...
        'contact' => '\PrioTicket\DistributorAPI\Models\ContactDetails'
    ];
     ...
     * Sets contact
     *
     * @param \PrioTicket\DistributorAPI\Models\ContactDetails $contact contact
     *
     * @return self
     */
