...
/**
 * UpdateOrderModel Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOrderModel';
    ...
    protected static $openAPITypes = [
        ...
        'order_bookings' => '\PrioTicket\DistributorAPI\Models\UpdateBookingOption[]'
    ];
    ...
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling UpdateOrderModel., must be bigger than or equal to 8.');
        }
     ...
     * Gets order_bookings
     *
     * @return \PrioTicket\DistributorAPI\Models\UpdateBookingOption[]|null
     */
     ...
     * Sets order_bookings
     *
     * @param \PrioTicket\DistributorAPI\Models\UpdateBookingOption[]|null $order_bookings **(ADVANCED)** Only include the bookings you would like to amend.  > Do not use this functionality without prior consent, unexpected behaviour can occur.
     *
     * @return self
     */
