...
class AuthenticationApi
{
     ...
     *
     * @param  \PrioTicket\DistributorAPI\Models\ClientCredentialsGrantRequest $client_credentials_grant_request Clients in possession of a client password MAY use the HTTP Basic authentication scheme  as defined in [RFC2617](https://tools.ietf.org/html/rfc2617) to authenticate withthe authorization server.    The client identifier is encoded using the \&quot;application/x-www-form-urlencoded\&quot; encoding algorithm, and the encoded value is used as the username; the client password is encoded using the same algorithm and used as the password.  Alternatively, the authorization server supports including the client credentials in the request-body using the following parameters:Including the client credentials in the request-body using the two parameters is NOT RECOMMENDED and SHOULD be limited to clients unable to directly utilize the HTTP Basic authentication scheme (or other password-based HTTP authentication schemes). The parameters can only be transmitted in the request-body and MUST NOT be included in the request URI. (required)
     * @param  string $authorization The client sends HTTP requests with the Authorization header that contains the word Basic word followed by a space and a base64-encoded string username:password. (optional)
     *
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PrioTicket\DistributorAPI\Models\ClientCredentialsGrantResponse|\PrioTicket\DistributorAPI\Models\OAuthErrorModel|\PrioTicket\DistributorAPI\Models\OAuthErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel|\PrioTicket\DistributorAPI\Models\ErrorModel
     */
    public function getToken($client_credentials_grant_request, $authorization = null)
    {
        list($response) = $this->getTokenWithHttpInfo($client_credentials_grant_request, $authorization);
        return $response;
    }
     ...
     */
    public function getTokenWithHttpInfo($client_credentials_grant_request, $authorization = null)
    {
        $request = $this->getTokenRequest($client_credentials_grant_request, $authorization);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PrioTicket\DistributorAPI\Models\ClientCredentialsGrantResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PrioTicket\DistributorAPI\Models\ClientCredentialsGrantResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\PrioTicket\DistributorAPI\Models\OAuthErrorModel' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PrioTicket\DistributorAPI\Models\OAuthErrorModel', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\PrioTicket\DistributorAPI\Models\ClientCredentialsGrantResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PrioTicket\DistributorAPI\Models\ClientCredentialsGrantResponse',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PrioTicket\DistributorAPI\Models\OAuthErrorModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function getTokenAsync($client_credentials_grant_request, $authorization = null)
    {
        return $this->getTokenAsyncWithHttpInfo($client_credentials_grant_request, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenAsyncWithHttpInfo($client_credentials_grant_request, $authorization = null)
    {
        $returnType = '\PrioTicket\DistributorAPI\Models\ClientCredentialsGrantResponse';
        $request = $this->getTokenRequest($client_credentials_grant_request, $authorization);
     ...
     */
    public function getTokenRequest($client_credentials_grant_request, $authorization = null)
    {
        // verify the required parameter 'client_credentials_grant_request' is set
        if ($client_credentials_grant_request === null || (is_array($client_credentials_grant_request) && count($client_credentials_grant_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_credentials_grant_request when calling getToken'
            );
        }
        ...
        // for model (json/xml)
        if (isset($client_credentials_grant_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($client_credentials_grant_request));
            } else {
                $httpBody = $client_credentials_grant_request;
            }
