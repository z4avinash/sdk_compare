...
class OrdersApi
{
     ...
     * @param  int $order_version Order Version / Revision number. By default the latest revision will be returned.  If set, the &#x60;cache&#x60; value will be ignored. (optional)
     ...
     * @param  \PrioTicket\DistributorAPI\Models\OrderStatusTypes[] $order_status [FILTER] on &#x60;order_status&#x60;. (optional)
     ...
     * @param  \DateTime $order_modified [FILTER] on &#x60;order_modified&#x60;. Only the orders modified after the given date will be returned. This includes newly created orders.  For caching purposes we recommend using the &#x60;If-Modified-Since&#x60; header instead. (optional)
     ...
     * @param  string $product_availability_capacity_id [FILTER] on &#x60;product_availability_capacity_id&#x60;. (optional)
     ...
     * @param  bool $filter_bookings [CONFIG] Filter (sub) bookings from response.   Whether to include all bookings belonging to the same order or only those matching the defined filters. By default the system will return every booking of an order, regardless whether some of those bookings do not match the defined filters.  For example. when a filter for &#x60;product_id&#x60; is set, only orders which contain that product will be returned, but additional bookings (for different product IDs) of that same order might be listed as well. By enabling this filter, only bookings for that &#x60;product_id&#x60; would be returned. (optional, default to false)
     * @param  string $order_view_type [CONFIG] **(ADVANCED)** account view type.  This value defaults and is limited to the scope of your credentials. (optional)
     ...
     * @param  string $voucher_additional_information This information will be shown on the voucher in a seperate section. (optional)
     *
     * @throws \PrioTicket\DistributorAPI\ApiException on non-2xx response
     * @throws \InvalidArgumentException
