...
class PaymentsApi
{
     ...
     * @param  string[] $product_type_transaction_id **(ADVANCED)** In case the &#x60;product_type_transaction_id&#x60; is provided, a partial refund will be made. Only the specified transaction(s) will be refunded. (optional)
     * @param  string $payment_id Unique Payment ID set by the Prio system. This is an internal identifier. (optional)
     * @param  string $payment_merchant_reference Unique (external) payment reference set by the merchant / (third) party / POS system initiating the payment. (optional)
     * @param  string $payment_service_provider_reference Reference set by payment service provider (optional)
     * @param  string $refund_amount **(ADVANCED)** Amount of money to be refunded. If not provided, the full amount will be refunded. (optional)
     ...
     * @param  string $payment_merchant_reference [FILTER] on &#x60;payment_merchant_reference&#x60;. (optional)
     * @param  string $payment_service_provider_reference [FILTER] on &#x60;payment_service_provider_reference&#x60;. (optional)
     * @param  string $payment_external_reference [FILTER] on &#x60;payment_external_reference&#x60;. (optional)
     * @param  \PrioTicket\DistributorAPI\Models\PaymentClass $payment_class **(ADVANCED)** By default sales payments will be returned. Alternatively you can also retrieve the purchase related payments. (optional)
