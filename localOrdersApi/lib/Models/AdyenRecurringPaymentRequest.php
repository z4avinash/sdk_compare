...
/**
 * AdyenRecurringPaymentRequest Class Doc Comment
 *
 * @category Class
 * @description Use Adyen Recurring Payments to store and automatically capture payments based on (non-)fixed schedules or events ([More info on Adyen Recurring Payments](https://docs.adyen.com/checkout/tokenization/create-and-use-tokens)).  Before using recurring payments, you first need to create a tokenized payment method. To tokenize a payment method you need to initiate a Create Payment request with &#x60;payment_object_type:ADYEN_DROP_IN&#x60; and &#x60;payment_recurring:true&#x60;.   The payment details will be stored and can be retrieved by providing the same &#x60;payment_external_reference&#x60; in both requests. &gt; Payment Contact Details (&#x60;payment_contact&#x60;) cannot be changed as these are stored once at token creation.
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AdyenRecurringPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdyenRecurringPaymentRequest';
