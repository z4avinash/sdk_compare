...
/**
 * ClientCredentialsGrantRequest Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ClientCredentialsGrantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientCredentialsGrantRequest';
     ...
     * Sets grant_type
     *
     * @param string $grant_type Value MUST be set to \"client_credentials\".
     *
     * @return self
     */
