...
/**
 * ConfirmedOrderModel Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfirmedOrderModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfirmedOrderModel';
    ...
    protected static $openAPITypes = [
        ...
        'order_bookings' => '\PrioTicket\DistributorAPI\Models\ConfirmedBooking[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_pricing'] === null) {
            $invalidProperties[] = "'order_pricing' can't be null";
        }
    ...
    public function setOrderReference($order_reference)
    {
        ...
        if ((mb_strlen($order_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $order_reference when calling ConfirmedOrderModel., must be bigger than or equal to 8.');
        }
     ...
     * Sets order_archived
     *
     * @param bool|null $order_archived Whether this order has been archived. Orders will be automatically archived if it is in a final state and has not been amended for a long period of time.
     *
     * @return self
     */
     ...
     * Sets order_redacted
     *
     * @param bool $order_redacted Whether this order has redacted or de-identified sensitive data such as personally identifiable information (PII).
     *
     * @return self
     */
     ...
     * Sets order_pricing
     *
     * @param \PrioTicket\DistributorAPI\Models\Pricing $order_pricing order_pricing
     *
     * @return self
     */
     ...
     * Gets order_bookings
     *
     * @return \PrioTicket\DistributorAPI\Models\ConfirmedBooking[]
     */
     ...
     * Sets order_bookings
     *
     * @param \PrioTicket\DistributorAPI\Models\ConfirmedBooking[] $order_bookings Details on the bookings made in this order.
     *
     * @return self
     */
