...
/**
 * CreateOrderRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOrderRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrderRequestData';
    ...
    protected static $openAPITypes = [
        ...
        'order' => '\PrioTicket\DistributorAPI\Models\CreateOrderModel'
    ];
     ...
     * Gets order
     *
     * @return \PrioTicket\DistributorAPI\Models\CreateOrderModel
     */
     ...
     * Sets order
     *
     * @param \PrioTicket\DistributorAPI\Models\CreateOrderModel $order order
     *
     * @return self
     */
