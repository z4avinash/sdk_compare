...
/**
 * CreatePaymentResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'payment' => '\PrioTicket\DistributorAPI\Models\MakePaymentResponse'
    ];
     ...
     * Gets payment
     *
     * @return \PrioTicket\DistributorAPI\Models\MakePaymentResponse
     */
     ...
     * Sets payment
     *
     * @param \PrioTicket\DistributorAPI\Models\MakePaymentResponse $payment payment
     *
     * @return self
     */
