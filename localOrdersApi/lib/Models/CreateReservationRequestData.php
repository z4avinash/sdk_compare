...
/**
 * CreateReservationRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateReservationRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateReservationRequestData';
    ...
    protected static $openAPITypes = [
        ...
        'reservation' => '\PrioTicket\DistributorAPI\Models\ReservationModel'
    ];
     ...
     * Gets reservation
     *
     * @return \PrioTicket\DistributorAPI\Models\ReservationModel
     */
     ...
     * Sets reservation
     *
     * @param \PrioTicket\DistributorAPI\Models\ReservationModel $reservation reservation
     *
     * @return self
     */
