...
class CreateWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\CreateWebhookRequestData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\CreateWebhookRequestData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\CreateWebhookRequestData $data data
     *
     * @return self
     */
