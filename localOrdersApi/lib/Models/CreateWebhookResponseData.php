...
/**
 * CreateWebhookResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateWebhookResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWebhookResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'webhook' => '\PrioTicket\DistributorAPI\Models\Webhook'
    ];
     ...
     * Sets webhook
     *
     * @param \PrioTicket\DistributorAPI\Models\Webhook $webhook webhook
     *
     * @return self
     */
