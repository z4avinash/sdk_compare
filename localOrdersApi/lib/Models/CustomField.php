 ...
 *
 * @category Class
 * @description Custom Fields allow you to store and list any arbitrary value in the system.  This metadata are data elements that you create yourself. When you add metadata to your request, they are echoed in the response so that you can connect the transaction to your metadata. For example, to add a shift number and an employee ID to a transaction. You are free to create metadata fields, even encoded, as long as the datatype is a string.
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class CustomField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'custom_field_type' => '\PrioTicket\DistributorAPI\Models\CustomFieldType'
    ];
    ...
    protected static $setters = [
        ...
        'custom_field_value' => 'setCustomFieldValue',
    ...
    protected static $getters = [
        ...
        'custom_field_value' => 'getCustomFieldValue',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['custom_field_value'] = $data['custom_field_value'] ?? null;
        $this->container['custom_field_type'] = $data['custom_field_type'] ?? null;
    }
     ...
     *
     * @param string|null $custom_field_name Unique Name / Identifier for this field.
     *
     * @return self
     */
    ...
    /**
     * Gets custom_field_value
     *
     * @return string|null
     */
    public function getCustomFieldValue()
    {
        return $this->container['custom_field_value'];
    }

    /**
     * Sets custom_field_value
     *
     * @param string|null $custom_field_value Freeform value of this field.
     *
     * @return self
     */
    public function setCustomFieldValue($custom_field_value)
    {
        $this->container['custom_field_value'] = $custom_field_value;
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\CustomFieldType|null
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\CustomFieldType|null $custom_field_type custom_field_type
     *
     * @return self
     */
