...
/**
 * DistributorProductTaxesResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributorProductTaxesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorProductTaxesResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\DistributorProductTaxesResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\DistributorProductTaxesResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\DistributorProductTaxesResponseData $data data
     *
     * @return self
     */
