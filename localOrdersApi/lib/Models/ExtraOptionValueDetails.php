...
/**
 * ExtraOptionValueDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ExtraOptionValueDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtraOptionValueDetails';
    ...
    protected static $openAPITypes = [
        ...
        'value_name' => 'string',
        'value_price' => 'string',
        'value_price_tax_id' => 'string',
        'value_price_tax_amount' => 'string',
        'value_product_type_id' => 'string',
        'value_icon' => 'string',
        'value_quantity_type' => 'string',
        'value_quantity_min' => 'int',
        'value_quantity_max' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'value_name' => null,
        'value_price' => null,
        'value_price_tax_id' => null,
        'value_price_tax_amount' => null,
        'value_product_type_id' => null,
        'value_icon' => 'uri',
        'value_quantity_type' => null,
        'value_quantity_min' => null,
        'value_quantity_max' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'value_price_tax_id' => 'value_price_tax_id',
        'value_price_tax_amount' => 'value_price_tax_amount',
        'value_product_type_id' => 'value_product_type_id',
        'value_icon' => 'value_icon',
        'value_quantity_type' => 'value_quantity_type',
        'value_quantity_min' => 'value_quantity_min',
        'value_quantity_max' => 'value_quantity_max'
    ];
    ...
    protected static $setters = [
        ...
        'value_price' => 'setValuePrice',
        'value_price_tax_id' => 'setValuePriceTaxId',
        'value_price_tax_amount' => 'setValuePriceTaxAmount',
        'value_product_type_id' => 'setValueProductTypeId',
        'value_icon' => 'setValueIcon',
        'value_quantity_type' => 'setValueQuantityType',
        'value_quantity_min' => 'setValueQuantityMin',
        'value_quantity_max' => 'setValueQuantityMax'
    ];
    ...
    protected static $getters = [
        ...
        'value_price' => 'getValuePrice',
        'value_price_tax_id' => 'getValuePriceTaxId',
        'value_price_tax_amount' => 'getValuePriceTaxAmount',
        'value_product_type_id' => 'getValueProductTypeId',
        'value_icon' => 'getValueIcon',
        'value_quantity_type' => 'getValueQuantityType',
        'value_quantity_min' => 'getValueQuantityMin',
        'value_quantity_max' => 'getValueQuantityMax'
    ];
    ...
    const VALUE_QUANTITY_TYPE_BOOKING = 'BOOKING';
    const VALUE_QUANTITY_TYPE_PIECES = 'PIECES';
     ...
     * @return string[]
     */
    public function getValueQuantityTypeAllowableValues()
    {
        return [
            self::VALUE_QUANTITY_TYPE_BOOKING,
            self::VALUE_QUANTITY_TYPE_PIECES,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['value_name'] = $data['value_name'] ?? null;
        $this->container['value_price'] = $data['value_price'] ?? null;
        $this->container['value_price_tax_id'] = $data['value_price_tax_id'] ?? null;
        $this->container['value_price_tax_amount'] = $data['value_price_tax_amount'] ?? null;
        $this->container['value_product_type_id'] = $data['value_product_type_id'] ?? null;
        $this->container['value_icon'] = $data['value_icon'] ?? null;
        $this->container['value_quantity_type'] = $data['value_quantity_type'] ?? null;
        $this->container['value_quantity_min'] = $data['value_quantity_min'] ?? null;
        $this->container['value_quantity_max'] = $data['value_quantity_max'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getValueQuantityTypeAllowableValues();
        if (!is_null($this->container['value_quantity_type']) && !in_array($this->container['value_quantity_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'value_quantity_type', must be one of '%s'",
                $this->container['value_quantity_type'],
     ...
     * Sets value_name
     *
     * @param string|null $value_name (Translatable) Value name.
     *
     * @return self
     */
    ...
    {
        return $this->container['value_price'];
    }

    /**
     * Sets value_price
     *
     * @param string|null $value_price The price of this value. In case `option_price_type:PRODUCT_TYPE` then this field will be undefined on `product_options` level.
     *
     * @return self
     */
    public function setValuePrice($value_price)
    {
        $this->container['value_price'] = $value_price;

        return $this;
    }

    /**
     * Gets value_price_tax_id
     *
     * @return string|null
     */
    public function getValuePriceTaxId()
    {
        return $this->container['value_price_tax_id'];
    }

    /**
     * Sets value_price_tax_id
     *
     * @param string|null $value_price_tax_id Tax ID for this product option value. Tax information can be retrieved from the Tax API.
     *
     * @return self
     */
    public function setValuePriceTaxId($value_price_tax_id)
    {
        $this->container['value_price_tax_id'] = $value_price_tax_id;

        return $this;
    }

    /**
     * Gets value_price_tax_amount
     *
     * @return string|null
     */
    public function getValuePriceTaxAmount()
    {
        return $this->container['value_price_tax_amount'];
    }

    /**
     * Sets value_price_tax_amount
     *
     * @param string|null $value_price_tax_amount Amount of tax applied for this product option value. Additional tax information can be retrieved from the Tax API.
     *
     * @return self
     */
    public function setValuePriceTaxAmount($value_price_tax_amount)
    {
        $this->container['value_price_tax_amount'] = $value_price_tax_amount;

        return $this;
    }

    /**
     * Gets value_product_type_id
     *
     * @return string|null
     */
    public function getValueProductTypeId()
    {
        return $this->container['value_product_type_id'];
    }

    /**
     * Sets value_product_type_id
     *
     * @param string|null $value_product_type_id Returned in case this value / option is only applicable to a specific product type (`option_price_type:PRODUCT_TYPE`).
     *
     * @return self
     */
    public function setValueProductTypeId($value_product_type_id)
    {
        $this->container['value_product_type_id'] = $value_product_type_id;
    ...
    {
        return $this->container['value_icon'];
    }

    /**
     * Sets value_icon
     *
     * @param string|null $value_icon value_icon
     *
     * @return self
     */
    public function setValueIcon($value_icon)
    {
        $this->container['value_icon'] = $value_icon;

        return $this;
    }

    /**
     * Gets value_quantity_type
     *
     * @return string|null
     */
    public function getValueQuantityType()
    {
        return $this->container['value_quantity_type'];
    }

    /**
     * Sets value_quantity_type
     *
     * @param string|null $value_quantity_type Whether the quantity limitations apply on the booking or is based on the `product_type_count`.
     *
     * @return self
     */
    public function setValueQuantityType($value_quantity_type)
    {
        $allowedValues = $this->getValueQuantityTypeAllowableValues();
        if (!is_null($value_quantity_type) && !in_array($value_quantity_type, $allowedValues, true)) {
        ...
        $this->container['value_quantity_type'] = $value_quantity_type;

        return $this;
    }

    /**
     * Gets value_quantity_min
     *
     * @return int|null
     */
    public function getValueQuantityMin()
    {
        return $this->container['value_quantity_min'];
    }

    /**
     * Sets value_quantity_min
     *
     * @param int|null $value_quantity_min Minimum quantity required for this value.
     *
     * @return self
     */
    public function setValueQuantityMin($value_quantity_min)
    {
        $this->container['value_quantity_min'] = $value_quantity_min;

        return $this;
    }

    /**
     * Gets value_quantity_max
     *
     * @return int|null
     */
    public function getValueQuantityMax()
    {
        return $this->container['value_quantity_max'];
    }

    /**
     * Sets value_quantity_max
     *
     * @param int|null $value_quantity_max Maximum quantity allowed for this value, can never exceed `option_quantity_max'.
     *
     * @return self
     */
    public function setValueQuantityMax($value_quantity_max)
    {
        $this->container['value_quantity_max'] = $value_quantity_max;
