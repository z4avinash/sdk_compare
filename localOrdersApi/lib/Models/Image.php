...
class Image implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'image_from_date' => '\DateTime',
        'image_till_date' => '\DateTime',
        'image_type' => 'string',
        'image_format' => 'string',
        'image_size' => 'string',
        'image_url' => 'string'
    ...
    protected static $openAPIFormats = [
        ...
        'image_from_date' => 'date-time',
        'image_till_date' => 'date-time',
        'image_type' => null,
        'image_format' => null,
        'image_size' => null,
        'image_url' => 'uri'
    ...
    protected static $attributeMap = [
        ...
        'image_from_date' => 'image_from_date',
        'image_till_date' => 'image_till_date',
    ...
    protected static $setters = [
        ...
        'image_from_date' => 'setImageFromDate',
        'image_till_date' => 'setImageTillDate',
    ...
    protected static $getters = [
        ...
        'image_from_date' => 'getImageFromDate',
        'image_till_date' => 'getImageTillDate',
    ...
    {
        return [
            self::IMAGE_TYPE_BANNER,
            self::IMAGE_TYPE_MAIN,
            self::IMAGE_TYPE_DETAIL,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['image_title'] = $data['image_title'] ?? null;
        $this->container['image_description'] = $data['image_description'] ?? null;
        $this->container['image_from_date'] = $data['image_from_date'] ?? null;
        $this->container['image_till_date'] = $data['image_till_date'] ?? null;
        $this->container['image_type'] = $data['image_type'] ?? null;
        $this->container['image_format'] = $data['image_format'] ?? null;
        $this->container['image_size'] = $data['image_size'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['image_title'] === null) {
            $invalidProperties[] = "'image_title' can't be null";
        }
        ...
        if (!is_null($this->container['image_size']) && !in_array($this->container['image_size'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'image_size', must be one of '%s'",
                $this->container['image_size'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets image_id
     *
     * @param string $image_id The unique Image ID. This ID can be used for caching purposes. If an Image is updated a new ID will be assigned.
     *
     * @return self
     */
    ...
    /**
     * Gets image_from_date
     *
     * @return \DateTime|null
     */
    public function getImageFromDate()
    {
        return $this->container['image_from_date'];
    }

    /**
     * Sets image_from_date
     *
     * @param \DateTime|null $image_from_date Event / Promotion starting date.
     *
     * @return self
     */
    public function setImageFromDate($image_from_date)
    {
        $this->container['image_from_date'] = $image_from_date;

        return $this;
    }

    /**
     * Gets image_till_date
     *
     * @return \DateTime|null
     */
    public function getImageTillDate()
    {
        return $this->container['image_till_date'];
    }

    /**
     * Sets image_till_date
     *
     * @param \DateTime|null $image_till_date Event / Promotion end date.
     *
     * @return self
     */
    public function setImageTillDate($image_till_date)
    {
        $this->container['image_till_date'] = $image_till_date;
     ...
     * Sets image_type
     *
     * @param string $image_type Product image type.
     *
     * @return self
     */
     ...
     * Sets image_format
     *
     * @param string|null $image_format Image format.
     *
     * @return self
     */
