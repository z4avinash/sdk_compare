...
/**
 * MakePaymentResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class MakePaymentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MakePaymentResponse';
    ...
    protected static $openAPITypes = [
        ...
        'payment_action' => 'object',
        'payment_refusal_reason' => 'string',
        'payment_details' => '\PrioTicket\DistributorAPI\Models\PaymentDetails',
        'payment_link' => 'string',
    ...
    protected static $setters = [
        ...
        'payment_refusal_reason' => 'setPaymentRefusalReason',
    ...
    protected static $getters = [
        ...
        'payment_refusal_reason' => 'getPaymentRefusalReason',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_result_code'] = $data['payment_result_code'] ?? null;
        $this->container['payment_action'] = $data['payment_action'] ?? null;
        $this->container['payment_refusal_reason'] = $data['payment_refusal_reason'] ?? null;
        $this->container['payment_details'] = $data['payment_details'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_result_code'] === null) {
            $invalidProperties[] = "'payment_result_code' can't be null";
        }
     ...
     *
     * @param string $payment_result_code Provides information about the result of the request (Adyen Specific Field).
     *
     * @return self
     */
     ...
     * Sets payment_action
     *
     * @param object|null $payment_action If you receive this object, this indicates that you need to perform an additional action again.  (Adyen Specific Field)
     *
     * @return self
     */
    ...
    /**
     * Gets payment_refusal_reason
     *
     * @return string|null
     */
    public function getPaymentRefusalReason()
    {
        return $this->container['payment_refusal_reason'];
    }

    /**
     * Sets payment_refusal_reason
     *
     * @param string|null $payment_refusal_reason Indicating the cause of the error.  (Adyen Specific Field)
     *
     * @return self
     */
    public function setPaymentRefusalReason($payment_refusal_reason)
    {
        $this->container['payment_refusal_reason'] = $payment_refusal_reason;
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentDetails $payment_details payment_details
     *
     * @return self
     */
     ...
     * Sets payment_link
     *
     * @param string $payment_link Hosted Payment Page Link.
     *
     * @return self
     */
     ...
     *
     * @param string $payment_service_provider_reference Unique payment reference set by the payment service provider.
     *
     * @return self
     */
