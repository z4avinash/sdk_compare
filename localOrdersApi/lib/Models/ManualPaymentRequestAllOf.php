...
/**
 * ManualPaymentRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ManualPaymentRequestAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManualPaymentRequest_allOf';
     ...
     * Gets payment_method
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentMethod|null
     */
     ...
     * Sets payment_method
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentMethod|null $payment_method payment_method
     *
     * @return self
     */
