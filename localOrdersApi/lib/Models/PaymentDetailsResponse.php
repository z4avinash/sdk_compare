...
class PaymentDetailsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\PaymentDetailsResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentDetailsResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentDetailsResponseData $data data
     *
     * @return self
     */
