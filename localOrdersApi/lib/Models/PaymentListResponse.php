...
class PaymentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\PaymentListResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentListResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentListResponseData $data data
     *
     * @return self
     */
