...
/**
 * ProductTaxDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductTaxDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductTaxDetail';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tax_region'] = $data['tax_region'] ?? null;
    }
     ...
     * Sets tax_id
     *
     * @param string $tax_id Unique identifier of this tax configuration.
     *
     * @return self
     */
     ...
     * Sets tax_name
     *
     * @param string $tax_name Name of the tax.
     *
     * @return self
     */
     ...
     * Sets tax_type
     *
     * @param string $tax_type Tax abbreviation.
     *
     * @return self
     */
     ...
     * Sets tax_region
     *
     * @param string|null $tax_region Country or State of the related tax authority.
     *
     * @return self
     */
