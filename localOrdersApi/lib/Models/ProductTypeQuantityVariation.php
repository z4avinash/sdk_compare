...
/**
 * ProductTypeQuantityVariation Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductTypeQuantityVariation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductTypeQuantityVariation';
    ...
    protected static $openAPITypes = [
        'product_type_quantity_variation_min' => 'int',
        'product_type_quantity_variation_max' => 'int',
        'product_type_quantity_variation_amount' => 'string',
        'product_type_quantity_variation_price_type' => '\PrioTicket\DistributorAPI\Models\PriceVariationPriceType'
    ];
    ...
    protected static $openAPIFormats = [
        'product_type_quantity_variation_min' => null,
        'product_type_quantity_variation_max' => null,
        'product_type_quantity_variation_amount' => null,
        'product_type_quantity_variation_price_type' => null
    ];
    ...
    protected static $attributeMap = [
        'product_type_quantity_variation_min' => 'product_type_quantity_variation_min',
        'product_type_quantity_variation_max' => 'product_type_quantity_variation_max',
        'product_type_quantity_variation_amount' => 'product_type_quantity_variation_amount',
        'product_type_quantity_variation_price_type' => 'product_type_quantity_variation_price_type'
    ];
    ...
    protected static $setters = [
        'product_type_quantity_variation_min' => 'setProductTypeQuantityVariationMin',
        'product_type_quantity_variation_max' => 'setProductTypeQuantityVariationMax',
        'product_type_quantity_variation_amount' => 'setProductTypeQuantityVariationAmount',
        'product_type_quantity_variation_price_type' => 'setProductTypeQuantityVariationPriceType'
    ];
    ...
    protected static $getters = [
        'product_type_quantity_variation_min' => 'getProductTypeQuantityVariationMin',
        'product_type_quantity_variation_max' => 'getProductTypeQuantityVariationMax',
        'product_type_quantity_variation_amount' => 'getProductTypeQuantityVariationAmount',
        'product_type_quantity_variation_price_type' => 'getProductTypeQuantityVariationPriceType'
    ];
    ...
    {
        $this->container['product_type_quantity_variation_min'] = $data['product_type_quantity_variation_min'] ?? null;
        $this->container['product_type_quantity_variation_max'] = $data['product_type_quantity_variation_max'] ?? null;
        $this->container['product_type_quantity_variation_amount'] = $data['product_type_quantity_variation_amount'] ?? null;
        $this->container['product_type_quantity_variation_price_type'] = $data['product_type_quantity_variation_price_type'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_type_quantity_variation_min'] === null) {
            $invalidProperties[] = "'product_type_quantity_variation_min' can't be null";
        }
        if (($this->container['product_type_quantity_variation_min'] < 1)) {
            $invalidProperties[] = "invalid value for 'product_type_quantity_variation_min', must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['product_type_quantity_variation_max']) && ($this->container['product_type_quantity_variation_max'] < 1)) {
            $invalidProperties[] = "invalid value for 'product_type_quantity_variation_max', must be bigger than or equal to 1.";
        }

        if ($this->container['product_type_quantity_variation_amount'] === null) {
            $invalidProperties[] = "'product_type_quantity_variation_amount' can't be null";
        }
        if ($this->container['product_type_quantity_variation_price_type'] === null) {
            $invalidProperties[] = "'product_type_quantity_variation_price_type' can't be null";
        }
    ...
    /**
     * Gets product_type_quantity_variation_min
     *
     * @return int
     */
    public function getProductTypeQuantityVariationMin()
    {
        return $this->container['product_type_quantity_variation_min'];
    }

    /**
     * Sets product_type_quantity_variation_min
     *
     * @param int $product_type_quantity_variation_min If `product_quantity_pricing:true`; The minimum booking quantity of this type required for this pricing configuration. This value has `product_type_quantity_min` as an absolute minimum.
     *
     * @return self
     */
    public function setProductTypeQuantityVariationMin($product_type_quantity_variation_min)
    {

        if (($product_type_quantity_variation_min < 1)) {
            throw new \InvalidArgumentException('invalid value for $product_type_quantity_variation_min when calling ProductTypeQuantityVariation., must be bigger than or equal to 1.');
        }

        $this->container['product_type_quantity_variation_min'] = $product_type_quantity_variation_min;

        return $this;
    }

    /**
     * Gets product_type_quantity_variation_max
     *
     * @return int|null
     */
    public function getProductTypeQuantityVariationMax()
    {
        return $this->container['product_type_quantity_variation_max'];
    }

    /**
     * Sets product_type_quantity_variation_max
     *
     * @param int|null $product_type_quantity_variation_max If `product_quantity_pricing:true`; The maximum booking quantity allowed for this pricing configuration. This value will never exceed `product_type_quantity_max`.
     *
     * @return self
     */
    public function setProductTypeQuantityVariationMax($product_type_quantity_variation_max)
    {

        if (!is_null($product_type_quantity_variation_max) && ($product_type_quantity_variation_max < 1)) {
            throw new \InvalidArgumentException('invalid value for $product_type_quantity_variation_max when calling ProductTypeQuantityVariation., must be bigger than or equal to 1.');
        }

        $this->container['product_type_quantity_variation_max'] = $product_type_quantity_variation_max;

        return $this;
    }

    /**
     * Gets product_type_quantity_variation_amount
     *
     * @return string
     */
    public function getProductTypeQuantityVariationAmount()
    {
        return $this->container['product_type_quantity_variation_amount'];
    }

    /**
     * Sets product_type_quantity_variation_amount
     *
     * @param string $product_type_quantity_variation_amount Quantity related price change (per piece) applicable to the product type sales price.
     *
     * @return self
     */
    public function setProductTypeQuantityVariationAmount($product_type_quantity_variation_amount)
    {
        $this->container['product_type_quantity_variation_amount'] = $product_type_quantity_variation_amount;

        return $this;
    }

    /**
     * Gets product_type_quantity_variation_price_type
     *
     * @return \PrioTicket\DistributorAPI\Models\PriceVariationPriceType
     */
    public function getProductTypeQuantityVariationPriceType()
    {
        return $this->container['product_type_quantity_variation_price_type'];
    }

    /**
     * Sets product_type_quantity_variation_price_type
     *
     * @param \PrioTicket\DistributorAPI\Models\PriceVariationPriceType $product_type_quantity_variation_price_type product_type_quantity_variation_price_type
     *
     * @return self
     */
    public function setProductTypeQuantityVariationPriceType($product_type_quantity_variation_price_type)
    {
        $this->container['product_type_quantity_variation_price_type'] = $product_type_quantity_variation_price_type;
