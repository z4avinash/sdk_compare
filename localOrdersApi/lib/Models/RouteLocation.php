...
class RouteLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool $route_location_active Whether this location is active.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $route_location_stopover A boolean which indicates that the waypoint is a stop on the route, which has the effect of showing it as a destination.
     *
     * @return self
     */
