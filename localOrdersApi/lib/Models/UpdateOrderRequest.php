...
class UpdateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\UpdateOrderRequestData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\UpdateOrderRequestData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\UpdateOrderRequestData $data data
     *
     * @return self
     */
