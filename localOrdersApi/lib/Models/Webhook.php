 ...
 *
 * @category Class
 * @description Details regarding a webhook.   Either a &#x60;webhook_url&#x60; or &#x60;webhook_email&#x60; is required.
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'webhook_events' => '\PrioTicket\DistributorAPI\Models\NotificationEvent[]',
        'webhook_url' => 'string',
        'webhook_email' => 'string',
        'webhook_payload' => 'bool',
        'webhook_auth' => 'string',
        'webhook_created' => '\DateTime',
        'webhook_created_name' => 'string',
        'webhook_created_email' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'webhook_auth' => null,
        'webhook_created' => 'date-time',
        'webhook_created_name' => null,
        'webhook_created_email' => 'email'
    ];
    ...
    protected static $attributeMap = [
        ...
        'webhook_created_name' => 'webhook_created_name',
        'webhook_created_email' => 'webhook_created_email'
    ];
    ...
    protected static $setters = [
        ...
        'webhook_email' => 'setWebhookEmail',
        'webhook_payload' => 'setWebhookPayload',
        'webhook_auth' => 'setWebhookAuth',
        'webhook_created' => 'setWebhookCreated',
        'webhook_created_name' => 'setWebhookCreatedName',
        'webhook_created_email' => 'setWebhookCreatedEmail'
    ];
    ...
    protected static $getters = [
        ...
        'webhook_email' => 'getWebhookEmail',
        'webhook_payload' => 'getWebhookPayload',
        'webhook_auth' => 'getWebhookAuth',
        'webhook_created' => 'getWebhookCreated',
        'webhook_created_name' => 'getWebhookCreatedName',
        'webhook_created_email' => 'getWebhookCreatedEmail'
    ];
    ...
    const WEBHOOK_STATUS_DISABLED = 'DISABLED';
     ...
     * @return string[]
     */
    public function getWebhookStatusAllowableValues()
    {
        return [
            self::WEBHOOK_STATUS_ENABLED,
            self::WEBHOOK_STATUS_DISABLED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['webhook_status'] = $data['webhook_status'] ?? null;
        $this->container['webhook_version'] = $data['webhook_version'] ?? null;
        $this->container['webhook_events'] = $data['webhook_events'] ?? null;
        $this->container['webhook_url'] = $data['webhook_url'] ?? null;
        $this->container['webhook_email'] = $data['webhook_email'] ?? null;
        $this->container['webhook_payload'] = $data['webhook_payload'] ?? true;
        $this->container['webhook_auth'] = $data['webhook_auth'] ?? null;
        $this->container['webhook_created'] = $data['webhook_created'] ?? null;
        $this->container['webhook_created_name'] = $data['webhook_created_name'] ?? null;
        $this->container['webhook_created_email'] = $data['webhook_created_email'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getWebhookStatusAllowableValues();
        if (!is_null($this->container['webhook_status']) && !in_array($this->container['webhook_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'webhook_status', must be one of '%s'",
                $this->container['webhook_status'],
                implode("', '", $allowedValues)
            );
        }

        if ($this->container['webhook_events'] === null) {
            $invalidProperties[] = "'webhook_events' can't be null";
        }
        if ($this->container['webhook_created'] === null) {
            $invalidProperties[] = "'webhook_created' can't be null";
        }
        if ($this->container['webhook_created_name'] === null) {
            $invalidProperties[] = "'webhook_created_name' can't be null";
        }
        if ($this->container['webhook_created_email'] === null) {
            $invalidProperties[] = "'webhook_created_email' can't be null";
        }
     ...
     * Sets webhook_id
     *
     * @param string $webhook_id Unique webhook ID.
     *
     * @return self
     */
     ...
     * Sets webhook_status
     *
     * @param string $webhook_status Status of this webhook.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getWebhookStatusAllowableValues();
        if (!in_array($webhook_status, $allowedValues, true)) {
     ...
     *
     * @param string|null $webhook_version Represents the version of the service API that's served in the response.
     *
     * @return self
     */
     ...
     * Gets webhook_events
     *
     * @return \PrioTicket\DistributorAPI\Models\NotificationEvent[]
     */
     ...
     * Sets webhook_events
     *
     * @param \PrioTicket\DistributorAPI\Models\NotificationEvent[] $webhook_events Events this webhook subscribes to.
     *
     * @return self
     */
     ...
     * Sets webhook_url
     *
     * @param string|null $webhook_url Webhook URL to sent notifications.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getWebhookEmail()
    {
        return $this->container['webhook_email'];
    }

    /**
     * Sets webhook_email
     *
     * @param string|null $webhook_email Webhook Email to sent notifications.
     *
     * @return self
     */
    public function setWebhookEmail($webhook_email)
    {
        $this->container['webhook_email'] = $webhook_email;

        return $this;
    }

    /**
     * Gets webhook_payload
     *
     * @return bool|null
     */
    public function getWebhookPayload()
    {
        return $this->container['webhook_payload'];
    }

    /**
     * Sets webhook_payload
     *
     * @param bool|null $webhook_payload Whether the notification should contain the payload of the changed data.
     *
     * @return self
     */
    public function setWebhookPayload($webhook_payload)
    {
        $this->container['webhook_payload'] = $webhook_payload;
    ...
    {
        return $this->container['webhook_auth'];
    }

    /**
     * Sets webhook_auth
     *
     * @param string|null $webhook_auth Optional Basic access authentication value that will be passed as `Authorization: Basic <Webhook Auth Value>` header on each callback.
     *
     * @return self
     */
    public function setWebhookAuth($webhook_auth)
    {
        $this->container['webhook_auth'] = $webhook_auth;

        return $this;
    }

    /**
     * Gets webhook_created
     *
     * @return \DateTime
     */
    public function getWebhookCreated()
    {
        return $this->container['webhook_created'];
    }

    /**
     * Sets webhook_created
     *
     * @param \DateTime $webhook_created Date of creation.
     *
     * @return self
     */
    public function setWebhookCreated($webhook_created)
    {
        $this->container['webhook_created'] = $webhook_created;

        return $this;
    }

    /**
     * Gets webhook_created_name
     *
     * @return string
     */
    public function getWebhookCreatedName()
    {
        return $this->container['webhook_created_name'];
    }

    /**
     * Sets webhook_created_name
     *
     * @param string $webhook_created_name Cashier name / User name who created the webhook.
     *
     * @return self
     */
    public function setWebhookCreatedName($webhook_created_name)
    {
        $this->container['webhook_created_name'] = $webhook_created_name;

        return $this;
    }

    /**
     * Gets webhook_created_email
     *
     * @return string
     */
    public function getWebhookCreatedEmail()
    {
        return $this->container['webhook_created_email'];
    }

    /**
     * Sets webhook_created_email
     *
     * @param string $webhook_created_email Cashier email / User email who created the webhook.
     *
     * @return self
     */
    public function setWebhookCreatedEmail($webhook_created_email)
    {
        $this->container['webhook_created_email'] = $webhook_created_email;
