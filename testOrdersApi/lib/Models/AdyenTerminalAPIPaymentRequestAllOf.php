<?php
/**
 * AdyenTerminalAPIPaymentRequestAllOf
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * AdyenTerminalAPIPaymentRequestAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class AdyenTerminalAPIPaymentRequestAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdyenTerminalAPIPaymentRequest_allOf';
     ...
     *
     * @param string|null $payment_terminal_id Unique ID of the selected payment terminal.
     *
     * @return self
     * @deprecated
     */
