...
/**
 * AvailabilitiesListResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AvailabilitiesListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailabilitiesListResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\AvailabilitiesListResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\AvailabilitiesListResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\AvailabilitiesListResponseData $data data
     *
     * @return self
     */
