...
/**
 * AvailabilitySpots Class Doc Comment
 *
 * @category Class
 * @description Information over the spots that the merchant has set for this configuration. &gt; Only applicable for managed (limited) capacity &#x60;product_capacity:true&#x60;.  &gt; In case of 3rd party aggregated data, not all fields will be available.
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AvailabilitySpots implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailabilitySpots';
    ...
    protected static $openAPITypes = [
        'availability_spots_total' => 'int',
        'availability_spots_reserved' => 'int',
        'availability_spots_booked' => 'int',
        'availability_spots_open' => 'int',
        'availability_spots_redeemed' => 'int',
        'availability_spots_details' => '\PrioTicket\DistributorAPI\Models\Spot[]'
    ];
    ...
    protected static $openAPIFormats = [
        'availability_spots_total' => null,
        'availability_spots_reserved' => null,
        'availability_spots_booked' => null,
        'availability_spots_open' => null,
        'availability_spots_redeemed' => null,
        'availability_spots_details' => null
    ];
    ...
    protected static $attributeMap = [
        'availability_spots_total' => 'availability_spots_total',
        'availability_spots_reserved' => 'availability_spots_reserved',
        'availability_spots_booked' => 'availability_spots_booked',
        'availability_spots_open' => 'availability_spots_open',
        'availability_spots_redeemed' => 'availability_spots_redeemed',
        'availability_spots_details' => 'availability_spots_details'
    ];
    ...
    protected static $setters = [
        'availability_spots_total' => 'setAvailabilitySpotsTotal',
        'availability_spots_reserved' => 'setAvailabilitySpotsReserved',
        'availability_spots_booked' => 'setAvailabilitySpotsBooked',
        'availability_spots_open' => 'setAvailabilitySpotsOpen',
        'availability_spots_redeemed' => 'setAvailabilitySpotsRedeemed',
        'availability_spots_details' => 'setAvailabilitySpotsDetails'
    ];
    ...
    protected static $getters = [
        'availability_spots_total' => 'getAvailabilitySpotsTotal',
        'availability_spots_reserved' => 'getAvailabilitySpotsReserved',
        'availability_spots_booked' => 'getAvailabilitySpotsBooked',
        'availability_spots_open' => 'getAvailabilitySpotsOpen',
        'availability_spots_redeemed' => 'getAvailabilitySpotsRedeemed',
        'availability_spots_details' => 'getAvailabilitySpotsDetails'
    ];
    ...
    {
        $this->container['availability_spots_total'] = $data['availability_spots_total'] ?? null;
        $this->container['availability_spots_reserved'] = $data['availability_spots_reserved'] ?? null;
        $this->container['availability_spots_booked'] = $data['availability_spots_booked'] ?? null;
        $this->container['availability_spots_open'] = $data['availability_spots_open'] ?? null;
        $this->container['availability_spots_redeemed'] = $data['availability_spots_redeemed'] ?? null;
        $this->container['availability_spots_details'] = $data['availability_spots_details'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['availability_spots_open'] === null) {
            $invalidProperties[] = "'availability_spots_open' can't be null";
        }
    ...
    /**
     * Gets availability_spots_total
     *
     * @return int|null
     */
    public function getAvailabilitySpotsTotal()
    {
        return $this->container['availability_spots_total'];
    }

    /**
     * Sets availability_spots_total
     *
     * @param int|null $availability_spots_total The total number of spots that the merchant has configured for this distributor (including those that are not available).
     *
     * @return self
     */
    public function setAvailabilitySpotsTotal($availability_spots_total)
    {
        $this->container['availability_spots_total'] = $availability_spots_total;

        return $this;
    }

    /**
     * Gets availability_spots_reserved
     *
     * @return int|null
     */
    public function getAvailabilitySpotsReserved()
    {
        return $this->container['availability_spots_reserved'];
    }

    /**
     * Sets availability_spots_reserved
     *
     * @param int|null $availability_spots_reserved The number of spots currently reserved / blocked for this availability entry. SOme of these might open up in the near future (e.g. abandoned checkouts). This value is already deducted from the `availability_spots_open` parameter and can be safely ignored in capacity calculations.  Formula: `availability_spots_total` - (`availability_spots_booked` + `availability_spots_reserved`) = `availability_spots_open`.
     *
     * @return self
     */
    public function setAvailabilitySpotsReserved($availability_spots_reserved)
    {
        $this->container['availability_spots_reserved'] = $availability_spots_reserved;

        return $this;
    }

    /**
     * Gets availability_spots_booked
     *
     * @return int|null
     */
    public function getAvailabilitySpotsBooked()
    {
        return $this->container['availability_spots_booked'];
    }

    /**
     * Sets availability_spots_booked
     *
     * @param int|null $availability_spots_booked The number of spots currently booked for this availability entry. These might open up in the near future (Cancellations). This value is already deducted from the `availability_spots_open` parameter and can be safely ignored in capacity calculations.  Formula: `availability_spots_total` - (`availability_spots_booked` + `availability_spots_reserved`) = `availability_spots_open`.
     *
     * @return self
     */
    public function setAvailabilitySpotsBooked($availability_spots_booked)
    {


        $this->container['availability_spots_booked'] = $availability_spots_booked;

        return $this;
    }

    /**
     * Gets availability_spots_open
     *
     * @return int
     */
    public function getAvailabilitySpotsOpen()
    {
        return $this->container['availability_spots_open'];
    }

    /**
     * Sets availability_spots_open
     *
     * @param int $availability_spots_open The number of spots currently available for this availability entry.
     *
     * @return self
     */
    public function setAvailabilitySpotsOpen($availability_spots_open)
    {


        $this->container['availability_spots_open'] = $availability_spots_open;

        return $this;
    }

    /**
     * Gets availability_spots_redeemed
     *
     * @return int|null
     * @deprecated
     */
    public function getAvailabilitySpotsRedeemed()
    {
        return $this->container['availability_spots_redeemed'];
    }

    /**
     * Sets availability_spots_redeemed
     *
     * @param int|null $availability_spots_redeemed The number of spots that are redeemed.   > Only visible to suppliers.
     *
     * @return self
     * @deprecated
     */
    public function setAvailabilitySpotsRedeemed($availability_spots_redeemed)
    {


        $this->container['availability_spots_redeemed'] = $availability_spots_redeemed;

        return $this;
    }

    /**
     * Gets availability_spots_details
     *
     * @return \PrioTicket\DistributorAPI\Models\Spot[]|null
     * @deprecated
     */
    public function getAvailabilitySpotsDetails()
    {
        return $this->container['availability_spots_details'];
    }

    /**
     * Sets availability_spots_details
     *
     * @param \PrioTicket\DistributorAPI\Models\Spot[]|null $availability_spots_details List of available spots.
     *
     * @return self
     * @deprecated
     */
    public function setAvailabilitySpotsDetails($availability_spots_details)
    {
        $this->container['availability_spots_details'] = $availability_spots_details;
