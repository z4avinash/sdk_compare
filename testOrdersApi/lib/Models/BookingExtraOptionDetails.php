...
/**
 * BookingExtraOptionDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class BookingExtraOptionDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BookingExtraOptionDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['value_count'] = $data['value_count'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['value_count'] === null) {
            $invalidProperties[] = "'value_count' can't be null";
        }
        if (($this->container['value_count'] > 100)) {
            $invalidProperties[] = "invalid value for 'value_count', must be smaller than or equal to 100.";
        }

        if (($this->container['value_count'] < 0)) {
            $invalidProperties[] = "invalid value for 'value_count', must be bigger than or equal to 0.";
        }
     ...
     * Sets value_count
     *
     * @param int $value_count Value count.
     *
     * @return self
     */
    public function setValueCount($value_count)
    {
        ...
        if (($value_count > 100)) {
            throw new \InvalidArgumentException('invalid value for $value_count when calling BookingExtraOptionDetails., must be smaller than or equal to 100.');
        }
        if (($value_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $value_count when calling BookingExtraOptionDetails., must be bigger than or equal to 0.');
        }
