...
/**
 * ConfirmReservation Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfirmReservation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfirmReservation';
    ...
    {
        $this->container['booking_option_type'] = $data['booking_option_type'] ?? null;
