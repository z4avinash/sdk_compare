...
/**
 * ConfirmedBookingAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class ConfirmedBookingAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfirmedBooking_allOf';
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\ConfirmedBookingDetail[]|null
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\ConfirmedBookingDetail[]|null $product_type_details A list of details on the confirmed booked product types.
     *
     * @return self
     */
    ...
    public function setBookingReference($booking_reference)
    {
        ...
        if ((mb_strlen($booking_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $booking_reference when calling ConfirmedBookingAllOf., must be bigger than or equal to 8.');
        }
