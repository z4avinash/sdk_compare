...
/**
 * ConfirmedCombiBooking Class Doc Comment
 *
 * @category Class
 ...
 */
class ConfirmedCombiBooking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConfirmedCombiBooking';
    ...
    protected static $openAPITypes = [
        ...
        'product_type_details' => '\PrioTicket\DistributorAPI\Models\BookingItemConfirmed[]',
     ...
     *
     * @param string|null $product_availability_id The unique ID for the availability slot. Only mandatory if `product_availability:true`
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $booking_travel_date If `product_availability:false` you can still define the expected redemption date of this product. Required if `product_traveldate_required:true`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $booking_external_reference A unique booking identifier within the external system.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets product_code
     *
     * @param string $product_code The product code. More details can be found on `product_code_settings`.
     *
     * @return self
     */
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\BookingItemConfirmed[]
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\BookingItemConfirmed[] $product_type_details A list of the confirmed booked combi-product types.
     *
     * @return self
     */
