...
class CreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\CreateOrderRequestData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\CreateOrderRequestData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\CreateOrderRequestData $data data
     *
     * @return self
     */
