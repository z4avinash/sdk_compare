...
/**
 * CreatePaymentRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePaymentRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePaymentRequestData';
    ...
    protected static $openAPITypes = [
        ...
        'payment' => '\PrioTicket\DistributorAPI\Models\PaymentRequestType'
    ];
     ...
     * Gets payment
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentRequestType
     */
     ...
     * Sets payment
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentRequestType $payment payment
     *
     * @return self
     */
