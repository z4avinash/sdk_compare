...
class CurrencyConversion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'currency_rates' => 'array<string,string>'
    ];
    ...
    protected static $setters = [
        ...
        'currency_date' => 'setCurrencyDate',
        'currency_rates' => 'setCurrencyRates'
    ];
    ...
    {
        $this->container['currency_base'] = $data['currency_base'] ?? null;
        $this->container['currency_date'] = $data['currency_date'] ?? null;
        $this->container['currency_rates'] = $data['currency_rates'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['currency_date'] === null) {
            $invalidProperties[] = "'currency_date' can't be null";
        }
        if ($this->container['currency_rates'] === null) {
            $invalidProperties[] = "'currency_rates' can't be null";
        }
     ...
     * Sets currency_base
     *
     * @param string|null $currency_base Currency base code, according to [ISO-4217](https://en.wikipedia.org/wiki/ISO_4217).
     *
     * @return self
     */
    ...
    {
        return $this->container['currency_date'];
    }

    /**
     * Sets currency_date
     *
     * @param \DateTime $currency_date Applicable date for these rates.
     *
     * @return self
     */
    public function setCurrencyDate($currency_date)
    {
        $this->container['currency_date'] = $currency_date;
    ...
    {
        return $this->container['currency_rates'];
    }

    /**
     * Sets currency_rates
     *
     * @param array<string,string> $currency_rates Conversion rate for each foreign currency.
     *
     * @return self
     */
    public function setCurrencyRates($currency_rates)
    {
        $this->container['currency_rates'] = $currency_rates;
