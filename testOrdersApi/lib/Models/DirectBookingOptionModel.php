...
/**
 * DirectBookingOptionModel Class Doc Comment
 *
 * @category Class
 ...
 */
class DirectBookingOptionModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DirectBookingOptionModel';
    ...
    public function setBookingVersion($booking_version)
    {
        ...
        if (!is_null($booking_version) && ($booking_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $booking_version when calling DirectBookingOptionModel., must be bigger than or equal to 1.');
        }
