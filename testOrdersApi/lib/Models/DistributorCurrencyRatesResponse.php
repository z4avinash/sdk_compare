...
/**
 * DistributorCurrencyRatesResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributorCurrencyRatesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorCurrencyRatesResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\DistributorCurrencyRatesResponseData'
    ];
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\DistributorCurrencyRatesResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\DistributorCurrencyRatesResponseData $data data
     *
     * @return self
     */
