...
/**
 * DistributorProductCategoriesResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributorProductCategoriesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorProductCategoriesResponse';
    ...
    protected static $openAPITypes = [
        'api_version' => 'string',
        'data' => '\PrioTicket\DistributorAPI\Models\DistributorProductCategoriesResponseData'
    ];
     ...
     * Sets api_version
     *
     * @param string $api_version Represents the version of the service API that's served in the response.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \PrioTicket\DistributorAPI\Models\DistributorProductCategoriesResponseData
     */
     ...
     * Sets data
     *
     * @param \PrioTicket\DistributorAPI\Models\DistributorProductCategoriesResponseData $data data
     *
     * @return self
     */
