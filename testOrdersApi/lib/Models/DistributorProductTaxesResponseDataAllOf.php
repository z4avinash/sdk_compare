<?php
/**
 * DistributorProductTaxesResponseDataAllOf
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * DistributorProductTaxesResponseDataAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class DistributorProductTaxesResponseDataAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributorProductTaxesResponseData_allOf';
