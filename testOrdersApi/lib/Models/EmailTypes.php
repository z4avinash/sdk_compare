...
/**
 * EmailTypes Class Doc Comment
 *
 * @category Class
 * @description Defines which emails will be sent by our system.   If you do not want our system to sent emails, please ignore this setting.  &gt; All emails will be sent to the &#x60;contact_type:BOOKER&#x60;
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EmailTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailTypes';
    ...
    protected static $setters = [
        'send_tickets' => 'setSendTickets',
        'send_receipt' => 'setSendReceipt',
        'send_marketing' => 'setSendMarketing',
        'send_offers' => 'setSendOffers',
    ...
    protected static $getters = [
        'send_tickets' => 'getSendTickets',
        'send_receipt' => 'getSendReceipt',
        'send_marketing' => 'getSendMarketing',
        'send_offers' => 'getSendOffers',
    ...
    {
        $this->container['send_tickets'] = $data['send_tickets'] ?? 'false';
        $this->container['send_receipt'] = $data['send_receipt'] ?? 'false';
        $this->container['send_marketing'] = $data['send_marketing'] ?? 'false';
        $this->container['send_offers'] = $data['send_offers'] ?? 'false';
        $this->container['send_notification'] = $data['send_notification'] ?? 'false';
    }
     ...
     * @return string|null
     */
    public function getSendTickets()
    {
        return $this->container['send_tickets'];
    }

    /**
     * Sets send_tickets
     *
     * @param string|null $send_tickets Send all vouchers to the specified email recipients.
     *
     * @return self
     */
    public function setSendTickets($send_tickets)
    {
        $this->container['send_tickets'] = $send_tickets;
     ...
     * Sets send_receipt
     *
     * @param string|null $send_receipt Send the receipt to the specified email recipients.
     *
     * @return self
     * @deprecated
     */
     ...
     * @deprecated
     */
    public function getSendMarketing()
    {
        return $this->container['send_marketing'];
    }

    /**
     * Sets send_marketing
     *
     * @param string|null $send_marketing Send marketing to the specified email recipients.
     *
     * @return self
     * @deprecated
     */
    public function setSendMarketing($send_marketing)
    {
        $this->container['send_marketing'] = $send_marketing;
     ...
     * @deprecated
     */
    public function getSendOffers()
    {
        return $this->container['send_offers'];
    }

    /**
     * Sets send_offers
     *
     * @param string|null $send_offers Send offers to the specified email recipients.
     *
     * @return self
     * @deprecated
     */
    public function setSendOffers($send_offers)
    {
        $this->container['send_offers'] = $send_offers;
     ...
     *
     * @param string|null $send_notification Send notifications to the specified email recipients.
     *
     * @return self
     * @deprecated
     */
