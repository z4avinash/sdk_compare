...
/**
 * GuideLanguage Class Doc Comment
 *
 * @category Class
 * @description Language code of the available guide.  Language is defined in [ISO-639-1](https://en.wikipedia.org/wiki/ISO_639-1) format.
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GuideLanguage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GuideLanguage';
    ...
    const LANGUAGE_TYPE_LIVE = 'GUIDE_LIVE';
    const LANGUAGE_TYPE_AUDIO = 'GUIDE_AUDIO';
    const LANGUAGE_TYPE_READING = 'GUIDE_READING';
     ...
     * @return string[]
     */
    public function getLanguageTypeAllowableValues()
    {
        return [
            self::LANGUAGE_TYPE_LIVE,
            self::LANGUAGE_TYPE_AUDIO,
            self::LANGUAGE_TYPE_READING,
        ];
    }
    ...
    {
        $this->container['language_codes'] = $data['language_codes'] ?? null;
        $this->container['language_type'] = $data['language_type'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['language_codes'] === null) {
            $invalidProperties[] = "'language_codes' can't be null";
        }
        if ($this->container['language_type'] === null) {
            $invalidProperties[] = "'language_type' can't be null";
        }
        $allowedValues = $this->getLanguageTypeAllowableValues();
        if (!is_null($this->container['language_type']) && !in_array($this->container['language_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'language_type', must be one of '%s'",
                $this->container['language_type'],
    ...
    {
        return $this->container['language_type'];
    }

    /**
     * Sets language_type
     *
     * @param string $language_type Type of language.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getLanguageTypeAllowableValues();
        if (!in_array($language_type, $allowedValues, true)) {
        ...
        $this->container['language_type'] = $language_type;
