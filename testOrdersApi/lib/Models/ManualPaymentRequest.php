...
/**
 * ManualPaymentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ManualPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManualPaymentRequest';
     ...
     *
     * @param string|null $payment_external_reference External payment reference set to identify the shopper / entity / cardholder / guest performing the payment. This reference can also be used to identify the payment in the PSP system. > Required in case of recurring payments (`payment_recurring:true`).
     *
     * @return self
     */
