...
/**
 * OpeningTimes Class Doc Comment
 *
 * @category Class
 ...
 */
class OpeningTimes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpeningTimes';
    ...
    protected static $openAPITypes = [
        'opening_time_valid_from' => '\DateTime',
        'opening_time_valid_till' => '\DateTime',
        'opening_time_details' => '\PrioTicket\DistributorAPI\Models\OpeningTimeDetail[]'
    ];
    ...
    protected static $openAPIFormats = [
        'opening_time_valid_from' => 'date',
        'opening_time_valid_till' => 'date',
        'opening_time_details' => null
    ];
    ...
    protected static $attributeMap = [
        'opening_time_valid_from' => 'opening_time_valid_from',
        'opening_time_valid_till' => 'opening_time_valid_till',
        'opening_time_details' => 'opening_time_details'
    ];
    ...
    protected static $setters = [
        'opening_time_valid_from' => 'setOpeningTimeValidFrom',
        'opening_time_valid_till' => 'setOpeningTimeValidTill',
        'opening_time_details' => 'setOpeningTimeDetails'
    ];
    ...
    protected static $getters = [
        'opening_time_valid_from' => 'getOpeningTimeValidFrom',
        'opening_time_valid_till' => 'getOpeningTimeValidTill',
        'opening_time_details' => 'getOpeningTimeDetails'
    ];
    ...
    {
        $this->container['opening_time_valid_from'] = $data['opening_time_valid_from'] ?? null;
        $this->container['opening_time_valid_till'] = $data['opening_time_valid_till'] ?? null;
        $this->container['opening_time_details'] = $data['opening_time_details'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['opening_time_details'] === null) {
            $invalidProperties[] = "'opening_time_details' can't be null";
        }
    ...
    /**
     * Gets opening_time_valid_from
     *
     * @return \DateTime|null
     */
    public function getOpeningTimeValidFrom()
    {
        return $this->container['opening_time_valid_from'];
    }

    /**
     * Sets opening_time_valid_from
     *
     * @param \DateTime|null $opening_time_valid_from Opening time valid from.
     *
     * @return self
     */
    public function setOpeningTimeValidFrom($opening_time_valid_from)
    {
        $this->container['opening_time_valid_from'] = $opening_time_valid_from;

        return $this;
    }

    /**
     * Gets opening_time_valid_till
     *
     * @return \DateTime|null
     */
    public function getOpeningTimeValidTill()
    {
        return $this->container['opening_time_valid_till'];
    }

    /**
     * Sets opening_time_valid_till
     *
     * @param \DateTime|null $opening_time_valid_till Opening time valid till.
     *
     * @return self
     */
    public function setOpeningTimeValidTill($opening_time_valid_till)
    {
        $this->container['opening_time_valid_till'] = $opening_time_valid_till;

        return $this;
    }

    /**
     * Gets opening_time_details
     *
     * @return \PrioTicket\DistributorAPI\Models\OpeningTimeDetail[]
     */
    public function getOpeningTimeDetails()
    {
        return $this->container['opening_time_details'];
    }

    /**
     * Sets opening_time_details
     *
     * @param \PrioTicket\DistributorAPI\Models\OpeningTimeDetail[] $opening_time_details Opening Time Details, based on the days of the week. If unset, the product / venue can be deemed unavailable / closed.
     *
     * @return self
     */
    public function setOpeningTimeDetails($opening_time_details)
    {
        $this->container['opening_time_details'] = $opening_time_details;
