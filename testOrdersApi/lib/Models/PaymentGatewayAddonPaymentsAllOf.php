<?php
/**
 * PaymentGatewayAddonPaymentsAllOf
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * PaymentGatewayAddonPaymentsAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class PaymentGatewayAddonPaymentsAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentGatewayAddonPayments_allOf';
     ...
     *
     * @param string|null $payment_auth_code Payment auth code.
     *
     * @return self
     */
