...
{
    public const DISCRIMINATOR = 'payment_gateway_type';
    ...
    protected static $openAPITypes = [
        ...
        'payment_service_provider_original_reference' => 'string',
        'payment_gateway_type' => 'string',
        'payment_gateway_additional_values' => 'array<string,string>',
        'payment_auth_code' => 'string',
        'payment_hotel_id' => 'string',
        'payment_hotel_guest_name' => 'string',
        'payment_hotel_room_number' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'payment_service_provider_original_reference' => null,
        'payment_gateway_type' => null,
        'payment_gateway_additional_values' => null,
        'payment_auth_code' => null,
        'payment_hotel_id' => null,
        'payment_hotel_guest_name' => null,
        'payment_hotel_room_number' => null,
    ...
    protected static $attributeMap = [
        ...
        'payment_service_provider_original_reference' => 'payment_service_provider_original_reference',
        'payment_gateway_type' => 'payment_gateway_type',
        'payment_gateway_additional_values' => 'payment_gateway_additional_values',
        'payment_auth_code' => 'payment_auth_code',
        'payment_hotel_id' => 'payment_hotel_id',
        'payment_hotel_guest_name' => 'payment_hotel_guest_name',
        'payment_hotel_room_number' => 'payment_hotel_room_number',
    ...
    protected static $setters = [
        ...
        'payment_service_provider_original_reference' => 'setPaymentServiceProviderOriginalReference',
        'payment_gateway_type' => 'setPaymentGatewayType',
        'payment_gateway_additional_values' => 'setPaymentGatewayAdditionalValues',
        'payment_auth_code' => 'setPaymentAuthCode',
        'payment_hotel_id' => 'setPaymentHotelId',
        'payment_hotel_guest_name' => 'setPaymentHotelGuestName',
        'payment_hotel_room_number' => 'setPaymentHotelRoomNumber',
    ...
    protected static $getters = [
        ...
        'payment_service_provider_original_reference' => 'getPaymentServiceProviderOriginalReference',
        'payment_gateway_type' => 'getPaymentGatewayType',
        'payment_gateway_additional_values' => 'getPaymentGatewayAdditionalValues',
        'payment_auth_code' => 'getPaymentAuthCode',
        'payment_hotel_id' => 'getPaymentHotelId',
        'payment_hotel_guest_name' => 'getPaymentHotelGuestName',
        'payment_hotel_room_number' => 'getPaymentHotelRoomNumber',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_service_provider_original_reference'] = $data['payment_service_provider_original_reference'] ?? null;
        $this->container['payment_gateway_type'] = $data['payment_gateway_type'] ?? null;
        $this->container['payment_gateway_additional_values'] = $data['payment_gateway_additional_values'] ?? null;
        $this->container['payment_auth_code'] = $data['payment_auth_code'] ?? null;
        $this->container['payment_hotel_id'] = $data['payment_hotel_id'] ?? null;
        $this->container['payment_hotel_guest_name'] = $data['payment_hotel_guest_name'] ?? null;
        $this->container['payment_hotel_room_number'] = $data['payment_hotel_room_number'] ?? null;
        $this->container['payment_customer_id'] = $data['payment_customer_id'] ?? null;

        // Initialize discriminator property with the model name.
        $this->container['payment_gateway_type'] = static::$openAPIModelName;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_merchant_account_name'] === null) {
            $invalidProperties[] = "'payment_merchant_account_name' can't be null";
        }
        if ($this->container['payment_service_provider_reference'] === null) {
            $invalidProperties[] = "'payment_service_provider_reference' can't be null";
        }
        if ($this->container['payment_gateway_type'] === null) {
            $invalidProperties[] = "'payment_gateway_type' can't be null";
        }
        if ($this->container['payment_auth_code'] === null) {
            $invalidProperties[] = "'payment_auth_code' can't be null";
        }
        if ($this->container['payment_hotel_id'] === null) {
            $invalidProperties[] = "'payment_hotel_id' can't be null";
        }
        if ($this->container['payment_hotel_guest_name'] === null) {
            $invalidProperties[] = "'payment_hotel_guest_name' can't be null";
        }
        if ($this->container['payment_hotel_room_number'] === null) {
            $invalidProperties[] = "'payment_hotel_room_number' can't be null";
        }
     ...
     *
     * @param string $payment_merchant_account_name The name / identifier of the party selling goods or services to shoppers via an e-commerce website, a mobile app, on a point of sale, or across all three channels.
     *
     * @return self
     */
     ...
     *
     * @param string $payment_service_provider_reference Unique payment reference set by the payment service provider. Note that every action will result in a different reference. The original reference can be found below.
     *
     * @return self
     */
    ...
    /**
     * Gets payment_service_provider_original_reference
     *
     * @return string|null
     */
    public function getPaymentServiceProviderOriginalReference()
    {
        return $this->container['payment_service_provider_original_reference'];
    }

    /**
     * Sets payment_service_provider_original_reference
     *
     * @param string|null $payment_service_provider_original_reference The PSP reference associated with the original payment prior to the modification (refund, manual capture) request.
     *
     * @return self
     */
    public function setPaymentServiceProviderOriginalReference($payment_service_provider_original_reference)
    {
        $this->container['payment_service_provider_original_reference'] = $payment_service_provider_original_reference;
    ...
    /**
     * Gets payment_gateway_additional_values
     *
     * @return array<string,string>|null
     */
    public function getPaymentGatewayAdditionalValues()
    {
        return $this->container['payment_gateway_additional_values'];
    }

    /**
     * Sets payment_gateway_additional_values
     *
     * @param array<string,string>|null $payment_gateway_additional_values Additional (conditional) values returned by the payment service provider.  There are many additional data elements that can be returned. The list is long and growing, so we can't mention all of them here.  For example:   * Cardholder Name   * Cardnumber (last digits only)   * Card Scheme   * Shopper IP   * Card Issuer Country   * Card Issuer Name   * Fraudscore   * Transaction Type   * Payment Status   * Username
     *
     * @return self
     */
    public function setPaymentGatewayAdditionalValues($payment_gateway_additional_values)
    {
        $this->container['payment_gateway_additional_values'] = $payment_gateway_additional_values;
     ...
     *
     * @param string $payment_auth_code Payment auth code.
     *
     * @return self
     */
    ...
    /**
     * Gets payment_hotel_id
     *
     * @return string
     */
    public function getPaymentHotelId()
    {
        return $this->container['payment_hotel_id'];
    }

    /**
     * Sets payment_hotel_id
     *
     * @param string $payment_hotel_id Payment hotel ID.
     *
     * @return self
     */
    public function setPaymentHotelId($payment_hotel_id)
    {
        $this->container['payment_hotel_id'] = $payment_hotel_id;

        return $this;
    }

    /**
     * Gets payment_hotel_guest_name
     *
     * @return string
     */
    public function getPaymentHotelGuestName()
    {
        return $this->container['payment_hotel_guest_name'];
    }

    /**
     * Sets payment_hotel_guest_name
     *
     * @param string $payment_hotel_guest_name Payment hotel guest name.
     *
     * @return self
     */
    public function setPaymentHotelGuestName($payment_hotel_guest_name)
    {
        $this->container['payment_hotel_guest_name'] = $payment_hotel_guest_name;

        return $this;
    }

    /**
     * Gets payment_hotel_room_number
     *
     * @return string
     */
    public function getPaymentHotelRoomNumber()
    {
        return $this->container['payment_hotel_room_number'];
    }

    /**
     * Sets payment_hotel_room_number
     *
     * @param string $payment_hotel_room_number Payment hotel room number.
     *
     * @return self
     */
    public function setPaymentHotelRoomNumber($payment_hotel_room_number)
    {
        $this->container['payment_hotel_room_number'] = $payment_hotel_room_number;
