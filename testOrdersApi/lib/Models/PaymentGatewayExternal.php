...
/**
 * PaymentGatewayExternal Class Doc Comment
 *
 * @category Class
 * @description Details on the payment when using an external Payment Gateway or using a physical payment method such as cash to settle the Guest Payment. &gt; Not applicable to B2B resellers (Indirect sales / &#x60;SettlementType:EXTERNAL&#x60;).
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PaymentGatewayExternal extends CommonPaymentGateway
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentGatewayExternal';
