...
/**
 * PaymentListResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentListResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentListResponseData';
    ...
    protected static $openAPITypes = [
        ...
        'page_index' => 'int',
        'total_pages' => 'int',
        'items' => '\PrioTicket\DistributorAPI\Models\PaymentDetails[]'
    ];
    ...
    public function setCurrentItemCount($current_item_count)
    {
        ...
        if (($current_item_count > 500)) {
            throw new \InvalidArgumentException('invalid value for $current_item_count when calling PaymentListResponseData., must be smaller than or equal to 500.');
        }
        if (($current_item_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_item_count when calling PaymentListResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setItemsPerPage($items_per_page)
    {
        ...
        if (($items_per_page > 500)) {
            throw new \InvalidArgumentException('invalid value for $items_per_page when calling PaymentListResponseData., must be smaller than or equal to 500.');
        }
        if (($items_per_page < 0)) {
            throw new \InvalidArgumentException('invalid value for $items_per_page when calling PaymentListResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setStartIndex($start_index)
    {
        ...
        if (($start_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $start_index when calling PaymentListResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalItems($total_items)
    {
        ...
        if (($total_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_items when calling PaymentListResponseData., must be bigger than or equal to 0.');
        }
    ...
    public function setPageIndex($page_index)
    {
        ...
        if (($page_index < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_index when calling PaymentListResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalPages($total_pages)
    {
        ...
        if (($total_pages < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_pages when calling PaymentListResponseData., must be bigger than or equal to 0.');
        }
     ...
     * Gets items
     *
     * @return \PrioTicket\DistributorAPI\Models\PaymentDetails[]
     */
     ...
     * Sets items
     *
     * @param \PrioTicket\DistributorAPI\Models\PaymentDetails[] $items A list of all payments.
     *
     * @return self
     */
