...
class PickupPoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'pickup_point_location' => 'string',
        'pickup_point_time' => 'string',
        'pickup_point_times' => 'string[]',
        'pickup_point_duration' => 'int',
        'pickup_point_availability_dependency' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'pickup_point_description' => null,
        'pickup_point_location' => null,
        'pickup_point_time' => 'time',
        'pickup_point_times' => 'time',
        'pickup_point_duration' => null,
        'pickup_point_availability_dependency' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'pickup_point_description' => 'pickup_point_description',
        'pickup_point_location' => 'pickup_point_location',
        'pickup_point_time' => 'pickup_point_time',
        'pickup_point_times' => 'pickup_point_times',
        'pickup_point_duration' => 'pickup_point_duration',
        'pickup_point_availability_dependency' => 'pickup_point_availability_dependency'
    ];
    ...
    protected static $setters = [
        'pickup_point_id' => 'setPickupPointId',
        'pickup_point_name' => 'setPickupPointName',
        'pickup_point_description' => 'setPickupPointDescription',
        'pickup_point_location' => 'setPickupPointLocation',
        'pickup_point_time' => 'setPickupPointTime',
        'pickup_point_times' => 'setPickupPointTimes',
        'pickup_point_duration' => 'setPickupPointDuration',
        'pickup_point_availability_dependency' => 'setPickupPointAvailabilityDependency'
    ];
    ...
    protected static $getters = [
        'pickup_point_id' => 'getPickupPointId',
        'pickup_point_name' => 'getPickupPointName',
        'pickup_point_description' => 'getPickupPointDescription',
        'pickup_point_location' => 'getPickupPointLocation',
        'pickup_point_time' => 'getPickupPointTime',
        'pickup_point_times' => 'getPickupPointTimes',
        'pickup_point_duration' => 'getPickupPointDuration',
        'pickup_point_availability_dependency' => 'getPickupPointAvailabilityDependency'
    ];
    ...
    {
        $this->container['pickup_point_id'] = $data['pickup_point_id'] ?? null;
        $this->container['pickup_point_name'] = $data['pickup_point_name'] ?? null;
        $this->container['pickup_point_description'] = $data['pickup_point_description'] ?? null;
        $this->container['pickup_point_location'] = $data['pickup_point_location'] ?? null;
        $this->container['pickup_point_time'] = $data['pickup_point_time'] ?? null;
        $this->container['pickup_point_times'] = $data['pickup_point_times'] ?? null;
        $this->container['pickup_point_duration'] = $data['pickup_point_duration'] ?? null;
        $this->container['pickup_point_availability_dependency'] = $data['pickup_point_availability_dependency'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pickup_point_id'] === null) {
            $invalidProperties[] = "'pickup_point_id' can't be null";
        }
        if ($this->container['pickup_point_name'] === null) {
            $invalidProperties[] = "'pickup_point_name' can't be null";
        }
    ...
    /**
     * Gets pickup_point_id
     *
     * @return string
     */
    public function getPickupPointId()
    {
        return $this->container['pickup_point_id'];
    }

    /**
     * Sets pickup_point_id
     *
     * @param string $pickup_point_id Pickup point ID.
     *
     * @return self
     */
    public function setPickupPointId($pickup_point_id)
    {
        $this->container['pickup_point_id'] = $pickup_point_id;
     ...
     *
     * @param string $pickup_point_name Pickup point name / label.
     *
     * @return self
     */
    ...
    /**
     * Gets pickup_point_description
     *
     * @return string|null
     */
    public function getPickupPointDescription()
    {
        return $this->container['pickup_point_description'];
    }

    /**
     * Sets pickup_point_description
     *
     * @param string|null $pickup_point_description Pickup point description.
     *
     * @return self
     */
    public function setPickupPointDescription($pickup_point_description)
    {
        $this->container['pickup_point_description'] = $pickup_point_description;

        return $this;
    }

    /**
     * Gets pickup_point_location
     *
     * @return string|null
     */
    public function getPickupPointLocation()
    {
        return $this->container['pickup_point_location'];
    }

    /**
     * Sets pickup_point_location
     *
     * @param string|null $pickup_point_location Reference to the location details.
     *
     * @return self
     */
    public function setPickupPointLocation($pickup_point_location)
    {
        $this->container['pickup_point_location'] = $pickup_point_location;

        return $this;
    }

    /**
     * Gets pickup_point_time
     *
     * @return string|null
     * @deprecated
     */
    public function getPickupPointTime()
    {
        return $this->container['pickup_point_time'];
    }

    /**
     * Sets pickup_point_time
     *
     * @param string|null $pickup_point_time Time of pickup.
     *
     * @return self
     * @deprecated
     */
    public function setPickupPointTime($pickup_point_time)
    {
        $this->container['pickup_point_time'] = $pickup_point_time;

        return $this;
    }

    /**
     * Gets pickup_point_times
     *
     * @return string[]|null
     */
    public function getPickupPointTimes()
    {
        return $this->container['pickup_point_times'];
    }

    /**
     * Sets pickup_point_times
     *
     * @param string[]|null $pickup_point_times Times available to select for this pickup point.
     *
     * @return self
     */
    public function setPickupPointTimes($pickup_point_times)
    {
        $this->container['pickup_point_times'] = $pickup_point_times;

        return $this;
    }

    /**
     * Gets pickup_point_duration
     *
     * @return int|null
     */
    public function getPickupPointDuration()
    {
        return $this->container['pickup_point_duration'];
    }

    /**
     * Sets pickup_point_duration
     *
     * @param int|null $pickup_point_duration Duration of the pickup in minutes.
     *
     * @return self
     */
    public function setPickupPointDuration($pickup_point_duration)
    {
        $this->container['pickup_point_duration'] = $pickup_point_duration;

        return $this;
    }

    /**
     * Gets pickup_point_availability_dependency
     *
     * @return string|null
     */
    public function getPickupPointAvailabilityDependency()
    {
        return $this->container['pickup_point_availability_dependency'];
    }

    /**
     * Sets pickup_point_availability_dependency
     *
     * @param string|null $pickup_point_availability_dependency Dependency on the selected `availability_slot`.  The selected (`pickup_point_time` + `pickup_point_duration`) is not allowed to exceed the selected `availability_from_date_time` and therefore only a limited amount of `pickup_point_times` should be shown.
     *
     * @return self
     */
    public function setPickupPointAvailabilityDependency($pickup_point_availability_dependency)
    {
        $this->container['pickup_point_availability_dependency'] = $pickup_point_availability_dependency;
