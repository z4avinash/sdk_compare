...
/**
 * ProductExclude Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductExclude implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductExclude';
    ...
    protected static $setters = [
        'exclude_id' => 'setExcludeId',
        'exclude_name' => 'setExcludeName',
        'exclude_description' => 'setExcludeDescription',
        'exclude_icon' => 'setExcludeIcon'
    ];
    ...
    protected static $getters = [
        'exclude_id' => 'getExcludeId',
        'exclude_name' => 'getExcludeName',
        'exclude_description' => 'getExcludeDescription',
        'exclude_icon' => 'getExcludeIcon'
    ];
    ...
    {
        $this->container['exclude_id'] = $data['exclude_id'] ?? null;
        $this->container['exclude_name'] = $data['exclude_name'] ?? null;
        $this->container['exclude_description'] = $data['exclude_description'] ?? null;
        $this->container['exclude_icon'] = $data['exclude_icon'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['exclude_id'] === null) {
            $invalidProperties[] = "'exclude_id' can't be null";
        }
        if ($this->container['exclude_name'] === null) {
            $invalidProperties[] = "'exclude_name' can't be null";
        }
    ...
    {
        return $this->container['exclude_id'];
    }

    /**
     * Sets exclude_id
     *
     * @param string $exclude_id Unique product exclude ID.
     *
     * @return self
     * @deprecated
     */
    public function setExcludeId($exclude_id)
    {
        $this->container['exclude_id'] = $exclude_id;
     ...
     * @deprecated
     */
    public function getExcludeName()
    {
        return $this->container['exclude_name'];
    }

    /**
     * Sets exclude_name
     *
     * @param string $exclude_name The name of the excluded product.
     *
     * @return self
     * @deprecated
     */
    public function setExcludeName($exclude_name)
    {
        $this->container['exclude_name'] = $exclude_name;

        return $this;
    }

    /**
     * Gets exclude_description
     *
     * @return string|null
     */
    public function getExcludeDescription()
    {
        return $this->container['exclude_description'];
    }

    /**
     * Sets exclude_description
     *
     * @param string|null $exclude_description More detail on the excluded product.
     *
     * @return self
     */
    public function setExcludeDescription($exclude_description)
    {
        $this->container['exclude_description'] = $exclude_description;
     ...
     * @deprecated
     */
    public function getExcludeIcon()
    {
        return $this->container['exclude_icon'];
    }

    /**
     * Sets exclude_icon
     *
     * @param string|null $exclude_icon Exclude icon.
     *
     * @return self
     * @deprecated
     */
    public function setExcludeIcon($exclude_icon)
    {
        $this->container['exclude_icon'] = $exclude_icon;
