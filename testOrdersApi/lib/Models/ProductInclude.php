...
/**
 * ProductInclude Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductInclude implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductInclude';
    ...
    protected static $setters = [
        'include_id' => 'setIncludeId',
        'include_name' => 'setIncludeName',
        'include_description' => 'setIncludeDescription',
        'include_icon' => 'setIncludeIcon'
    ];
    ...
    protected static $getters = [
        'include_id' => 'getIncludeId',
        'include_name' => 'getIncludeName',
        'include_description' => 'getIncludeDescription',
        'include_icon' => 'getIncludeIcon'
    ];
    ...
    {
        $this->container['include_id'] = $data['include_id'] ?? null;
        $this->container['include_name'] = $data['include_name'] ?? null;
        $this->container['include_description'] = $data['include_description'] ?? null;
        $this->container['include_icon'] = $data['include_icon'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['include_id'] === null) {
            $invalidProperties[] = "'include_id' can't be null";
        }
        if ($this->container['include_name'] === null) {
            $invalidProperties[] = "'include_name' can't be null";
        }
    ...
    {
        return $this->container['include_id'];
    }

    /**
     * Sets include_id
     *
     * @param string $include_id Unique product include ID.
     *
     * @return self
     * @deprecated
     */
    public function setIncludeId($include_id)
    {
        $this->container['include_id'] = $include_id;
    ...
    {
        return $this->container['include_name'];
    }

    /**
     * Sets include_name
     *
     * @param string $include_name The name of the included product.
     *
     * @return self
     * @deprecated
     */
    public function setIncludeName($include_name)
    {
        $this->container['include_name'] = $include_name;

        return $this;
    }

    /**
     * Gets include_description
     *
     * @return string|null
     */
    public function getIncludeDescription()
    {
        return $this->container['include_description'];
    }

    /**
     * Sets include_description
     *
     * @param string|null $include_description More detail on the included product.
     *
     * @return self
     */
    public function setIncludeDescription($include_description)
    {
        $this->container['include_description'] = $include_description;
     ...
     * @deprecated
     */
    public function getIncludeIcon()
    {
        return $this->container['include_icon'];
    }

    /**
     * Sets include_icon
     *
     * @param string|null $include_icon Include icon.
     *
     * @return self
     * @deprecated
     */
    public function setIncludeIcon($include_icon)
    {
        $this->container['include_icon'] = $include_icon;
