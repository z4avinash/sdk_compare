...
/**
 * ProductRedemptionRules Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductRedemptionRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductRedemptionRules';
    ...
    protected static $openAPITypes = [
        'redemption_has_duration' => 'string',
        'redemption_duration_time' => 'int',
        'redemption_duration_type' => '\PrioTicket\DistributorAPI\Models\RedemptionDurationType',
        'redemption_count_type' => '\PrioTicket\DistributorAPI\Models\RedemptionCountType',
        'redemption_count_value' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'redemption_has_duration' => null,
        'redemption_duration_time' => null,
        'redemption_duration_type' => null,
        'redemption_count_type' => null,
        'redemption_count_value' => null
    ];
    ...
    protected static $attributeMap = [
        'redemption_has_duration' => 'redemption_has_duration',
        'redemption_duration_time' => 'redemption_duration_time',
        'redemption_duration_type' => 'redemption_duration_type',
        'redemption_count_type' => 'redemption_count_type',
        'redemption_count_value' => 'redemption_count_value'
    ];
    ...
    protected static $setters = [
        'redemption_has_duration' => 'setRedemptionHasDuration',
        'redemption_duration_time' => 'setRedemptionDurationTime',
        'redemption_duration_type' => 'setRedemptionDurationType',
        'redemption_count_type' => 'setRedemptionCountType',
        'redemption_count_value' => 'setRedemptionCountValue'
    ];
    ...
    protected static $getters = [
        'redemption_has_duration' => 'getRedemptionHasDuration',
        'redemption_duration_time' => 'getRedemptionDurationTime',
        'redemption_duration_type' => 'getRedemptionDurationType',
        'redemption_count_type' => 'getRedemptionCountType',
        'redemption_count_value' => 'getRedemptionCountValue'
    ];
    ...
    {
        $this->container['redemption_has_duration'] = $data['redemption_has_duration'] ?? 'false';
        $this->container['redemption_duration_time'] = $data['redemption_duration_time'] ?? null;
        $this->container['redemption_duration_type'] = $data['redemption_duration_type'] ?? null;
        $this->container['redemption_count_type'] = $data['redemption_count_type'] ?? null;
        $this->container['redemption_count_value'] = $data['redemption_count_value'] ?? 1;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['redemption_has_duration'] === null) {
            $invalidProperties[] = "'redemption_has_duration' can't be null";
        }
        if ($this->container['redemption_count_type'] === null) {
            $invalidProperties[] = "'redemption_count_type' can't be null";
        }
    ...
    /**
     * Gets redemption_has_duration
     *
     * @return string
     */
    public function getRedemptionHasDuration()
    {
        return $this->container['redemption_has_duration'];
    }

    /**
     * Sets redemption_has_duration
     *
     * @param string $redemption_has_duration In case this product has a fixed duration a countdown will be started based on the `redemption_duration_type`.
     *
     * @return self
     */
    public function setRedemptionHasDuration($redemption_has_duration)
    {
        $this->container['redemption_has_duration'] = $redemption_has_duration;

        return $this;
    }

    /**
     * Gets redemption_duration_time
     *
     * @return int|null
     */
    public function getRedemptionDurationTime()
    {
        return $this->container['redemption_duration_time'];
    }

    /**
     * Sets redemption_duration_time
     *
     * @param int|null $redemption_duration_time The total amount of time in seconds that the pass is supposed to be valid. Only applicable if `redemption_has_duration:true`.
     *
     * @return self
     */
    public function setRedemptionDurationTime($redemption_duration_time)
    {
        $this->container['redemption_duration_time'] = $redemption_duration_time;

        return $this;
    }

    /**
     * Gets redemption_duration_type
     *
     * @return \PrioTicket\DistributorAPI\Models\RedemptionDurationType|null
     */
    public function getRedemptionDurationType()
    {
        return $this->container['redemption_duration_type'];
    }

    /**
     * Sets redemption_duration_type
     *
     * @param \PrioTicket\DistributorAPI\Models\RedemptionDurationType|null $redemption_duration_type redemption_duration_type
     *
     * @return self
     */
    public function setRedemptionDurationType($redemption_duration_type)
    {
        $this->container['redemption_duration_type'] = $redemption_duration_type;

        return $this;
    }

    /**
     * Gets redemption_count_type
     *
     * @return \PrioTicket\DistributorAPI\Models\RedemptionCountType
     */
    public function getRedemptionCountType()
    {
        return $this->container['redemption_count_type'];
    }

    /**
     * Sets redemption_count_type
     *
     * @param \PrioTicket\DistributorAPI\Models\RedemptionCountType $redemption_count_type redemption_count_type
     *
     * @return self
     */
    public function setRedemptionCountType($redemption_count_type)
    {
        $this->container['redemption_count_type'] = $redemption_count_type;

        return $this;
    }

    /**
     * Gets redemption_count_value
     *
     * @return int|null
     */
    public function getRedemptionCountValue()
    {
        return $this->container['redemption_count_value'];
    }

    /**
     * Sets redemption_count_value
     *
     * @param int|null $redemption_count_value The amount of times this product can be redeemed.   Only applicable if `redemption_count_type:LIMITED`.
     *
     * @return self
     */
    public function setRedemptionCountValue($redemption_count_value)
    {
        $this->container['redemption_count_value'] = $redemption_count_value;
