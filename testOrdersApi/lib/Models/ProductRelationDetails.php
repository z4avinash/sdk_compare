...
/**
 * ProductRelationDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductRelationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductRelationDetails';
    ...
    protected static $openAPITypes = [
        ...
        'product_timepicker_visible' => 'string',
        'product_booking_window_product_id' => 'string',
        'product_booking_window_start_time' => 'int',
        'product_booking_window_end_time' => 'int',
        'product_admission_type' => '\PrioTicket\DistributorAPI\Models\ProductAdmissionType',
        'product_relation_type' => '\PrioTicket\DistributorAPI\Models\RelationType',
    ...
    protected static $openAPIFormats = [
        ...
        'product_booking_window_product_id' => null,
        'product_booking_window_start_time' => null,
        'product_booking_window_end_time' => null,
        'product_admission_type' => null,
        'product_relation_type' => null,
        'product_images' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'product_booking_window_product_id' => 'product_booking_window_product_id',
        'product_booking_window_start_time' => 'product_booking_window_start_time',
        'product_booking_window_end_time' => 'product_booking_window_end_time',
    ...
    protected static $setters = [
        ...
        'product_parent_id' => 'setProductParentId',
        ...
        'product_booking_window_product_id' => 'setProductBookingWindowProductId',
        'product_booking_window_start_time' => 'setProductBookingWindowStartTime',
        'product_booking_window_end_time' => 'setProductBookingWindowEndTime',
        'product_admission_type' => 'setProductAdmissionType',
        'product_relation_type' => 'setProductRelationType',
    ...
    protected static $getters = [
        ...
        'product_parent_id' => 'getProductParentId',
        ...
        'product_booking_window_product_id' => 'getProductBookingWindowProductId',
        'product_booking_window_start_time' => 'getProductBookingWindowStartTime',
        'product_booking_window_end_time' => 'getProductBookingWindowEndTime',
        'product_admission_type' => 'getProductAdmissionType',
        'product_relation_type' => 'getProductRelationType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['product_parent_id'] = $data['product_parent_id'] ?? null;
        ...
        $this->container['product_booking_window_product_id'] = $data['product_booking_window_product_id'] ?? null;
        $this->container['product_booking_window_start_time'] = $data['product_booking_window_start_time'] ?? null;
        $this->container['product_booking_window_end_time'] = $data['product_booking_window_end_time'] ?? null;
        $this->container['product_admission_type'] = $data['product_admission_type'] ?? null;
        $this->container['product_relation_type'] = $data['product_relation_type'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_parent_id'] === null) {
            $invalidProperties[] = "'product_parent_id' can't be null";
        }
    ...
    /**
     * Gets product_parent_id
     *
     * @return string
     */
    public function getProductParentId()
    {
        return $this->container['product_parent_id'];
    }

    /**
     * Sets product_parent_id
     *
     * @param string $product_parent_id Unique identifier for the parent product assigned by Prio.
     *
     * @return self
     */
    public function setProductParentId($product_parent_id)
    {
        $this->container['product_parent_id'] = $product_parent_id;
     ...
     *
     * @param string|null $product_from_price Static From price which can be shown. (Usually regular Adult including discount). Also used for price filtering.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $product_start_date Starting date of the product.
     *
     * @return self
     */
     ...
     *
     * @param string|null $product_timepicker_visible Whether you should show the timepicker during booking.
     *
     * @return self
     */
    ...
    /**
     * Gets product_booking_window_product_id
     *
     * @return string|null
     */
    public function getProductBookingWindowProductId()
    {
        return $this->container['product_booking_window_product_id'];
    }

    /**
     * Sets product_booking_window_product_id
     *
     * @param string|null $product_booking_window_product_id The booking window dependant product, also called dependencies, indicates the restrictions on sub-ticket bookings in regards to the selected travel-date of another product. This means that some products can only be bought between a fixed booking window relative to another product (booking). This is mainly used in itenaries and tours where external factors such as travel time restrict a guest to book multiple attractions in a short period.  This dependancy can be set for another (previous) sub-product in this array or the main product of this booking.  Only applicable if `product_combi:true` or `product_addon:true`.
     *
     * @return self
     */
    public function setProductBookingWindowProductId($product_booking_window_product_id)
    {
        $this->container['product_booking_window_product_id'] = $product_booking_window_product_id;

        return $this;
    }

    /**
     * Gets product_booking_window_start_time
     *
     * @return int|null
     */
    public function getProductBookingWindowStartTime()
    {
        return $this->container['product_booking_window_start_time'];
    }

    /**
     * Sets product_booking_window_start_time
     *
     * @param int|null $product_booking_window_start_time The minimum amount of minutes passed after the selected travel date (`booking_travel_date`) or availability slot (`availability_from_date_time`) of the `product_booking_window_product_id`.  Only applicable if `product_combi:true` or `product_addon:true`.
     *
     * @return self
     */
    public function setProductBookingWindowStartTime($product_booking_window_start_time)
    {
        $this->container['product_booking_window_start_time'] = $product_booking_window_start_time;

        return $this;
    }

    /**
     * Gets product_booking_window_end_time
     *
     * @return int|null
     */
    public function getProductBookingWindowEndTime()
    {
        return $this->container['product_booking_window_end_time'];
    }

    /**
     * Sets product_booking_window_end_time
     *
     * @param int|null $product_booking_window_end_time The maximum amount of minutes allowed after the previously selected travel date (`booking_travel_date`) or availability slot (`availability_from_date_time`) of the `product_booking_window_product_id`.  Only applicable if `product_combi:true` or `product_addon:true`.
     *
     * @return self
     */
    public function setProductBookingWindowEndTime($product_booking_window_end_time)
    {
        $this->container['product_booking_window_end_time'] = $product_booking_window_end_time;
    ...
    /**
     * Gets product_relation_type
     *
     * @return \PrioTicket\DistributorAPI\Models\RelationType|null
     */
    public function getProductRelationType()
    {
        return $this->container['product_relation_type'];
    }

    /**
     * Sets product_relation_type
     *
     * @param \PrioTicket\DistributorAPI\Models\RelationType|null $product_relation_type product_relation_type
     *
     * @return self
     */
    public function setProductRelationType($product_relation_type)
    {
        $this->container['product_relation_type'] = $product_relation_type;
