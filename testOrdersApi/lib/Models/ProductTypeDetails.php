...
/**
 * ProductTypeDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductTypeDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductTypeDetails';
    ...
    protected static $openAPITypes = [
        ...
        'product_type_variant_id' => 'string',
        ...
        'product_type_quantity_min' => 'int',
        'product_type_quantity_max' => 'int',
        'product_type_price_tax_id' => 'string',
        'product_type_price_type' => 'string',
        'product_type_pricing' => '\PrioTicket\DistributorAPI\Models\ProductTypePricing',
        'product_type_fees' => '\PrioTicket\DistributorAPI\Models\Fee[]',
        'product_type_quantity_variations_label' => 'string',
        'product_type_quantity_variations' => '\PrioTicket\DistributorAPI\Models\ProductTypeQuantityVariation[]',
        'product_type_daily_variations' => '\PrioTicket\DistributorAPI\Models\ProductTypeDailyVariation[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'product_type_quantity_min' => null,
        'product_type_quantity_max' => null,
        'product_type_price_tax_id' => null,
        'product_type_price_type' => null,
        'product_type_pricing' => null,
        'product_type_fees' => null,
        'product_type_quantity_variations_label' => null,
        'product_type_quantity_variations' => null,
        'product_type_daily_variations' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'product_type_quantity_min' => 'product_type_quantity_min',
        'product_type_quantity_max' => 'product_type_quantity_max',
        'product_type_price_tax_id' => 'product_type_price_tax_id',
        'product_type_price_type' => 'product_type_price_type',
        'product_type_pricing' => 'product_type_pricing',
        'product_type_fees' => 'product_type_fees',
        'product_type_quantity_variations_label' => 'product_type_quantity_variations_label',
        'product_type_quantity_variations' => 'product_type_quantity_variations',
        'product_type_daily_variations' => 'product_type_daily_variations'
    ];
    ...
    protected static $setters = [
        ...
        'product_type_variant_id' => 'setProductTypeVariantId',
        'product_type_id' => 'setProductTypeId',
        'product_type_label' => 'setProductTypeLabel',
        'product_type_description' => 'setProductTypeDescription',
        ...
        'product_type_quantity_min' => 'setProductTypeQuantityMin',
        'product_type_quantity_max' => 'setProductTypeQuantityMax',
        'product_type_price_tax_id' => 'setProductTypePriceTaxId',
        'product_type_price_type' => 'setProductTypePriceType',
        'product_type_pricing' => 'setProductTypePricing',
        'product_type_fees' => 'setProductTypeFees',
        'product_type_quantity_variations_label' => 'setProductTypeQuantityVariationsLabel',
        'product_type_quantity_variations' => 'setProductTypeQuantityVariations',
        'product_type_daily_variations' => 'setProductTypeDailyVariations'
    ];
    ...
    protected static $getters = [
        ...
        'product_type_variant_id' => 'getProductTypeVariantId',
        'product_type_id' => 'getProductTypeId',
        'product_type_label' => 'getProductTypeLabel',
        'product_type_description' => 'getProductTypeDescription',
        ...
        'product_type_quantity_min' => 'getProductTypeQuantityMin',
        'product_type_quantity_max' => 'getProductTypeQuantityMax',
        'product_type_price_tax_id' => 'getProductTypePriceTaxId',
        'product_type_price_type' => 'getProductTypePriceType',
        'product_type_pricing' => 'getProductTypePricing',
        'product_type_fees' => 'getProductTypeFees',
        'product_type_quantity_variations_label' => 'getProductTypeQuantityVariationsLabel',
        'product_type_quantity_variations' => 'getProductTypeQuantityVariations',
        'product_type_daily_variations' => 'getProductTypeDailyVariations'
    ];
    ...
    const PRODUCT_TYPE_PRICE_TYPE_INDIVIDUAL = 'INDIVIDUAL';
    const PRODUCT_TYPE_PRICE_TYPE_GROUP = 'GROUP';
     ...
     * @return string[]
     */
    public function getProductTypePriceTypeAllowableValues()
    {
        return [
            self::PRODUCT_TYPE_PRICE_TYPE_INDIVIDUAL,
            self::PRODUCT_TYPE_PRICE_TYPE_GROUP,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['product_type_variant_id'] = $data['product_type_variant_id'] ?? null;
        $this->container['product_type_id'] = $data['product_type_id'] ?? null;
        $this->container['product_type_label'] = $data['product_type_label'] ?? null;
        $this->container['product_type_description'] = $data['product_type_description'] ?? null;
        ...
        $this->container['product_type_pax'] = $data['product_type_pax'] ?? 1;
        $this->container['product_type_capacity'] = $data['product_type_capacity'] ?? 1;
        $this->container['product_type_quantity_min'] = $data['product_type_quantity_min'] ?? null;
        $this->container['product_type_quantity_max'] = $data['product_type_quantity_max'] ?? null;
        $this->container['product_type_price_tax_id'] = $data['product_type_price_tax_id'] ?? null;
        $this->container['product_type_price_type'] = $data['product_type_price_type'] ?? null;
        $this->container['product_type_pricing'] = $data['product_type_pricing'] ?? null;
        $this->container['product_type_fees'] = $data['product_type_fees'] ?? null;
        $this->container['product_type_quantity_variations_label'] = $data['product_type_quantity_variations_label'] ?? null;
        $this->container['product_type_quantity_variations'] = $data['product_type_quantity_variations'] ?? null;
        $this->container['product_type_daily_variations'] = $data['product_type_daily_variations'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['product_type_pax']) && ($this->container['product_type_pax'] < 0)) {
        ...
        if (!is_null($this->container['product_type_quantity_max']) && ($this->container['product_type_quantity_max'] > 100)) {
            $invalidProperties[] = "invalid value for 'product_type_quantity_max', must be smaller than or equal to 100.";
        }

        $allowedValues = $this->getProductTypePriceTypeAllowableValues();
        if (!is_null($this->container['product_type_price_type']) && !in_array($this->container['product_type_price_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'product_type_price_type', must be one of '%s'",
                $this->container['product_type_price_type'],
    ...
    {
        return $this->container['product_type_variant_id'];
    }

    /**
     * Sets product_type_variant_id
     *
     * @param string|null $product_type_variant_id Unique identifier for this product type variant.
     *
     * @return self
     * @deprecated
     */
    public function setProductTypeVariantId($product_type_variant_id)
    {
        $this->container['product_type_variant_id'] = $product_type_variant_id;
     ...
     *
     * @param string $product_type_id product_type_id
     *
     * @return self
     */
     ...
     *
     * @param string|null $product_type_label (Translatable) The actual label to show on your front-end.
     *
     * @return self
     */
    ...
    /**
     * Gets product_type_description
     *
     * @return string|null
     */
    public function getProductTypeDescription()
    {
        return $this->container['product_type_description'];
    }

    /**
     * Sets product_type_description
     *
     * @param string|null $product_type_description (Translatable) Optional description of this product type. If provided, it is highly recommended to show it on your front-end as it might contain important information about the eligibility.
     *
     * @return self
     */
    public function setProductTypeDescription($product_type_description)
    {
        $this->container['product_type_description'] = $product_type_description;
     ...
     *
     * @param int|null $product_type_pax Number of persons that should be counted in the reporting.
     *
     * @return self
     */
    public function setProductTypePax($product_type_pax)
    {
        ...
        if (!is_null($product_type_pax) && ($product_type_pax < 0)) {
            throw new \InvalidArgumentException('invalid value for $product_type_pax when calling ProductTypeDetails., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int|null $product_type_capacity Capacity that should be counted / blocked in the system.  For example:  If a single table with six seats is booked by two persons, the setup would be as follows:    ```   \"product_type_count\": 1,   \"product_type_pax\": 2,   \"product_type_capacity\": 6   ```
     *
     * @return self
     */
    public function setProductTypeCapacity($product_type_capacity)
    {
        ...
        if (!is_null($product_type_capacity) && ($product_type_capacity < 0)) {
            throw new \InvalidArgumentException('invalid value for $product_type_capacity when calling ProductTypeDetails., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets product_type_quantity_min
     *
     * @return int|null
     */
    public function getProductTypeQuantityMin()
    {
        return $this->container['product_type_quantity_min'];
    }

    /**
     * Sets product_type_quantity_min
     *
     * @param int|null $product_type_quantity_min The minimum required quantity to be selected. The `product_type_count` must be equal or higher.
     *
     * @return self
     */
    public function setProductTypeQuantityMin($product_type_quantity_min)
    {


        $this->container['product_type_quantity_min'] = $product_type_quantity_min;

        return $this;
    }

    /**
     * Gets product_type_quantity_max
     *
     * @return int|null
     */
    public function getProductTypeQuantityMax()
    {
        return $this->container['product_type_quantity_max'];
    }

    /**
     * Sets product_type_quantity_max
     *
     * @param int|null $product_type_quantity_max The maximum allowed quantity to be selected. The `product_type_count` must be equal or lower.
     *
     * @return self
     */
    public function setProductTypeQuantityMax($product_type_quantity_max)
    {

        if (!is_null($product_type_quantity_max) && ($product_type_quantity_max > 100)) {
            throw new \InvalidArgumentException('invalid value for $product_type_quantity_max when calling ProductTypeDetails., must be smaller than or equal to 100.');
        }

        $this->container['product_type_quantity_max'] = $product_type_quantity_max;

        return $this;
    }

    /**
     * Gets product_type_price_tax_id
     *
     * @return string|null
     */
    public function getProductTypePriceTaxId()
    {
        return $this->container['product_type_price_tax_id'];
    }

    /**
     * Sets product_type_price_tax_id
     *
     * @param string|null $product_type_price_tax_id Tax ID for this product type. Tax information can be retrieved from the Tax API.
     *
     * @return self
     */
    public function setProductTypePriceTaxId($product_type_price_tax_id)
    {
        $this->container['product_type_price_tax_id'] = $product_type_price_tax_id;

        return $this;
    }

    /**
     * Gets product_type_price_type
     *
     * @return string|null
     */
    public function getProductTypePriceType()
    {
        return $this->container['product_type_price_type'];
    }

    /**
     * Sets product_type_price_type
     *
     * @param string|null $product_type_price_type Whether the price is applicable per individual or fixed for the whole group.  Price Type:      * `INDIVIDUAL` - Depending on the booking quantity, the price increases.      * `GROUP` - The price for this product type is fixed regardless of how many are booked.
     *
     * @return self
     */
    public function setProductTypePriceType($product_type_price_type)
    {
        $allowedValues = $this->getProductTypePriceTypeAllowableValues();
        if (!is_null($product_type_price_type) && !in_array($product_type_price_type, $allowedValues, true)) {
        ...
        $this->container['product_type_price_type'] = $product_type_price_type;
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductTypePricing
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductTypePricing $product_type_pricing product_type_pricing
     *
     * @return self
     */
    ...
    /**
     * Gets product_type_fees
     *
     * @return \PrioTicket\DistributorAPI\Models\Fee[]|null
     */
    public function getProductTypeFees()
    {
        return $this->container['product_type_fees'];
    }

    /**
     * Sets product_type_fees
     *
     * @param \PrioTicket\DistributorAPI\Models\Fee[]|null $product_type_fees List of fees. Some fee types are only visible for certain users.
     *
     * @return self
     */
    public function setProductTypeFees($product_type_fees)
    {
        $this->container['product_type_fees'] = $product_type_fees;

        return $this;
    }

    /**
     * Gets product_type_quantity_variations_label
     *
     * @return string|null
     * @deprecated
     */
    public function getProductTypeQuantityVariationsLabel()
    {
        return $this->container['product_type_quantity_variations_label'];
    }

    /**
     * Sets product_type_quantity_variations_label
     *
     * @param string|null $product_type_quantity_variations_label product_type_quantity_variations_label
     *
     * @return self
     * @deprecated
     */
    public function setProductTypeQuantityVariationsLabel($product_type_quantity_variations_label)
    {
        $this->container['product_type_quantity_variations_label'] = $product_type_quantity_variations_label;

        return $this;
    }

    /**
     * Gets product_type_quantity_variations
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductTypeQuantityVariation[]|null
     */
    public function getProductTypeQuantityVariations()
    {
        return $this->container['product_type_quantity_variations'];
    }

    /**
     * Sets product_type_quantity_variations
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductTypeQuantityVariation[]|null $product_type_quantity_variations Only set if `product_quantity_pricing:true`.
     *
     * @return self
     */
    public function setProductTypeQuantityVariations($product_type_quantity_variations)
    {
        $this->container['product_type_quantity_variations'] = $product_type_quantity_variations;

        return $this;
    }

    /**
     * Gets product_type_daily_variations
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductTypeDailyVariation[]|null
     * @deprecated
     */
    public function getProductTypeDailyVariations()
    {
        return $this->container['product_type_daily_variations'];
    }

    /**
     * Sets product_type_daily_variations
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductTypeDailyVariation[]|null $product_type_daily_variations Only set if `product_daily_pricing:true`. As an alternative to implementing these prices statically (Content API), they could also be retrieved from the Availability API (`availability_pricing`).
     *
     * @return self
     * @deprecated
     */
    public function setProductTypeDailyVariations($product_type_daily_variations)
    {
        $this->container['product_type_daily_variations'] = $product_type_daily_variations;
