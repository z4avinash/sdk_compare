...
/**
 * ProductTypeSeason Class Doc Comment
 *
 * @category Class
 ...
 */
class ProductTypeSeason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductTypeSeason';
    ...
    protected static $openAPITypes = [
        'product_type_season_label' => 'string',
        'product_type_season_start_date' => '\DateTime',
        'product_type_season_end_date' => '\DateTime',
        'product_type_season_details' => '\PrioTicket\DistributorAPI\Models\ProductTypeDetails[]'
    ];
    ...
    protected static $openAPIFormats = [
        'product_type_season_label' => null,
        'product_type_season_start_date' => 'date-time',
        'product_type_season_end_date' => 'date-time',
        'product_type_season_details' => null
    ];
    ...
    protected static $attributeMap = [
        'product_type_season_label' => 'product_type_season_label',
        'product_type_season_start_date' => 'product_type_season_start_date',
        'product_type_season_end_date' => 'product_type_season_end_date',
        'product_type_season_details' => 'product_type_season_details'
    ];
    ...
    protected static $setters = [
        'product_type_season_label' => 'setProductTypeSeasonLabel',
        'product_type_season_start_date' => 'setProductTypeSeasonStartDate',
        'product_type_season_end_date' => 'setProductTypeSeasonEndDate',
        'product_type_season_details' => 'setProductTypeSeasonDetails'
    ];
    ...
    protected static $getters = [
        'product_type_season_label' => 'getProductTypeSeasonLabel',
        'product_type_season_start_date' => 'getProductTypeSeasonStartDate',
        'product_type_season_end_date' => 'getProductTypeSeasonEndDate',
        'product_type_season_details' => 'getProductTypeSeasonDetails'
    ];
    ...
    {
        $this->container['product_type_season_label'] = $data['product_type_season_label'] ?? null;
        $this->container['product_type_season_start_date'] = $data['product_type_season_start_date'] ?? null;
        $this->container['product_type_season_end_date'] = $data['product_type_season_end_date'] ?? null;
        $this->container['product_type_season_details'] = $data['product_type_season_details'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_type_season_start_date'] === null) {
            $invalidProperties[] = "'product_type_season_start_date' can't be null";
        }
        if ($this->container['product_type_season_details'] === null) {
            $invalidProperties[] = "'product_type_season_details' can't be null";
        }
    ...
    /**
     * Gets product_type_season_label
     *
     * @return string|null
     */
    public function getProductTypeSeasonLabel()
    {
        return $this->container['product_type_season_label'];
    }

    /**
     * Sets product_type_season_label
     *
     * @param string|null $product_type_season_label Optional label for this season. Only applicable if set and `product_seasonal_pricing:true.
     *
     * @return self
     */
    public function setProductTypeSeasonLabel($product_type_season_label)
    {
        $this->container['product_type_season_label'] = $product_type_season_label;

        return $this;
    }

    /**
     * Gets product_type_season_start_date
     *
     * @return \DateTime
     */
    public function getProductTypeSeasonStartDate()
    {
        return $this->container['product_type_season_start_date'];
    }

    /**
     * Sets product_type_season_start_date
     *
     * @param \DateTime $product_type_season_start_date Start date of this season.
     *
     * @return self
     */
    public function setProductTypeSeasonStartDate($product_type_season_start_date)
    {
        $this->container['product_type_season_start_date'] = $product_type_season_start_date;

        return $this;
    }

    /**
     * Gets product_type_season_end_date
     *
     * @return \DateTime|null
     */
    public function getProductTypeSeasonEndDate()
    {
        return $this->container['product_type_season_end_date'];
    }

    /**
     * Sets product_type_season_end_date
     *
     * @param \DateTime|null $product_type_season_end_date End date of this season.
     *
     * @return self
     */
    public function setProductTypeSeasonEndDate($product_type_season_end_date)
    {
        $this->container['product_type_season_end_date'] = $product_type_season_end_date;

        return $this;
    }

    /**
     * Gets product_type_season_details
     *
     * @return \PrioTicket\DistributorAPI\Models\ProductTypeDetails[]
     */
    public function getProductTypeSeasonDetails()
    {
        return $this->container['product_type_season_details'];
    }

    /**
     * Sets product_type_season_details
     *
     * @param \PrioTicket\DistributorAPI\Models\ProductTypeDetails[] $product_type_season_details Contains information related to the different product type versions in this season.
     *
     * @return self
     */
    public function setProductTypeSeasonDetails($product_type_season_details)
    {
        $this->container['product_type_season_details'] = $product_type_season_details;
