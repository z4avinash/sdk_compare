...
/**
 * ReservationDetail Class Doc Comment
 *
 * @category Class
 ...
 */
class ReservationDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReservationDetail';
    ...
    protected static $openAPITypes = [
        ...
        'booking_version' => 'int',
        'booking_voucher_released' => 'string',
        ...
        'product_type_details' => '\PrioTicket\DistributorAPI\Models\RegularBookingItem[]',
        'booking_reservation_reference' => 'string',
        'booking_reservation_valid_until' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'product_type_details' => null,
        'booking_reservation_reference' => null,
        'booking_reservation_valid_until' => 'date-time'
    ];
    ...
    protected static $attributeMap = [
        ...
        'booking_reservation_reference' => 'booking_reservation_reference',
        'booking_reservation_valid_until' => 'booking_reservation_valid_until'
    ];
    ...
    protected static $setters = [
        ...
        'product_type_details' => 'setProductTypeDetails',
        'booking_reservation_reference' => 'setBookingReservationReference',
        'booking_reservation_valid_until' => 'setBookingReservationValidUntil'
    ];
    ...
    protected static $getters = [
        ...
        'product_type_details' => 'getProductTypeDetails',
        'booking_reservation_reference' => 'getBookingReservationReference',
        'booking_reservation_valid_until' => 'getBookingReservationValidUntil'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['product_type_details'] = $data['product_type_details'] ?? null;
        $this->container['booking_reservation_reference'] = $data['booking_reservation_reference'] ?? null;
        $this->container['booking_reservation_valid_until'] = $data['booking_reservation_valid_until'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['product_type_details'] === null) {
            $invalidProperties[] = "'product_type_details' can't be null";
        }
        if ($this->container['booking_reservation_reference'] === null) {
            $invalidProperties[] = "'booking_reservation_reference' can't be null";
        }
        if ($this->container['booking_reservation_valid_until'] === null) {
            $invalidProperties[] = "'booking_reservation_valid_until' can't be null";
        }
    ...
    public function setBookingVersion($booking_version)
    {
        ...
        if (!is_null($booking_version) && ($booking_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $booking_version when calling ReservationDetail., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $booking_voucher_released Whether the vouchers of this booking are available / released. Voucher allocation can be delayed based on the voucher release requirements.
     *
     * @return self
     * @deprecated
     */
    ...
    /**
     * Gets product_type_details
     *
     * @return \PrioTicket\DistributorAPI\Models\RegularBookingItem[]
     */
    public function getProductTypeDetails()
    {
        return $this->container['product_type_details'];
    }

    /**
     * Sets product_type_details
     *
     * @param \PrioTicket\DistributorAPI\Models\RegularBookingItem[] $product_type_details A list specifying the booking quantity per product type.
     *
     * @return self
     */
    public function setProductTypeDetails($product_type_details)
    {
        $this->container['product_type_details'] = $product_type_details;

        return $this;
    }

    /**
     * Gets booking_reservation_reference
     *
     * @return string
     */
    public function getBookingReservationReference()
    {
        return $this->container['booking_reservation_reference'];
    }

    /**
     * Sets booking_reservation_reference
     *
     * @param string $booking_reservation_reference Unique identifier for this booking within the current cart. To update this booking you should pass the same value in the next request.
     *
     * @return self
     */
    public function setBookingReservationReference($booking_reservation_reference)
    {
        $this->container['booking_reservation_reference'] = $booking_reservation_reference;

        return $this;
    }

    /**
     * Gets booking_reservation_valid_until
     *
     * @return \DateTime
     */
    public function getBookingReservationValidUntil()
    {
        return $this->container['booking_reservation_valid_until'];
    }

    /**
     * Sets booking_reservation_valid_until
     *
     * @param \DateTime $booking_reservation_valid_until The reserved booking will stay alive until this time, after that the booking will be auto-cancelled. > In this case ONLY this specific product will be auto-cancelled. To view your updated reservation you could call the 'Cart Details' endpoint.  > Our system will try to reset the `booking_reservation_valid_until` every time the Update Cart endpoint is called. This will not work for most third-party products. Please keep an eye on the value `booking_reservation_valid_until` to make sure your cart does not expire.
     *
     * @return self
     */
    public function setBookingReservationValidUntil($booking_reservation_valid_until)
    {
        $this->container['booking_reservation_valid_until'] = $booking_reservation_valid_until;
