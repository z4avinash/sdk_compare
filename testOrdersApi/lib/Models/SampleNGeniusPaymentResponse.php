...
/**
 * SampleNGeniusPaymentResponse Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class SampleNGeniusPaymentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sample_N_Genius_Payment_Response';
     ...
     * Sets result_code
     *
     * @param string $result_code Provides information about the result of the request.
     *
     * @return self
     */
