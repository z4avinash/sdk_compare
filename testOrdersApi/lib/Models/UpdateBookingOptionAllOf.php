...
/**
 * UpdateBookingOptionAllOf Class Doc Comment
 *
 * @category Class
 * @package  PrioTicket\DistributorAPI
 * @author   OpenAPI Generator team
 ...
 */
class UpdateBookingOptionAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateBookingOption_allOf';
    ...
    public function setBookingReference($booking_reference)
    {
        ...
        if (!is_null($booking_reference) && (mb_strlen($booking_reference) < 8)) {
            throw new \InvalidArgumentException('invalid length for $booking_reference when calling UpdateBookingOptionAllOf., must be bigger than or equal to 8.');
        }
