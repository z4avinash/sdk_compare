...
/**
 * UpdateOrderRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateOrderRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateOrderRequestData';
    ...
    protected static $openAPITypes = [
        ...
        'order' => '\PrioTicket\DistributorAPI\Models\UpdateOrderModel'
    ];
     ...
     * Gets order
     *
     * @return \PrioTicket\DistributorAPI\Models\UpdateOrderModel
     */
     ...
     * Sets order
     *
     * @param \PrioTicket\DistributorAPI\Models\UpdateOrderModel $order order
     *
     * @return self
     */
