...
/**
 * WebhookNotification Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookNotification';
    ...
    protected static $openAPITypes = [
        ...
        'notification_status' => '\PrioTicket\DistributorAPI\Models\NotificationStatus',
        'notification_event' => '\PrioTicket\DistributorAPI\Models\NotificationEvent',
    ...
    protected static $openAPIFormats = [
        ...
        'notification_account_id' => null,
        'notification_item_id' => null,
        'notification_note' => null,
        'notification_created' => 'date-time'
    ];
    ...
    protected static $setters = [
        ...
        'notification_event' => 'setNotificationEvent',
        'notification_account_id' => 'setNotificationAccountId',
        'notification_item_id' => 'setNotificationItemId',
        'notification_note' => 'setNotificationNote',
        'notification_created' => 'setNotificationCreated'
    ];
    ...
    protected static $getters = [
        ...
        'notification_event' => 'getNotificationEvent',
        'notification_account_id' => 'getNotificationAccountId',
        'notification_item_id' => 'getNotificationItemId',
        'notification_note' => 'getNotificationNote',
        'notification_created' => 'getNotificationCreated'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['notification_status'] = $data['notification_status'] ?? null;
        $this->container['notification_event'] = $data['notification_event'] ?? null;
        $this->container['notification_account_id'] = $data['notification_account_id'] ?? null;
        $this->container['notification_item_id'] = $data['notification_item_id'] ?? null;
        $this->container['notification_note'] = $data['notification_note'] ?? null;
        $this->container['notification_created'] = $data['notification_created'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['notification_status'] === null) {
            $invalidProperties[] = "'notification_status' can't be null";
        }
        if ($this->container['notification_event'] === null) {
            $invalidProperties[] = "'notification_event' can't be null";
        }
        if ($this->container['notification_item_id'] === null) {
            $invalidProperties[] = "'notification_item_id' can't be null";
        }
     ...
     *
     * @return \PrioTicket\DistributorAPI\Models\NotificationStatus
     * @deprecated
     */
     ...
     *
     * @param \PrioTicket\DistributorAPI\Models\NotificationStatus $notification_status notification_status
     *
     * @return self
     * @deprecated
     */
    ...
    /**
     * Gets notification_event
     *
     * @return \PrioTicket\DistributorAPI\Models\NotificationEvent
     */
    public function getNotificationEvent()
    {
        return $this->container['notification_event'];
    }

    /**
     * Sets notification_event
     *
     * @param \PrioTicket\DistributorAPI\Models\NotificationEvent $notification_event notification_event
     *
     * @return self
     */
    public function setNotificationEvent($notification_event)
    {
        $this->container['notification_event'] = $notification_event;

        return $this;
    }

    /**
     * Gets notification_account_id
     *
     * @return string|null
     * @deprecated
     */
    public function getNotificationAccountId()
    {
        return $this->container['notification_account_id'];
    }

    /**
     * Sets notification_account_id
     *
     * @param string|null $notification_account_id Notification account ID.
     *
     * @return self
     * @deprecated
     */
    public function setNotificationAccountId($notification_account_id)
    {
        $this->container['notification_account_id'] = $notification_account_id;

        return $this;
    }

    /**
     * Gets notification_item_id
     *
     * @return string
     */
    public function getNotificationItemId()
    {
        return $this->container['notification_item_id'];
    }

    /**
     * Sets notification_item_id
     *
     * @param string $notification_item_id Identifier of the item related to this event.  Item Types:    * Product ID.   * Availability ID.   * Payment ID.   * Order ID.   * Contact ID.
     *
     * @return self
     */
    public function setNotificationItemId($notification_item_id)
    {
        $this->container['notification_item_id'] = $notification_item_id;

        return $this;
    }

    /**
     * Gets notification_note
     *
     * @return string|null
     * @deprecated
     */
    ...
    {
        return $this->container['notification_note'];
    }

    /**
     * Sets notification_note
     *
     * @param string|null $notification_note Notification note.
     *
     * @return self
     * @deprecated
     */
    public function setNotificationNote($notification_note)
    {
        $this->container['notification_note'] = $notification_note;

        return $this;
    }

    /**
     * Gets notification_created
     *
    ...
    {
        return $this->container['notification_created'];
    }

    /**
     * Sets notification_created
     *
     * @param \DateTime|null $notification_created Date of creation.
     *
     * @return self
     * @deprecated
     */
    ...
    {
        $this->container['notification_created'] = $notification_created;
